...
$route['foodstaffManage'] = 'HomeController/staffManage';
...
$route['request_service'] = 'HomeController/request_service';
$route['handover_staff'] = 'HomeController/handover_staff';


$route['enquiry_request'] = 'HoteladminController/enquiry_request';
$route['banquet_hall'] = 'HoteladminController/banquet_hall';
$route['view_all_notification'] = 'HoteladminController/view_all_notification';

//front office
$route['frontoffice_notification_ajax'] = 'FrontofficeController/frontoffice_notification_ajax';
...
$route['frontDashnotification'] = 'FrontofficeController/frontDashnotification';
$route['checkOutRequest'] = 'FrontofficeController/checkOutRequest';
$route['staffhandover'] = 'FrontofficeController/staffhandover';
...
$route['all_notification'] = 'HoteladminController/all_notification';
$route['roomServDashNotification'] = 'HoteladminController/roomServDashNotification';
$route['HouseKeepingDashNotification'] = 'HoteladminController/HouseKeepingDashNotification';
$route['foodDashNotification'] = 'HoteladminController/foodDashNotification';
$route['checkOutRequestAdmin'] = 'HoteladminController/checkOutRequestAdmin';
...
$route['menu_setting'] = 'SuperAdminController/menu_setting';
...
$route['activeGuest'] = 'SuperAdminController/activeGuest';
$route['guestfrom'] = 'SuperAdminController/guestfrom';
$route['superAdminDashboardEnquiry'] = 'SuperAdminController/enquiry';
...
$route['orderbyroom'] = 'RoomserviceController/orderbyroom';
// chiragi end routs
...
$route['OnCallOrder'] = 'HouseKeepingController/OnCallOrder';
$route['Accepted'] = 'HouseKeepingController/Accepted';
$route['Completed_orders'] = 'HouseKeepingController/Completed_orders';
$route['Rejected_orders'] = 'HouseKeepingController/Rejected_orders';
$route['Staff_mang'] = 'HouseKeepingController/Staff_mang';
$route['staffdetails'] = 'HouseKeepingController/staffdetails';
$route['services'] = 'HouseKeepingController/services';
$route['Laundry'] = 'HouseKeepingController/Laundry';
$route['mng_loundry'] = 'HouseKeepingController/mng_loundry';
$route['loundry_acc_req'] = 'HouseKeepingController/loundry_acc_req';
$route['loundry_cmpl_order'] = 'HouseKeepingController/loundry_cmpl_order';
$route['loundry_rej_order'] = 'HouseKeepingController/loundry_rej_order';
$route['HouseDashNotification'] = 'HouseKeepingController/HouseDashNotification';
$route['Staff_review'] = 'HouseKeepingController/Staff_review';
$route['RmStatus'] = 'HouseKeepingController/RmStatus';
$route['service_mang'] = 'HouseKeepingController/service_mang';
$route['Handover'] = 'HouseKeepingController/Handover';
$route['staff_handover'] = 'HouseKeepingController/staff_handover';
$route['Service_request'] = 'HouseKeepingController/Service_request';


//use_login
$route['app_login'] = 'LoginController/app_login';
$route['staff_login'] = 'StaffApi/staff_login';
$route['staff_add_services_orders'] = 'StaffApi/staff_add_services_orders';

$route['controller_name/customer_list'] = 'controller_name/customer_list';
...
$route['user_verification'] = 'UserApi/user_verification';

$route['user_login'] = 'UserApi/user_login'; //7/11/2022
$route['get_faq'] = 'UserApi/get_faq';
$route['terms_condition'] = 'UserApi/terms_condition';   
$route['help_center'] = 'UserApi/help_center';

$route['contact_details'] = 'UserApi/contact_details';
$route['update_password'] = 'UserApi/update_password';
$route['forgot_password'] = 'UserApi/forgot_password';
...
$route['get_feedback'] = 'UserApi/get_feedback';
...
//spa request insert
$route['sent_request_to_spa'] = 'UserApi/sent_request_to_spa'; //16/06/2023

//spa type fetch
$route['spa_types'] = 'UserApi/spa_types';//16/06/2023

//edit laundry order
$route['edit_laundry_order'] = 'UserApi/edit_laundry_order';//19/06/2023

//edit reserve table request
$route['edit_reserve_table_request'] = 'UserApi/edit_reserve_table_request';//19/06/2023

//edit business center request
$route['edit_business_center_request'] = 'UserApi/edit_business_center_request';//19/06/2023

//edit business center request
$route['edit_cab_request'] = 'UserApi/edit_cab_request';//19/06/2023

//edit wash my vehicle request
$route['edit_wash_my_vehicle_request'] = 'UserApi/edit_wash_my_vehicle_request';//19/06/2023

//edit wash my vehicle request
$route['edit_banquet_hall_request'] = 'UserApi/edit_banquet_hall_request';//19/06/2023

//edit house keeping request
$route['edit_house_keeping_order'] = 'UserApi/edit_house_keeping_order';//19/06/2023

//edit house keeping request
$route['edit_spa_request'] = 'UserApi/edit_spa_request';//19/06/2023

//complete reserve table request
$route['complete_request_for_table_reserve'] = 'UserApi/complete_request_for_table_reserve';//22/06/2023

//complete business center request
$route['complete_request_for_business_center'] = 'UserApi/complete_request_for_business_center';//22/06/2023

//complete banquet hall request
$route['complete_request_for_banquet_hall'] = 'UserApi/complete_request_for_banquet_hall';//22/06/2023

//complete banquet cab service request
$route['complete_request_for_cab_service'] = 'UserApi/complete_request_for_cab_service';//22/06/2023

//complete wash my car request
$route['complete_request_for_wash_my_car'] = 'UserApi/complete_request_for_wash_my_car';//22/06/2023

//complete wash my car request
$route['complete_request_for_spa'] = 'UserApi/complete_request_for_spa';//22/06/2023

//complete checkout request
$route['checkout_request'] = 'UserApi/checkout_request';//26/06/2023

//complete checkout request
$route['luggage_return'] = 'UserApi/luggage_return';//26/06/2023

//call waiter request list
$route['get_my_call_waiter_list'] = 'UserApi/get_my_call_waiter_list';//26/06/2023

$route['update_id_proff'] = 'UserApi/update_id_proff';
