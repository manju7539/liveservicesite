...
class SuperAdminController extends CI_Controller
{
    ...
    public function hotelLists()
    {
        ...
        if (isset($start_date) && isset($end_date) && empty($searchon) && empty($city)) {
            $wh = '(register_date BETWEEN "' . $start_date . '" AND "' . $end_date . '")';
            $data['hotel_data'] = $this->MainModel->getAllData('register', $wh);
        } elseif (empty($date) && !empty($searchon) && empty($city)) {
            $data['hotel_data'] = $this->SuperAdmin->ser_check_list_hotel($searchon);
        } elseif (empty($date) && empty($searchon) && !empty($city)) {
            ...
            $wh = '(register_date BETWEEN "' . $start_date . '" AND "' . $end_date . '" AND u_id = "' . $searchon . '")';
            $data['hotel_data'] = $this->MainModel->getAllData('register', $wh);
        } elseif (!empty($date) && empty($searchon) && !empty($city)) {
            $wh = '(register_date BETWEEN "' . $start_date . '" AND "' . $end_date . '" AND city = "' . $city . '")';
            $data['hotel_data'] = $this->MainModel->getAllData('register', $wh);
        } elseif (empty($date) && !empty($searchon) && !empty($city)) {
            $wh = '(u_id = "' . $searchon . '" AND city = "' . $city . '")';
            $data['hotel_data'] = $this->MainModel->getAllData('register', $wh);
        } elseif (!empty($date) && !empty($searchon) && !empty($city)) {
            $wh = '(register_date BETWEEN "' . $start_date . '" AND "' . $end_date . '" AND u_id = "' . $searchon . '" AND city = "' . $city . '")';
            $data['hotel_data'] = $this->MainModel->getAllData('register', $wh);
        }
    ...
    public function add_hotels()
    {
        ...
        if ($department_permission) {
            ...
            echo "<script>
                    ...
                    window.location.href='" . base_url('hotelLists') . "';
                  </script>";
        }
        // }
    }
    ...
    {
        $query = $this->MainModel->get('register');
