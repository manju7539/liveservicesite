...
<div class="state-overview">
   <div class="row">
      ...
      <!-- /.col -->
      <div class="col-xl-3 col-md-6 col-12">
      <a href="<?php echo base_url('newManageOrder?type=completed')?>">
      ...
      <div class="col-xl-3 col-md-6 col-12">
      <a href="<?php echo base_url('newManageOrder?type=new_orders')?>">
      ...
      <!-- /.col -->
      <div class="col-xl-3 col-md-6 col-12">
      <a href="<?php echo base_url('newManageOrder?type=reject_orders')?>">
                                    ...
                                    <li>
                                       <div class="timeline-panel">
                                          <div class="media-body">
                                             ...
                                             <small class="d-block"><?php echo date('d-m-Y', strtotime($g['created_at'])) . " - " . date('h:i a', strtotime($g['created_at'])) ?></small>
                                          </div>
                                       </div>
                                    </li>
                                    <?php
