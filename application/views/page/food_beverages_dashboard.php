      ...
      <div class="row">
                  ...
                  <div class="accordion accordion-rounded-stylish accordion-bordered" id="accordion-eleven">
                     <div class="row">
                        <div class="col-xl-12">
                           ...
                           <div class="row">
                              <div class="col-xl-6">
                                 <a href="<?php echo base_url('HoteladminController/FoodBeberageList?id=4&type=new')?>">
         ...
         <div class="col-xl-4">
            <div class="row">
                     ...
                     <div class="card-body no-padding height-9">
                        <div class="row">
                           <div class="noti-information notification-menu">
                              <div class="notification-list mail-list not-list small-slimscroll-style" style="height:365px">
                                 <?php
                                    $admin_id = $this->session->userdata('u_id');  
			                           $today_date = date('Y-m-d');
                                    $get_notification_data = $this->MainModel->get_notifications_for_food($admin_id,$today_date);
               ...
               <div class="col-xl-12 ">
                  <div class="card  card-box m-0 mt-3 mb-4" style="margin-bottom:20px">
                     <div class="card-head">
                                 ...
                                 <?php 
                                    ...
                                    if(!empty($get_activity_complt_orders))
                                    {
                                       ...
                                       //   echo "<pre>"; print_r($g_act);
                                          ...
                                          $bookingdata= '(booking_id = "'.$g_act['booking_id'].'")';
