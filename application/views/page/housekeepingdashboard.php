                                       ...
                                       <div class="col-10 d-flex flex-column ps-4 pt-1">
                                         ...
                                         <div class="col-md-10">
                                          <div class=" d-flex mt-2">
                                              ...
                                              <button type="submit" value="4" data-id="<?php echo $gnt['notification_id'] ?>"  name="order_status" data-action="4" class="btn btn-success css_btn">Accept</button>
                                           &nbsp;
                                         
                                              
                                              <button type="submit"  value="5" data-id="<?php echo $gnt['notification_id'] ?>"  name="order_status" data-action="5" class="btn btn-danger css_btn">Reject</button>
                                      </div>
