         ...
         <div class="col-xl-3 col-md-6 col-12">
            ...
            <a style="color: white" href="<?php echo base_url('roomStatus')?>">
               ...
               <div class="info-box-content">
                  ...
                  <hr class="m-0">
                  <span style="color:#ffffffad;font-size:22px;"><?php echo count($get_hotel_current_booking_accept)?></span>
                  <br>
                  <!-- <div class="progress">
                     <div class="progress-bar width-60"></div>
                     </div> -->
         ...
         <div class="col-xl-3 col-md-6 col-12">
            ...
            <a style="color: white" href="<?php echo base_url('frontDeparture')?>">
               ...
               <div class="info-box-content">
                  ...
                  <hr class="m-0">
                  <span style="color:#c1c1c1;font-size:25px;"><?php echo count($total_expected_departed_booking)?></span>
                  <!-- <div class="progress">
                     <div class="progress-bar width-80"></div>
                     </div>
                     <span class="progress-description">
      ...
      <div class="col-md-12 col-sm-12">
         ...
         <div class="row">
            ...
            <div class="col-md-6 col-sm-12 col-12">
               <div class="card  card-box bg-light m-0">
                  <div class="card-head">
         ...
         <div class="row">
            <div class="col-md-12 col-sm-12">
               <div class="card  card-box bg-light m-0 mt-2">
                  <div class="card-head">
