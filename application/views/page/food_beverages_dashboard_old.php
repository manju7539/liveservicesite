      ...
      <div class="panel tab-border card-box">
         <header class="panel-heading panel-heading-gray custom-tab ">
            <ul class="nav nav-tabs">
               ...
               <li class="nav-item" style="width: 33%;text-align: center;"> <a class="nav-link active" data-bs-toggle="tab" href="#sample">Food
                  And
                  Beverages</a>
               </li>
            </ul>
...
<div class="row">
   <div class="col-xl-12">
      ...
      <div class="row">
               ...
               <div class="col-xl-3 col-md-6 col-12">
                  <a href="<?php echo base_url('HoteladminController/order_management?id=3&type=completed')?>">
                     <div class="info-box bg-blue">
                        <span class="info-box-icon push-bottom"><i class="material-icons">style</i></span>
                        <div class="info-box-content">
               ...
               <div class="col-xl-3 col-md-6 col-12">
                  <a href="<?php echo base_url('HoteladminController/order_management?id=3&type=new_orders')?>">
                     <div class="info-box bg-orange">
                        <span class="info-box-icon push-bottom"><i class="material-icons">style</i></span>
                        <div class="info-box-content">
                           <span class="info-box-text">Pending Orders</span>
                           <span class="info-box-number"><?php echo count($new_order_list)?></span>
                        </div>
                        <!-- /.info-box-content -->
                     </div>
                  </a>
               ...
               <div class="col-xl-3 col-md-6 col-12">
                  <a href="<?php echo base_url('HoteladminController/order_management?id=3&type=reject_orders')?>">
                     <div class="info-box bg-success">
                        <span class="info-box-icon push-bottom"><i class="material-icons">style</i></span>
                        <div class="info-box-content">
                           <span class="info-box-text">Rejected Orders</span>
                           <span class="info-box-number"><?php echo count($rejected_order)?></span>
                        </div>
                        <!-- /.info-box-content -->
                     </div>
                  </a>
                  ...
                  <div class="accordion accordion-rounded-stylish accordion-bordered" id="accordion-eleven">
                     <div class="row">
                        <div class="col-xl-12">
                                                   ...
                                                   <div class="col-xl-12">
                                                      <div class="row row-cols-8 ">
                                                         <div class="room_card card red"
                                                            ...
                                                            <span
                                                               class="room_no "><a href="<?php echo base_url('HoteladminController/order_management')?>" style="color: black;">206</a></span>
                                                         </div>
                                                      </div>
                                                   </div>
                                                </div>
                                                   ...
                                                   <div class="col-xl-12">
                                                      <div class="row row-cols-8 ">
                                                         <div class="room_card card red"
                                                            ...
                                                            <span
                                                               class="room_no "><a href="<?php echo base_url('HoteladminController/order_management')?>" style="color: black;">304</a></span>
                                                         </div>
                                                         <div class="room_card card red"
                                                            data-bs-toggle="modal"
                                                            data-bs-target=".add">
                                                            ...
                                                            <span
                                                               class="room_no "><a href="<?php echo base_url('HoteladminController/order_management')?>"style="color: black;">316</a></span>
                                                         </div>
                                                         <div class="room_card card red"
                                                            data-bs-toggle="modal"
                                                            data-bs-target=".add">
                                                            ...
                                                            <span
                                                               class="room_no "><a href="<?php echo base_url('HoteladminController/order_management')?>" style="color: black;">321</a></span>
                                                         </div>
                                                         <div class="room_card card red"
                                                            data-bs-toggle="modal"
                                                            data-bs-target=".add">
                                                            ...
                                                            <span
                                                               class="room_no "><a href="<?php echo base_url('HoteladminController/order_management')?>" style="color: black;">331</a></span>
                                                         </div>
                                                      </div>
                                                   </div>
                                                </div>
                                                   ...
                                                   <div class="col-xl-12">
                                                      <div class="row row-cols-8 ">
                                                         <div class="room_card card red"
                                                            ...
                                                            <span
                                                               class="room_no "><a href="<?php echo base_url('HoteladminController/order_management')?>" style="color: black;">401</a></span>
                                                         </div>
                                                         <div class="room_card card red"
                                                            data-bs-toggle="modal"
                                                            data-bs-target=".add">
                                                            ...
                                                            <span
                                                               class="room_no "><a href="<?php echo base_url('HoteladminController/order_management')?>" style="color: black;">402</a></span>
                                                         </div>
                                                         <div class="room_card card red"
                                                            data-bs-toggle="modal"
                                                            data-bs-target=".add">
                                                            ...
                                                            <span
                                                               class="room_no "><a href="<?php echo base_url('HoteladminController/order_management')?>" style="color: black;">413</a></span>
                                                         </div>
                                                      </div>
                                                   </div>
                                                </div>
                           ...
                           <div class="row">
                              <div class="col-xl-6">
                                 <a href="<?php echo base_url('HoteladminController/FoodBeberageList')?>">
                              ...
                              <div class="col-xl-6">
                                 <?php 
                                    ...
                                    ?>
                                 <a
                                    href="<?php echo base_url('HoteladminController/new_hall_request')?>">
                                    <div class="accordion-item" style="height: 163px;">
                                       <div class="accordion-header rounded-lg collapsed"
                                          role="button">
                                          <span class="accordion-header-icon"></span>
               ...
               <div class="col-md-12 ">
                  <div class="card card-box m-0">
                     <div class="card-head">
                        ...
                        <div class="action coin-tabs mt-1" style="float:right">
                                          <ul class="nav nav-tabs" role="tablist">
                                             <li class="nav-item">
                                                <a class="nav-link active " data-bs-toggle="tab"
                                                   href="#Daily1" role="tab"
                                                   style="color:black;">Todays</a>
                                             </li>
                                             <li class="nav-item">
                                                <a class="nav-link " data-bs-toggle="tab"
                                                   href="#weekly1" role="tab" style="color:black;">Last
                                                7 Days</a>
                                             </li>
                                             <li class="nav-item" style="color:black;">
                                                <a class="nav-link" data-bs-toggle="tab"
                                                   href="#monthly1" role="tab"
                                                   style="color:black;">Current Month</a>
                                             </li>
                                             <li class="nav-item">
                                                <a class="nav-link " data-bs-toggle="tab"
                                                   href="#yearly1" role="tab"
                                                   style="color:black;">Current Year</a>
                                             </li>
                                          </ul>
                                       </div>
                     </div>
                                       ...
                                       <div class="tab-content">
                                             ...
                                             <div style="width:100%;">
                                                ...
                                                <div class="guest-calendar text-center">
                                                   <div id="reportrange_today"
                                                      ...
                                                      style="background-color:white;color:black;border:none;font-weight:600;">
                                                      <span></span><b class=""></b>
                                                ...
                                                <canvas id="year"
                                                   style="min-height: 400px; height: 400px; max-height: 400px; max-width: 100%; display: block; width: 952px;"
                                                   class="chartjs-render-monitor" width="952"
                                                   height="400"></canvas>
                                             </div>
                                          </div>
                                          <div class="tab-pane fade " id="weekly1">
                                             <div style="width:100%;">
                                                ...
                                                <canvas id="year1"
                                                   style="min-height: 400px; height: 0px; max-height: 400px; max-width: 100%; display: block; width: 0px;"
                                                   class="chartjs-render-monitor" width="0"
                                                   height="0"></canvas>
                                             </div>
                                          </div>
         ...
         <div class="col-xl-4">
            <div class="row">
                     ...
                     <div class="card-body no-padding height-9">
                        <div class="row">
                           <div class="noti-information notification-menu">
                              ...
                              </span> <span class="text-purple"><?php echo $g['title'] ?></span>
                              <!-- <span class="text-purple"><?php echo $g['description'] ?></span> -->

                              <span class="notificationtime">
                              <small>
                              <?php echo date('d F Y',strtotime($g['created_at']))." - ".date('h:i a',strtotime($g['created_at'])) ?>
                              </small>
                              </span>
                              </a>
                                 <!-- <li>
                                    <div class="timeline-panel">
                                       <div class="media-body d-flex align-items-center flex-column">
                                      
                                          <h5 class="mb-1"><?php echo $g['title'] ?>
                                          </h5>
                                          
                                          <span class="text-black"><?php echo  $g['description']?></span>
                                          <small class="d-block text-black"><?php echo date('d F Y',strtotime($g['created_at']))." - ".date('h:i a',strtotime($g['created_at'])) ?></small>
                                       </div>
                                    </div>
                                 </li> -->
                                 <?php
                              ...
                              <div class="full-width text-center p-t-10">
                                 <button type="button"
                                    ...
                                    {
                                    ?>
                                 <a href="<?php echo base_url('foodDashNotification')?>" >View All Notification</a>
                                 <?php
                                    }
                                    ?></button>
                              </div>
               ...
               <div class="col-xl-12 ">
                  <div class="card  card-box m-0 mt-3">
                     <div class="card-head">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <?php
                                       ...
                                       {
                                       ?>
                                       Room-<?php echo $g_act['room_no']?> Pending<!--At <span
                                       ...
                                       {
                                       ?>
                                       Room-<?php echo $g_act['room_no']?> Order Accepted,<!--At <span
                                          style="font-weight:bold">30 Min
                                          Ago</span> ; -->By -
                                       ...
                                       {
                                       ?>
                                       Room-<?php echo $g_act['room_no']?> Order Completed,<!--At <span
                                          style="font-weight:bold">30 Min
                                          Ago</span> ; -->By -
                                       <span style="font-weight:bold"><?php echo $staff_name;?></span>
                                       <?php 
                                       ...
                                       {
                                       ?>
                                       Room-<?php echo $g_act['room_no']?> Order Rejected<!--At <span
                                          style="font-weight:bold">30 Min
                                          Ago</span> ; -->
                                       <?php 
                                       ...
                                       {
                                       ?>
                                       Room-<?php echo $g_act['room_no']?> Order Cancelled By User<!--At <span
                                          style="font-weight:bold">30 Min
                                          Ago</span> ; -->
                                       <?php 
...
<script src="https://code.highcharts.com/highcharts.js"></script>
      ...
      <script>
         Highcharts.chart('container', {
             ...
             xAxis: {
                 ...
                 categories: ['2hr', '4hr', '6hr', '8hr', '10hr', '12hr', '14hr', '16hr', '18hr', '20hr',
                     '222hr', '24hr'
         
                 ],
                 accessibility: {
                     rangeDescription: 'Range: 2hr to 24hr'
                 }
             },
      ...
      <script>
         $(function() {
             ...
             // $('#reportrange_week').daterangepicker({
             //     startDate: start,
             //     endDate: end,
             //     ranges: {
             //         'Today': [moment(), moment()],
