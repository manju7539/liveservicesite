...
<style>
    .cancel_booking .container-fluid{
        padding:0px
    }
</style>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-topline-aqua">
                    <div class="card-head">
                        <header>List Of Cancelled Booking</header>
                    ...
                    <div class="card-action coin-tabs mb-2">
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link "  href="<?php echo base_url('all_booking')?>">All
                                    Booking</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link active" href="<?php echo base_url('cancle_booking')?>">Cancelled Booking</a>
                            </li>
                        ...
                        <div class="table-scrollable cancel_booking">
                                               ...
                                               <td><h5><?php echo date('d-m-Y', strtotime($row['check_out']));?></h5></td>
                                                        ...
                                                        <td>
                                                            <!-- <a href="<?php //echo base_url('customer_view/'.$row['u_id'].'/'.$row['booking_id'])?>">
                                                                ...
                                                                <a href="#" class="btn btn-secondary shadow btn-xs sharp me-1  guest_invoice" data-bs-toggle="modal" u-id1=<?= $row['u_id']?> booking-id=<?= $row['booking_id']?> data-bs-target=".bd-view-modal-invoice-guest"><i class="fa fa-eye"></i>
                                                </a>
                                                        </td>
                                                    </tr>
...
//      echo '</pre>';
    ...
    <!-- sub popup view -->
    <div class="modal fade  bd-view-modal-invoice-guest <?php echo $row['booking_id'] ?>" tabindex="-1" style="display: none;" aria-hidden="true">
