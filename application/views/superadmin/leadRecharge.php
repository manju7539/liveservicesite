...
// 	 exit;
    ...
    /* th{
        ...
        .lead_reacharge .container-fluid{
            padding:0px
        }
        </style>
            ...
            <div class="col-md-12">
                <div class="card card-topline-aqua">
                    ...
                    <div class="btn-group r-btn">
                        ...
                        <div class="table-scrollable lead_reacharge" >
...
<script>
    ...
    $(document).on('click', '#delete_data', function (event) {
        event.preventDefault(); // Prevent the default behavior of the form submit button
            ...
            swal({
                title: "Are you sure?",
                text: "You will not be able to recover this Lead Rechage!",
                type: "warning",
                ...
                if (isConfirm) {
                    $.ajax({
                        ...
                        dataType: "html",
                        success: function (data) {
                            swal("Deleted!", "Your Lead Recharge has been deleted!", "success");
                            $.get( '<?= base_url('leadRecharge');?>', function( data ) {
                                var resu = $(data).find('.table-scrollable').html();
                                $('.table-scrollable').html(resu);
                                setTimeout(function(){
