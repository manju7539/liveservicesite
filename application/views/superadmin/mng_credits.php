         ...
         <div class="col-md-12">
            <div class="card card-topline-aqua">
               ...
               <div class="card-body ">
                  ...
                  <div class="table-scrollable mng_credits" >
...
<script>
   ...
   $(document).on('click', '#delete_data', function (event) {
        event.preventDefault(); // Prevent the default behavior of the form submit button
            ...
            swal({
                title: "Are you sure?",
                text: "You will not be able to recover this Hotel Credit!",
                type: "warning",
                ...
                if (isConfirm) {
                    $.ajax({
                        ...
                        dataType: "html",
                        success: function (data) {
                            swal("Deleted!", "Your Hotel Credit has been deleted!", "success");
                            $.get( '<?= base_url('mng_credits');?>', function( data ) {
                              var resu = $(data).find('.table-scrollable').html();
                              $('.table-scrollable').html(resu);
                              setTimeout(function(){
