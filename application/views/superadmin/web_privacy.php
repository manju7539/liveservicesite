...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <div class="row">
            ...
            <?php 
                                if (!empty($this->session->flashdata('hotel_privacy_msg')) )
                                { ?>
                                   <div class="alert alert-success" role="alert" id="a" style="margin-top:10px; background-color: #71C56C;">
                                <strong style="color:black ;margin-top:10px;"><?php echo $this->session->flashdata('hotel_privacy_msg') ?></strong>
                ...
                <?php
                            ...
                            // echo $id;
                            $tc=$this->SuperAdmin->get_data_privacy_policy_hotels($tbl='privacy_policy');
                            // echo  $tc;
                ...
                <div class="row">
                <form id="privacy" method="post" enctype="multipart/form-data">
...
<script>
    ...
    $(document).on('submit', '#privacy', function(e){
        ...
        var form_data = new FormData(privacy);
        // console.log(form_data);
        $.ajax({
            url         : '<?= base_url('SuperAdminController/Add_Privacy_policy_Hotels') ?>',
            method      : 'POST',
            data        : form_data,
            processData : false,
            contentType : false,
