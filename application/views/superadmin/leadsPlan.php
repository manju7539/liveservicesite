         ...
         <div class="col-md-12">
            <div class="card card-topline-aqua">
               ...
               <div class="btn-group r-btn">
                  ...
                  <div class="table-scrollable plan_listing">
                  ...
                  <div class="basic-form">
                     <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12">
                           ...
                           <textarea name="description" id="add_description" class="summernote" cols="30" rows="10"></textarea>
         ...
         <div class="modal-body">
            ...
            <form id="frmupdateblock" method="POST" enctype="multipart/form-data">
               <div class="row">
                  ...
                  <div class="col-md-12 col-sm-12">
                        <label class="form-label">Description</label>
                        <textarea name="description" class="summernote form-control" id="description" cols="30" rows="10"></textarea>
                  </div>
...
$(document).ready(function () {
        ...
        $("#frmupdateblock").validate({
            ...
            submitHandler: function (form) {
                // Use AJAX to submit the form (if required)
                $.ajax({
                    url: 'your_server_endpoint_here', // Replace with your server-side URL
                    type: 'POST',
                    data: $(form).serialize(),
                    success: function (response) {
                        alert("Form submitted successfully!");
                        // Refresh or close modal as needed
                        location.reload();
                    },
   ...
   // fetch leads plan data for edit
