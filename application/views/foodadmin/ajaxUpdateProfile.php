...
<div class="row">
            ...
            <div class="card card-topline-aqua">
                <div class="card-body no-padding height-9">
                    ...
                    <ul class="list-group list-group-unbordered">
                        ...
                        <li class="list-group-item">
                            <b>Email ID</b> <a class="pull-right" style="float:right;"><?php echo $email;?></a>
                        </li>
                        <li class="list-group-item">
    ...
    <div class="col-xl-8" style="margin-left: 80px;">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="default-tab">
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" href="#home"><i class="la la-edit me-2"></i>
                                Update Profile</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#profile"><i class="la la-lock me-2"></i>
                                Change password</a>
                        </li>
                            ...
                            <div class="pt-4">
                                <div class="basic-form">
                                    <form id="frmblock" method="post" enctype="multipart/form-data">
                                        <div class="mb-3 form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="hidden" name="id"
                                                    value="<?php echo $admin_details['u_id']?>">
                                        ...
                                        <div class="mb-3 form-group">
                                            <label class="text-label form-label" for="dlab-password">Upload
                                                profile</label>
                                            <div class="input-group transparent-append">
                                                <span class="input-group-text"> <i class="fa fa-file"></i> </span>
                                                <input type="file" name="File" value="<?php  echo $img?>"
                                                    class="form-control" id="dlab-password">
                                        ...
                                        <button type="submit" class="btn me-2 btn-primary css_btn">Update</button>
                                    ...
                                    <form id="updateProfile" method="POST">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group transparent-append">
                                                ...
                                                <span class="input-group-text show-pass">
                                                    <i class="current_paswword fa fa-eye-slash"></i>
                                                </span>
                                                <script>
                                                $(document).on('click', '.current_paswword', function() {

                                                    $(this).toggleClass("fa-eye fa-eye-slash");

                                                    var input = $("#current-password");
                                                    input.attr('type') === 'password' ? input.attr('type',
                                                        'text') : input.attr('type', 'password')
                                                });
                                                $(document).on('click', '.new_password_fist', function() {
                                                ...
                                                $(document).on('click', '.confirm_paswword', function() {
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group transparent-append">
                                                ...
                                                <span class="input-group-text show-pass">
                                                    <i class="fa fa-eye-slash new_password_fist "></i>
                                                </span>

                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            <label class="text-label form-label" for="confirm-password">Confirm Password
                                            </label>
                                            <div class="input-group transparent-append">
                                                <span class="input-group-text"> <i class="fa fa-lock"></i> </span>
                                                <input type="password" class="form-control" id="confirm-password"
                                                    ...
                                                    <span class="input-group-text show-pass">
                                                        <i class="fa fa-eye-slash confirm_paswword"></i>
                                                        <!-- <i class="fa fa-eye"></i> -->
                                                    </span>
                                        ...
                                        <button type="submit" class="btn me-2 btn-primary css_btn">Change</button>
                                        <!-- <button type="submit" class="btn btn-light css_btn">Cancel</button> -->
                                    </form>
                                </div>
                            </div>
