        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-topline-aqua">
                    ...
                    <div class="new_req">               
                        <div class="table-scrollable rew_request">
                                   ...
                                   ?>
                                    <tr>
                                       ...
                                       <td>
                                        ...
                                        <td>
                                            <span><?php echo date('d-m-Y', strtotime($l['request_date']));?> / <sub><?php echo date('h:i A', strtotime($l['request_time']));?></sub></span>
                                        </td>
                                        <td>
