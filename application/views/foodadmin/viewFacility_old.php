                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="#" id="delete_<?php echo $l['food_facility_id']?>" class="btn btn-tbl-delete btn-xs"><i class="fa fa-trash-o "></i></a>
                                            </td>
                                        </tr>
                                        <script>
                  ...
                  <div class="row">
                     ...
                     <div class="mb-3 col-md-6">
                        ...
                        <div class="input-group mb-3">
                           <div class="form-file form-control"
                              style="border: 0.0625rem solid #ccc7c7;">
                              <input type="file" name="File" value="<?php print_r($l['icon']);?>" accept="image/png, image/gif, image/jpeg">
    ...
    $(document).on('submit', '#frmblock', function(e){
        ...
        $.ajax({
            ...
            success     : function(res) {
                $.get( '<?= base_url('facility');?>', function( data ) {
...
<script>
     $(document).ready(function (id) {
            $(document).on('click','#edit_data',function(){
                ...
                // alert(id);
                $.ajax({
                    url: '<?= base_url('HomeController/getEditDataoffacility') ?>',
                    //url: 'https://aartoon.com/control_panel/MainController/delete_home_slider/13',
                    type: "post",
                    data: {id:id},
                    dataType:"json",
