                        ...
                        <div class="basic-form">                                   
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6 form-group ">
                                    ...
                                    <input type="text" name="cat_name" id="cat_name" value="" class= "form-control" placeholder="Category Name" onkeyup="return AlreadyExist()" autocomplete="off" required>
                                </div>
...
<script>
        ...
        $.ajax({
            ...
            success: function (response) {
                if(response == 1)
                {
                    ...
                    document.getElementById("cat_name").setAttribute("data-exist","1"); 
                    return false;
                }
                else
                {
                    document.getElementById("cat_name").setAttribute("data-exist","0"); 
                    $('#Error_cat_name').hide();
                    return true;
                }
            }
    ...
    $(document).on('submit', '#frmblock', function(evnt){
        evnt.preventDefault();
        var error_val = $('#cat_name').attr("data-exist");
        if(error_val == 1)
        {
            return false;
        }
