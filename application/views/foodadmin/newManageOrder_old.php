                  ...
                  <div class="modal-body">
                     <div class="col-lg-12">
                        ...
                        <div class="mb-3 col-md-12 assignto">
                           ...
                           <select id="status" name="staff_id" class="default-select form-control wide" value="">
                              <?php
                              $admin_id = $this->session->userdata('u_id');
                              $wh_admin = '(u_id ="' . $admin_id . '")';
                              $get_hotel_id = $this->MainModel->getData('register', $wh_admin);
   ...
   <script>
      $(document).ready(function() {
         ...
         $(document).on("click", ".btn_reassign_ord", function() {
            var selectedStaffId = $(this).attr('data-staff-id'); // Get the selected staff ID from the button
            $('#food_order_id_reassign').val($(this).attr('data-id'));
            $('#hotel_id').val($(this).attr('data-hotel-id'));
            $('#status').val(selectedStaffId);
            $("#reassign_ord_modal").modal('show');
         });
