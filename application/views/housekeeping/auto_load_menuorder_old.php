<?php 
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <div>
                                       <a href="#">
                                          <div class="badge badge-info new_notes" data-bs-toggle="modal"
                                             data-bs-target=".note_<?php echo $l['h_k_order_id']?>"  data-id2="<?php echo $l['h_k_order_id'] ?>">
                                             view
                                          </div>
                                       </a>
                                    </div>
                                 ...
                                 <td>
                                    <div>
                                       <a href="javascript:void(0)">
                                          ...
                                          data-id1="<?php echo $l['h_k_order_id'] ?>">
                               ...
                               <!--view Note Modal -->
               <div class="row">
                  <div class="modal fade note_<?php echo $l['h_k_order_id']?>" id="new_notes_ord_req_modal_id" aria-hidden="true">
