<?php 
                                                    ...
                                                    ?>
                                                      <tr class="out_of_time tr_id_<?php echo $l['cloth_order_id'];?>" data-time="<?php echo $l['cloth_order_id'];?>" >
                                                    <tr>
                                                        <td><?php echo $i;?></td>
                                                        <td class="bg_change_<?php echo $l['cloth_order_id'];?>"><?php echo $lo['cloth_order_id'];?>
