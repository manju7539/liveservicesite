...
<div class="page-content-wrapper">
   <div class="page-content">
    ...
    <span></span> <i class="fa fa-caret-down"></i>
                                 ...
                                 <select id="inputState" name="floor" class="default-select form-control wide"  >
                                 ...
                                 <select id="inputState"  name="room_non"  class="default-select form-control wide"  required >
                  ...
                  <div class="tab-content">
                              ...
                              <?php 
                                    if(!empty($new_order_list))
                                    {
                                       ...
                                       // die;
                                        ...
                                        $i=1;
                                        foreach($new_order_list as $ln)
                                        {
                                          //      echo "<pre>";
                                          //   print_r($new_order_list);die;
                                            $admin_id = $this->session->userdata('u_id');
                                 ...
                                 <tr>
                                    <td><?php echo $i;?></td>
                                    <td><?php echo $ln['h_k_order_id'];?></td>
                                    <td><?php echo date('d-m-Y', strtotime($ln['order_date']));?>
                                       <sub><?php echo date('h:i A', strtotime($ln['order_time']));?></sub>
                                    </td>
                                    <?php 
                                       if($ln['order_from'] == 1)
                                       {
                                       ...
                                       elseif($ln['order_from'] == 2)
                                       {
                                          $order_type = 'From Staff Order';
                                       }
                                       elseif($ln['order_from'] == 3)
                                       {
                                    ...
                                    <td><?php echo $ln['floor'];?></td>
                                    <td>
                                       <div>
                                          <h5 class="text-nowrap"><?php echo  $ln['room_no'];?></h5>
                                       </div>
                                    </td>
                                    <td>
                                       <div>
                                          <h5 class="text-nowrap"><?php echo $ln['full_name'];?></h5>
                                       </div>
                                    </td>
                                    <td>
                                       <div>
                                          ...
                                          <a href="#">
                                             <div class="badge badge-info edit_model_click" 
                                             data-unic-id="<?php echo $ln['h_k_order_id'] ?>">
                                                view
                                             </div>
                                          </a>
                                       </div>
                                    ...
                                    <div>
                                       ...
                                       <a href="#">
                                          <div class="badge badge-info new_house_ord_req" 
                                          data-id1="<?php echo $ln['h_k_order_id'] ?>">
                                             view
                                          </div>
                                       </a>
                                    </div>
                                    ...
                                    <div>
                                       ...
                                       <a href="#">
                                          <div class="btn btn-warning shadow btn-xs sharp me-1" id="edit_data" data-bs-toggle="modal"
                                          data-id=="<?php echo $ln['h_k_order_id'] ?>" data-bs-target=".update_staff_modal">
                     ...
                     <div class="tab-pane<?= ($type == 'accept_orders') ? ' active' : ''; ?>" id="house_accepted_order_div">
                        <div class="table-scrollable new_order_calllist">
                           <table id="house_manage_search_accepted_order" class="display full-width">
                              <thead>
                                 <tr>
                                    <th>Sr.no</th>
                                    <th>Order Id</th>
                              ...
                              <?php 
                                                            ...
                                                            {
                                                                $i=1;
                                                                foreach($accept_order_list as $l)
                                                                {
                                                                  $admin_id = $this->session->userdata('u_id');
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo date('d-m-Y', strtotime($l['order_date']));?>
                                                        ...
                                                        <td>
                                                            <span><?php echo $l['full_name'];?></span>
                                                        </td>
                                                        ...
                                                        <div>
                                                            ...
                                                            <a href="#">
                                                                <div class="badge badge-info accept_house_ord_req" data-bs-toggle="modal" 
                                                                data-id2="<?php echo $l['h_k_order_id'] ?>">
                                                                    view
                                                                </div>
                                                            </a>
                                                        </div>
                                                        ...
                                                        <td>
                                                            <span><?php echo $l['staff_name'];?></span>

                                                        </td>
                                                  
                                                       <td>
                                                       <input type="hidden" name="users_id" id="housekeeoingorderid<?php echo $l['h_k_order_id']; ?>" value="<?php echo $l['h_k_order_id'] ?>">
                                                   <input type="hidden" name="useruid" id="useruid<?php echo $l['h_k_order_id']; ?>" value="<?php echo $l['u_id'] ?>">
                                                   <input type="hidden" name="userhotelid" id="userhotelid<?php echo $l['h_k_order_id']; ?>" value="<?php echo $l['hotel_id'] ?>">
                                                    <select class="form-control" name="status" id="housekeepingstatus<?php echo $l['h_k_order_id']; ?>" onchange="change_status(<?php echo $l['h_k_order_id'] ?>);" style="min-width:85px;text-align:center">
                     ...
                     <div class="tab-pane<?= ($type == 'completed') ? ' active' : ''; ?>" id="house_completed_order_div">
                        <div class="table-scrollable new_order_calllist">
                           <table id="house_manage_search_completed_order" class="display full-width">
                              <thead>
                                 <tr>
                                    <th><strong>Sr. No</strong></th>
                                    <th>Order ID</th>
                              ...
                              <tbody id="append_data3">
                                 ...
                                 <tr>
                                    ...
                                    <td><?php echo  $lc['floor'];?></td>
                                    <td>
                                       <div>
                                          <h5 class="text-nowrap"><?php echo $lc['room_no'];?></h5>
                                       </div>
                                    </td>
                                    <td>
                                       <div>
                                          <h5 class="text-nowrap"><?php echo $lc['full_name'];?></h5>
                                       </div>
                                    </td>
                                    <td>
                                       <div>
                                    ...
                                    <td>
                                       <div>
                                          <h5 class="text-nowrap"><?php echo $lc['staff_name'];?></h5>
                                       </div>
                                    </td>
                     ...
                     <div class="tab-pane<?= ($type == 'reject_orders') ? ' active' : ''; ?>" id="house_rejected_order_div">
                        <div class="table-scrollable rejected_data new_order_calllist">
                           <table id="house_manage_search_rejected_order" class="display full-width">
                              <thead>
                                 <tr>
                                    <th>Sr.No.</th>
                                    <th>Order ID</th>
                              ...
                              <tbody id="append_data2">
                                 ...
                                 <tr>
                                    ...
                                    <td><?php echo $lr['floor'];?></td>
                                    <td>
                                       <div>
                                          <h5 class="text-nowrap"><?php echo $lr['room_no'];?></h5>
                                       </div>
                                    </td>
                                    <td>
                                       <div>
                                          <h5 class="text-nowrap"><?php echo $lr['full_name'];?></h5>
                                       </div>
                                    </td>
                                    <td>
                                       <div>
...
<script>
   $(document).ready(function() {
       $('#example1').DataTable();
       $('#house_manage_search_accepted_order').DataTable();
       $('#house_manage_search_completed_order').DataTable();
       $('#house_manage_search_rejected_order').DataTable();
