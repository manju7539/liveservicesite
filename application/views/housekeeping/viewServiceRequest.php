                        ...
                        <div class=" mb-3 col-md-6 form-group">
                           ...
                           <select name="send_to" class="default-select form-control wide  js-example-disabled-results" required>
                              ...
                              <?php
                                 ...
                                 $wh11 = '(admin_id = "'.$hotel_id.'" AND department_id != 5 )';
                                //  print_r($wh11);die;
...
<script>
   ...
   $(document).on('submit', '#frmblock1', function(e){
       ...
       $.ajax({
           url         : '<?= base_url('HouseKeepingController/add_service_request') ?>',
           method      : 'POST',
           data        : form_data,
           processData : false,
           contentType : false,
           ...
           success     : function(res) {
                   ...
                   $.get( '<?= base_url('Service_request');?>', function( data ) {
...
<script>
   $(document).ready(function (id) {
              $(document).on('click','#service_data',function(){
               ...
               //    alert(id);
                  $.ajax({
                                            url: '<?= base_url('HouseKeepingController/get_service_request') ?>',
                                              type: "post",
                                            data: {id:id},
                                            dataType:"json",
                                            success: function (data) {
     ...
     $(document).on('submit', '#frmupdateblock_service', function(e){
         ...
         var form_data = new FormData(this);
         $.ajax({
             url         : '<?php echo base_url('HouseKeepingController/change_service_request_status') ?>',
             type      : 'POST',
             data        : form_data,
             processData : false,
             contentType : false,
