                                                    ...
                                                    <?php 
                                                            if(!empty($completed_order))
                                                            {
                                                                ...
                                                                foreach($completed_order as $c)
                                                                {
                                                                    ...
                                                                    $get_rm_no_s = $this->AdminModel->getData('user_hotel_booking_details',$wh_rm_no_s);
                                                                    ...
                                                                    //user name
                                                                    $where = '(u_id ="'.$c['u_id'].'")';
                                                                    $get_user_name = $this->AdminModel->getData('register',$where);
                                                                    ...
                                                                    $get_staff_name = $this->AdminModel->getData('register',$where1);
                                                                    ...
                                                                    $get_rm_no_s1 = $this->AdminModel->getData('user_hotel_booking',$wh_rm_no_s1);
                                                                    ...
                                                                    if(!empty($get_rm_no_s))
                                                                    {
                                                                     ...
                                                                     $g_rm_number = $this->AdminModel->getData('room_nos',$wh1);
                                                                     ...
                                                                     $g_rm_confug = $this->AdminModel->getData('room_configure',$wh2);
                                                                     ...
                                                                     $g_rm_floors = $this->AdminModel->getData('floors',$wh3);
