...
<div class="page-content-wrapper">
   <div class="page-content">
      ...
      <div class="alert alert-success update_laun_message" role="alert" id="a"
         style="margin-top:10px; margin-top: 10px;background-color: #4e8759;padding: 4px;border-radius:3px ;display: none;">
         <strong style="color:#fff ;margin-top:10px;">Status Changed Sucessfully !..</strong>
         <span style="  float: right;font-size: 29px;line-height: 0.8;top: 9;color: #fff;"
            aria-hidden="true">&times;</span>
      </div>
      <div class="alert alert-success ordermessage" role="alert" id="a"
         style="margin-top:10px; margin-top: 10px;background-color: #4e8759;padding: 4px;border-radius:3px ;display: none;">
            ...
            <div class="card card-topline-aqua">
               ...
               <div class="card-body ">
                  <div class="col-md-12 col-sm-12">
                     ...
                     <header class="panel-heading panel-heading-gray custom-tab ">
                        <ul class="nav nav-tabs">
                           ...
                           <li class="nav-item"><a href="#house_new_order_div" class="active" data-bs-toggle="tab">New
                                 Order</a>
                           </li>
                           <li class="nav-item"><a href="#house_accepted_order_div" data-bs-toggle="tab">Accepted
                                 Order</a>
                           </li>
                           <li class="nav-item"><a href="#house_completed_order_div" data-bs-toggle="tab">Completed
                                 Order</a>
                           </li>
                           <li class="nav-item"><a href="#house_rejected_order_div" data-bs-toggle="tab">Rejected
                                 Order</a>
                           </li>
                        </ul>
                     </header>
                        ...
                        <div class="mb-1 laundry_time ">
                           <div>
                              <button style="float:left;" type="button" class="btn btn-primary css_btn"
                                 data-bs-toggle="modal" id="timing_btn"
                                 data-idtime="<?= $laundry_time['laundry_time_id'] ?? '' ?>"
                                 ...
                                 if ($laundry_time) {
                                    ?>
                                    PickUp Timing- <?php echo date('G:i:s', strtotime($pick_up_start_time)) ?> to
                                    <?php echo date('G:i:s', strtotime($pick_up_end_time)) ?> <b>/</b>
                                    Drop Timing- <?php echo date('G:i:s', strtotime($drop_start_time)) ?> to
                                    <?php echo date('G:i:s', strtotime($drop_end_time)) ?>
                                    <?php
                                 } else {
                  ...
                  <div class="tab-content">
                                 ...
                                 if (!empty($manage_cloth)) {
                                    ...
                                    foreach ($manage_cloth as $l) {
                                       ...
                                       <tr>
                                          <td><?php echo $i; ?></td>
                                          <td>
                                             <a href="<?php echo $l['image'] ?>" target="_blank"><img class="me-2 "
                                                   src="<?php echo $l['image'] ?>" alt="" style="width:100px; background-color: #175692;"></a>
                                          </td>
                                          <td>
                                          ...
                                          <td class="text-center">
                                             <a href="#" class="btn btn-warning shadow btn-xs sharp me-1" id="edit_data"
                                                data-bs-toggle="modal" data-id="<?php echo $l['cloth_id'] ?>"
                                                data-bs-target=".update_staff_modal"><i class="fa fa-pencil"></i></a>
                                             <a href="#" class="btn btn-danger shadow btn-xs sharp me-1" id="delete_data"
                                                delete-id="<?= $l['cloth_id'] ?>"><i class="fa fa-trash"></i></a>
                                          </td>
                                       </tr>
                                       <?php
                                       $i++;
                     ...
                     ?>
                     <div class="modal fade" id="new_laundry_ord_req_modal_id" tabindex="-1" role="dialog"
                        aria-hidden="true">
                     ...
                     ?>
                     <!-- Modal popup for view-->
                     <div class="modal fade" id="accept_laundry_ord_req_modal_id" tabindex="-1" role="dialog"
                        aria-hidden="true">
                        <div class="modal-dialog modal-lg slideInDown animated">
                           <div class="modal-content">
                              <div class="modal-header">
                     ...
                     ?>
                     <!-- Modal popup for view-->
                     <div class="modal fade" id="complete_laundry_ord_req_modal_id" tabindex="-1" role="dialog"
                        aria-hidden="true">
                        <div class="modal-dialog modal-lg slideInDown animated">
                           <div class="modal-content">
                              <div class="modal-header">
                     ...
                     ?>
                     <!-- Modal popup for view-->
                     <div class="modal fade" id="reject_laundry_ord_req_modal_id" tabindex="-1" role="dialog"
                        aria-hidden="true">
                        <div class="modal-dialog modal-lg slideInDown animated">
                           <div class="modal-content">
                              <div class="modal-header">
   ...
   <div class="row">
      <div class="modal fade" id="notification_names_view_model" tabindex="-1" aria-labelledby="exampleModalLabel"
         aria-hidden="true">
      ...
      <div class="modal-dialog modal-lg">
         <div class="modal-content">
            <form id="frmblock1" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-2">
                              <div class="custom-control custom-radio image-checkbox">
                                 <input type="radio" name="places_name" value="Pant" id="ck2a" class="radio_shown"
                                    data-image="<?php echo base_url(); ?>assets/dist/images/Service_Icons/Laundry/store.png">
                                 <label class="custom-control-label" for="ck2a">
                                    <img
                                       src="<?php echo base_url(); ?>assets/dist/images/Service_Icons/Laundry/store.png"
                                       class="img-fluid cloth-image"
                                       style="height:160px; width:220px; padding: 12px; background-color: #175692;">
                                    <span class="cloth_name-title"
                                       style="display:block; text-align:center; margin-top: 8px; color:#361616;">Pant</span>
                                 </label>
                              </div>
                           </div>
                           ...
                           <div class="col-md-2">
                              <div class="custom-control custom-radio image-checkbox">
                                 <input type="radio" name="places_name" value="Shirt" id="ck2b" class="radio_shown"
                                    data-image="<?php echo base_url(); ?>assets/dist/images/Service_Icons/Laundry/Group7794.png">
                                 <label class="custom-control-label" for="ck2b">
                                    <img
                                       src="<?php echo base_url(); ?>assets/dist/images/Service_Icons/Laundry/Group7794.png"
                                       class="img-fluid cloth-image"
                                       style="height:160px; width:220px; padding: 12px; background-color: #175692;">
                                    <span class="cloth_name"
                                       style="display:block; text-align:center; margin-top: 8px; color:#361616;">Shirt</span>
                                 </label>
                              </div>
                           </div>
                           ...
                           <div class="col-md-2">
                              <div class="custom-control custom-radio image-checkbox">
                                 <input type="radio" name="places_name" value="Saree" id="ck2c" class="radio_shown"
                                    data-image="<?php echo base_url(); ?>assets/dist/images/Service_Icons/Laundry/Group7817.png">
                                 <label class="custom-control-label" for="ck2c">
                                    <img
                                       src="<?php echo base_url(); ?>assets/dist/images/Service_Icons/Laundry/Group7817.png"
                                       class="img-fluid cloth-image"
                                       style="height:160px; width:220px; padding: 12px; background-color: #175692;">
                                    <span class="cloth_name"
                                       style="display:block; text-align:center; margin-top: 8px; color:#361616;">Saree</span>
                                 </label>
                              </div>
                           </div>
                           ...
                           <div class="col-md-2">
                              <div class="custom-control custom-radio image-checkbox">
                                 <input type="radio" name="places_name" value="Skirt" id="ck2d" class="radio_shown"
                                    data-image="<?php echo base_url(); ?>assets/dist/images/Service_Icons/Laundry/Group7793.png">
                                 <label class="custom-control-label" for="ck2d">
                                    <img
                                       src="<?php echo base_url(); ?>assets/dist/images/Service_Icons/Laundry/Group7793.png"
                                       class="img-fluid cloth-image"
                                       style="height:160px; width:220px; padding: 12px; background-color: #175692;">
                                    <span class="cloth_name"
                                       style="display:block; text-align:center; margin-top: 8px; color:#361616;">Skirt</span>
                                 </label>
                              </div>
                           </div>
                           ...
                           <div class="col-md-2">
                              <div class="custom-control custom-radio image-checkbox">
                                 <input type="radio" name="places_name" value="T-shirt" id="ck2e" class="radio_shown"
                                    data-image="<?php echo base_url(); ?>assets/dist/images/Service_Icons/Laundry/Group2.png">
                                 <label class="custom-control-label" for="ck2e">
                                    <img
                                       src="<?php echo base_url(); ?>assets/dist/images/Service_Icons/Laundry/Group2.png"
                                       class="img-fluid cloth-image"
                                       style="height:160px; width:220px; padding: 12px; background-color: #175692;">
                                    <span class="cloth_name"
                                       style="display:block; text-align:center; margin-top: 8px; color:#361616;">T-shirt</span>
                                 </label>
                              </div>
                           </div>
                           ...
                           <div class="col-md-2">
                              <div class="custom-control custom-radio image-checkbox">
                                 <input type="radio" name="places_name" value="Kurta" id="ck2f" class="radio_shown"
                                    data-image="<?php echo base_url(); ?>assets/dist/images/Service_Icons/Laundry/Group7792.png">
                                 <label class="custom-control-label" for="ck2f">
                                    <img
                                       src="<?php echo base_url(); ?>assets/dist/images/Service_Icons/Laundry/Group7792.png"
                                       class="img-fluid cloth-image"
                                       style="height:160px; width:220px; padding: 12px; background-color: #175692;">
                                    <span class="cloth_name"
                                       style="display:block; text-align:center; margin-top: 8px; color:#361616;">Kurta</span>
                                 </label>
                              </div>
                           </div>
                        </div>
               ...
               <!-- Hidden input for storing selected cloth image -->
               <input type="hidden" name="cloth_image" id="cloth_image">
                  ...
                  <div class="basic-form">
                     <div class="row">
                        ...
                        <div class="mb-3 col-md-4">
                           ...
                           <select id="inputState" name="order_from" class="default-select form-control wide" required>
                        ...
                        <div class="mb-3 col-md-4">
                           ...
                           <select id="room_no" class="js-example-disabled-results form-control" name="room_no"
                              required>
                        ...
                        <div class="mb-3 col-md-4">
                           ...
                           <input type="text" class="form-control" name="user_n" placeholder="Guest Name"
                              id="users_name">
                        ...
                        <div class="mb-3 col-md-12">
                           ...
                           <div class="input-group">
                              <div class="new_css">
                                 <select id="cloths_name" class="form-control js-example-disabled-results"
                                    name="cloth_name" required>
                                    <option value="" selected disabled>--Select--</option>
                                    <?php
                                    $admin_id = $this->session->userdata('u_id');
                                    ...
                                    foreach ($cloths as $c) {
                                       ?>
                                       <option value="<?php echo $c["cloth_id"]; ?>"><?php echo $c["cloth_name"]; ?>
                                       </option>
                                       <?php
                                    }
                                    ?>
                              ...
                              <input type="text" class="form-control" id="price1" name="cloth_price"
                                 oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                  ...
                  <div class="row">
                     <div class="mb-3 col-lg-6">
                        ...
                        <div class="input-group">
                           ...
                           <input type="time" name="pick_up_start_time" id="pick_up_start_time" class="form-control"
                              required>
                           <input type="time" name="pick_up_end_time" id="pick_up_end_time" class="form-control"
                              required>
                        </div>
                     </div>
                     <div class="mb-3 col-lg-6">
...
<script>
   document.addEventListener("DOMContentLoaded", function () {
      const radioButtons = document.querySelectorAll('.radio_shown');
      const clothImageInput = document.getElementById('cloth_image');

      radioButtons.forEach(radio => {
         radio.addEventListener('change', function () {
            if (this.checked) {
               clothImageInput.value = this.dataset.image;
            }
         });
      });

      // Set default selected image
      const checkedRadio = document.querySelector('.radio_shown:checked');
      if (checkedRadio) {
         clothImageInput.value = checkedRadio.dataset.image;
      }
   });
</script>