<?php 
                     ...
                     ?>
                       <?php
                                                $i=1;
                                                foreach($get_cloth_orders_data as $g3)
                                                {
                                                
                                                    $wh11 = '(cloth_id ="'.$g3['cloth_id'].'")';
                                                    ...
                                                    $wh12 = '(cloth_order_id ="'.$g3['cloth_order_id'].'")';
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                   <div>
                                                      <h5 class="text-nowrap"><?php echo $g3['quantity']?></h5>
                                                   </div>
                                                </td>
                                                <td>
                                                   <div>
                                                      <h5 class="text-nowrap"><?php echo $g3['price']?></h5>
                                                   </div>
                                                </td>
                                                <td>
                                                   <div>
                                                   <h5 class="text-nowrap"><?php echo $g3['price'] * $g3['quantity']?></h5>
                                                   </div>
                                                </td>
                                             </tr>
                                             <?php 
