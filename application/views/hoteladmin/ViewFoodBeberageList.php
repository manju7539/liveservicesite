    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">Food & Beverage</div>
                </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card-box bg-light">
                                <div class="card-body row">
                                    ...
                                    <div class="custom_icon_block <?=(empty($id))?'active' : 'inactive';?>" id="icon_1" data-id="1">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                             <img src="<?php echo base_url('assets/dist/images/big/food_facility.png')?>" alt="" title="Our Facility" class='icon_size'>
                                             <p class="icon_header">Our Facility</p>
                                        </a> 
            
                                    </div>
                                    <div class="custom_icon_block inactive" id="icon_2" data-id="2">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                             <img src="<?php echo base_url('assets/dist/images/big/food_category.png')?>" alt=""  title="Facility Categories" class='icon_size'>
                                             <p class="icon_header">Categories</p>
                                        </a> 
                                    </div>
                                    <div class="custom_icon_block  inactive" id="icon_3" data-id="3">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                             <img src="<?php echo base_url('assets/dist/images/big/menu.png')?>" alt="" title="Menus" class='icon_size'>
                                             <p class="icon_header">Menus</p>
                                        </a> 
                                    </div>
                                    <div class="custom_icon_block <?= ($id == 4) ? 'active' : 'inactive'; ?>" id="icon_4" data-id="4">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                             <img src="<?php echo base_url('assets/dist/images/big/reserve_table.png')?>" alt="" title="Reserve Table" class='icon_size'>
                                             <p class="icon_header">Reserve Table</p>
                                        </a> 
                                    </div>
                                    </div>
...
<script>
    $(function(){
        ...
        $(".loader_block").show();
        $.ajax({
            url         : '<?= base_url('HoteladminController/ajaxFoodBeverageIcon') ?>',
            method      : 'POST',
