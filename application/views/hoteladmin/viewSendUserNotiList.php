   ...
   <div class="page-content">
      <div class="page-bar">
         <div class="page-title-breadcrumb">
            <div class=" pull-left">
               <div class="page-title">Notification to Users</div>
            </div>
            <ol class="breadcrumb page-breadcrumb pull-right">
               ...
               <li class="active">Notification to Users</li>
            </ol>
         </div>
      </div>
      <div class="row">
         <div class="col-md-12">
            <div class="card card-topline-aqua">
               ...
               <div class="card-body">
                  ...
                  <div class="table-scrollable send_user">
...
<script>
   ...
   $(document).on('submit', '#frmblock', function(e){
      ...
      $.ajax({
         url         : '<?= base_url('HoteladminController/sent_notification_to_users') ?>',
         method      : 'POST',
         data        : form_data,
         processData : false,
         contentType : false,
         ...
         $.get( '<?= base_url('HoteladminController/sendUserNoti');?>', function( data ) {
   ...
   $(document).on('click', '#delete_data', function (event) {
         ...
         swal({
               ...
               if (isConfirm) {
                  $.ajax({
                     url: '<?= base_url('HoteladminController/user_delete_notification') ?>',
                     method: "POST",
                     data: { id: id },
                     dataType: "html",
