                ...
                <div class="card-box">
                    <div class="card-body ">
                        ...
                        <?php
                            ...
                            {
                                foreach ($get_front_ofs_notifications as $fo_nt) 
                                {
                                    $wh = '(notification_id = "'.$fo_nt['notification_id'].'" AND department_id = 2)';

                                    $notifictions_department_id = $this->HotelAdminModel->getAllData('notifictions_department_id',$wh);
			                        // echo "<pre>";print_r($notifictions_department_id);die;
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-10">
                                                <h5 class="fw-bold"><?php echo $fo_nt['title']?></h5>
                                                <span><?php echo $fo_nt['description']?></span>
                                            </div>
                                            <div class="col-md-2">
                                                <h5><?php echo date('d F Y',strtotime($fo_nt['created_at']))." - ".date('h:i a',strtotime($fo_nt['created_at'])) ?></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
