...
<header><span class="page_header_title11">Buy Plan</span></header>
                ...
                <div class="text-center ">
                    <button type="submit" class="btn btn-primary btn-sm" data-bs-toggle="modal"
                        data-bs-target="#exampleModalCenter" style="margin-bottom:10px;margin-top:10px;"> Add Wallet Amount</button>
                </div>
                        ...
                        <div class="outer-box">
                            <div class="row">
                                ...
                                ?>
                                            ...
                                            <div class="pricing-block col-md-3 wow fadeInUp">
                                                <div class="inner-box">
                                                    <div class="icon-box">
                                                   ...
                                                   <!-- <div class="price-box">
                                                    ...
                                                    <div class="btn-box">
                                                        <a href="<?php echo base_url('HoteladminController/purchase_leads/'.$admin_id.'/'.$l_p['leads_plan_id'].'/'.$l_p['amount'])?>" class="theme-btn">Buy plan</a>
                                                    </div>
                                                </div>
                                            </div>
                                <?php
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="mb-3 col-md-12">
                                ...
                                <input type="number" id="amount" min="1" name="amount" class="form-control" placeholder="Enter amount" required>
                            </div>
                        </div>
                    </div>
