...
<div class="page-content-wrapper">
                                ...
                                <div class="card-body row">
                                    ...
                                    <div class="custom_icon_block active" id="icon_1" data-id="1">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                             <img src="<?php echo base_url('assets/dist/images/big/enquiry.png')?>" alt="" title="Enquiry Request" style="height:75px;">
                                        </a> 
                                        <!-- <div class="tooltip">
  <span class="tooltiptext">Tooltip text</span>
                                    ...
                                    <div class="custom_icon_block inactive" id="icon_2" data-id="2">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                             <img src="<?php echo base_url('assets/dist/images/big/room_status.png')?>" alt=""  title="Room Status" style="height:75px;">
                                        </a> 
                                    </div>
                                    <div class="custom_icon_block1 inactive" id="icon_3" data-id="3">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                             <img src="<?php echo base_url('assets/dist/images/big/digital_check.png')?>" alt="" title="Digital Check-in" style="height:75px;">
                                        </a> 
                                    </div>
                                    <div class="custom_icon_block inactive" id="icon_4" data-id="4">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                             <img src="<?php echo base_url('assets/dist/images/big/floors_new.png')?>" alt="" title="Floor" style="height:75px;">
                                        </a> 
                                    </div>
                                    ...
                                    <div class="custom_icon_block inactive" id="icon_5" data-id="5">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                             <img src="<?php echo base_url('assets/dist/images/big/room_type.png')?>" alt="" title="Add Room Type" style="height:75px;">
                                        </a> 
                                    </div>
                                    <div class="custom_icon_block inactive" id="icon_6" data-id="6">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                             <img src="<?php echo base_url('assets/dist/images/big/room_configure_new.png')?>" alt="" title="Room Configure" style="height:75px;">
                                        </a> 
                                    </div>
                                    <div class="custom_icon_block inactive" id="icon_7" data-id="7">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                             <img src="<?php echo base_url('assets/dist/images/big/business_new.png')?>" alt="" title="Add Business Center" style="height:75px;">
                                        </a> 
                                    </div>
                                    <div class="custom_icon_block inactive" id="icon_8" data-id="8">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                             <img src="<?php echo base_url('assets/dist/images/big/business_new.png')?>" alt="" title="Business Center Reservation" style="height:75px;">
                                        </a> 
                                    </div>
                                    ...
                                    <div class="custom_icon_block inactive" id="icon_9" data-id="9">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                             <img src="<?php echo base_url('assets/dist/images/big/enquiry.png')?>" alt="" title=" Service Request" style="height:75px;">
                                        </a> 
                                    </div>
                                    <div class="custom_icon_block inactive" id="icon_10" data-id="10">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                             <img src="<?php echo base_url('assets/dist/images/big/service.png')?>" alt="" title="Services" style="height:75px;">
                                        </a> 
                                    </div>
                                    <div class="custom_icon_block inactive" id="icon_11" data-id="11">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                             <img src="<?php echo base_url('assets/dist/images/big/lost.png')?>" alt="" title="Lost & Found" style="height:75px;">
                                        </a> 
                                    </div>
                                    
                                    <div class="custom_icon_block inactive" id="icon_12" data-id="12">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                             <img src="<?php echo base_url('assets/dist/images/big/User_new.png')?>" alt="" title="Accounts" style="height:75px;">
                                        </a> 
                                    </div>
                                    ...
                                    <div class="custom_icon_block inactive" id="icon_13" data-id="13">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                             <img src="<?php echo base_url('assets/dist/images/big/visitors.png')?>" alt="" title="Visitors" style="height:75px;">
                                        </a> 
                                    </div>
                                    <div class="custom_icon_block inactive" id="icon_14" data-id="14">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                             <img src="<?php echo base_url('assets/dist/images/big/night_audit.png')?>" alt="" title="Night Audit" style="height:75px;">
                                        </a> 
                                    </div>
                                    <div class="custom_icon_block inactive" id="icon_15" data-id="15">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                             <img src="<?php echo base_url('assets/dist/images/big/guide.png')?>" alt="" title="Hotel Guide" style="height:75px;">
                                        </a> 
                                    </div>
                                    <div class="custom_icon_block inactive" id="icon_16" data-id="16">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                             <img src="<?php echo base_url('assets/dist/images/dispute_new.png')?>" alt="" title=" Raise Dispute" style="height:75px;">
                                        </a> 
                                    </div>
                                </div>
                                <!-- <div> -->
                                    <div id="aniimated-thumbnials" class="list-unstyled row clearfix gallery_subsection" style="background: #e8e8e8bd;padding: 14px;margin-top: 10px;display:none">
                                        <div class="active services_subsection" id="sub_icon_16" sub-id="1" data-id="10">
                                            <a href="javascript:void(0)" data-sub-html="Demo Description">
                                                <img src="<?php echo base_url('assets/dist/images/new/gym.png')?>" alt=""  title="Gym Service"   style="height:75px;">
                                            </a> 
                                        </div>
                                        <div class="services_subsection inactive" id="sub_icon_16" sub-id="2" data-id="10">
                                            <a href="javascript:void(0)" data-sub-html="Demo Description">
                                                <img src="<?php echo base_url('assets/dist/images/new/spa.png')?>" alt=""  title="Spa Service"  style="height:75px;">
                                            </a> 
                                        </div>
                                        <div class="services_subsection inactive" id="sub_icon_16" sub-id="3" data-id="10">
                                            <a href="javascript:void(0)" data-sub-html="Demo Description">
                                                <img src="<?php echo base_url('assets/dist/images/new/pool.png')?>" alt=""  title="Pool Service"  style="height:75px;">
                                            </a> 
                                        </div>
                                        <div class="inactive services_subsection" id="sub_icon_16" sub-id="4" data-id="10">
                                            <a href="javascript:void(0)" data-sub-html="Demo Description">
                                                <img src="<?php echo base_url('assets/dist/images/new/shuttle.png')?>" alt=""  title="Shuttle Service"  style="height:75px;">
                                            </a> 
                                        </div>
                                        <div class="inactive services_subsection" id="sub_icon_16" sub-id="5" data-id="10">
                                            <a href="javascript:void(0)" data-sub-html="Demo Description">
                                                <img src="<?php echo base_url('assets/dist/images/new/baby_care.png')?>" alt=""  title="Baby care Service" style="height:75px;">
                                            </a> 
                                        </div>
                                        <div class="inactive services_subsection" id="sub_icon_16" sub-id="6" data-id="10">
                                            <a href="javascript:void(0)" data-sub-html="Demo Description">
                                                <img src="<?php echo base_url('assets/dist/images/new/car_wash.png')?>" alt=""  title="Car Wash Service"  style="height:75px;">
                                            </a> 
                                        </div>
                                        <div class="inactive services_subsection" id="sub_icon_16" sub-id="7" data-id="10">
                                            <a href="javascript:void(0)" data-sub-html="Demo Description">
                                                <img src="<?php echo base_url('assets/dist/images/new/cloackroom.png')?>" alt="" title="Cloakroom Service"   style="height:75px;">
                                            </a> 
                                        </div>
                                        <div class="inactive services_subsection" id="sub_icon_16" sub-id="8" data-id="10">
                                            <a href="javascript:void(0)" data-sub-html="Demo Description">
                                                <img src="<?php echo base_url('assets/dist/images/new/cab.png')?>" alt=""  title="Cab Service"  style="height:75px;">
                                            </a> 
                                        </div>
                                    </div>
                                    ...
                                    <div id="aniimated-thumbnials" class="list-unstyled row clearfix gallery_subsection1" style="background: #e8e8e8bd;padding: 14px;margin-top: 10px;display:none">
                                        ...
                                        <div class="inactive services_subsection" id="sub_icon_16" sub-id="n1" data-id="3">
                                            <a href="javascript:void(0)" data-sub-html="Demo Description">
                                                <img src="<?php echo base_url('assets/dist/images/new/arrival.png')?>" alt=""  title="Arrival"  style="height:75px;">
                                            </a> 
                                        </div>
                                        <div class="inactive services_subsection" id="sub_icon_16" sub-id="n2" data-id="3">
                                            <a href="javascript:void(0)" data-sub-html="Demo Description">
                                                <img src="<?php echo base_url('assets/dist/images/new/departure.png')?>" alt=""  title="Departure"  style="height:75px;">
                                            </a> 
                                        </div>
                                    </div>
