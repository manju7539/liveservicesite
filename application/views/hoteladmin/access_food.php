                                            ...
                                            <td>
                                                <div class="text-center">
                                                    <div class="form-check custom-checkbox checkbox-info ">
                                                        <input type="hidden" name="service_name" id="service_name_<?php echo $access_data['access_to_department_id']??0?>" value="<?php echo $h_av_se['service_name']?>"><input type="hidden" name="service_name" id="service_name_<?php echo $access_to_department_id?>" value="<?php echo $h_av_se['service_name']?>">
                                                        <input type="hidden" name="front_ofs_admin_id" id="front_ofs_admin_id" value="<?php echo $this->uri->segment(3)?>">
                                                        <?php
                                                            if($is_access)
                                                            {
                                                        ?>
