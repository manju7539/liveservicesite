    ...
    function change_status(cnt) {
             ...
             $(".loader_block").show();
              ...
              if (status != '') {
                  ...
                  $.ajax({
                      url: base_url + "HoteladminController/change_status_of_checkout_request",
                      method: "POST",
                      data: {
                        status: status,
                          uid: uid
                      ...
                      success: function(res) {
                        ...
                        //   alert(data);
                        $.get( '<?= base_url('checkOutRequestAdmin');?>', function( data ) {
   ...
   $(document).ready(function() {
       ...
       function action_status(cnt) {
             ...
             $(".loader_block").show();
              ...
              if (status != '') {
                  $.ajax({
                      url: base_url + "HoteladminController/checkout_action_change",
                      method: "POST",
                      data: {
                        status: status,
                          uid: uid
