    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">All Restaurant & Bar Notification</div>
                </div>
                ...
                <div class="card-box">
                    <div class="card-body ">
                        ...
                        <?php 
                            ...
                            $get_notification_data = $this->HotelAdminModel->get_notifications_for_food_1($admin_id,$today_date);
                            // echo "<pre>";print_r($get_notification_data);die;
