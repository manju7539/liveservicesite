<div class="alert alert-success successmessage20" role="alert" id="a" style="margin-top:10px; margin-top: 10px;background-color: #4e8759;padding: 4px;border-radius:3px ;display: none;">
   <strong style="color:#fff ;margin-top:10px;">Vehicle type Already Exiest.</strong>
...
<div class="alert alert-success successmessage" role="alert" id="a" style="margin-top:10px; margin-top: 10px;background-color: #4e8759;padding: 4px;border-radius:3px ;display: none;">
   <strong style="color:#fff ;margin-top:10px;">Booking Successfully..!</strong>
   <span style="  float: right;font-size: 29px;line-height: 0.8;top: 9;color: #fff;" aria-hidden="true">&times;</span>
</div>
...
<style>
   ...
   .hotel_list_spa .container-fluid {
   padding: 0px
   }
   .spa_added .container-fluid {
   padding: 0px
   }
   .spa_change_record1 .container-fluid {
   padding: 0px
   }
   .spa_change_record2 .container-fluid {
   padding: 0px
   }
   .spa_change_record3 .container-fluid {
   padding: 0px
   }
   .sub_iconlist .container-fluid {
   padding: 0px
   }
</style>
<style>
...
<div class="col-md-12">
   <div class="card card-topline-aqua">
      ...
      <div class="table-scrollable" id="gym_data" style>
...
<div class="col-md-12">
   <div class="card card-topline-aqua">
      ...
      <div class="card-body ">
         ...
         <div class="tab-content">
            ...
            <div class="tab-pane active" style="background-color:white;" id="arrival1_div_spa">
               <div class="table-scrollable hotel_list_spa" id="spa_data_info">
                  <table id="example1" class="display full-width">
                     <thead>
                  ...
                  <table id="acceptedOrder_tb_spa" class="display full-width">
                     ...
                     <tbody id="searchTable">
                        ...
                        <tr>
                           ...
                           <input type="hidden" name="useruid" id="useruid<?php echo $spa_r_s['spa_service_request_id']; ?>" value="<?php echo $spa_r_s['u_id']; ?>">
      ...
      <div class="modal fade" id="edit_spa_model_info" tabindex="-1" style="display: none;" aria-hidden="true">
         <div class="modal-dialog modal-lg">
            <div class="modal-content">
               <div class="modal-header">
                  <h5 class="modal-title">Edit schedule</h5>
               ...
               <div class="modal-body">
                  <form id="editspaCenterinfo" method="post" enctype="multipart/form-data">
                           <input type="hidden" name="front_ofs_service_id" id="front_ofs_service_id">
                           ...
                           <div class="modal-body">
                              <div class="col-lg-12">
                                 <div class="basic-form">
                                    ...
                                    <div id="spaImagesContainer" class="row">
                                 ...
                                 <div class="row">
                                    ...
                                    <?php
                                       ...
                                       ?>
                                    <div class="col-md-6 ">
                                       <input type="hidden" name="front_ofs_service_img_id" id="front_ofs_service_imageinfo2">
                                       ...
                                       <img src="" id="img_info2" alt="Not Found" height="50" width="50">
                                    </div>
                                    <?php
                                       $j++;
                                       }
...
<div class="modal fade" id="notification_spa_view_model" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-dialog" style="max-width: 700px;">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title"><b>Description</b></h5>
         ...
         <div class="modal-body">
            <div class="basic-form get_data_model_info">
            </div>
         </div>
      </div>
   </div>
</div>
<div class="modal fade" id="notification_spaterm_view_model" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-dialog" style="max-width: 700px;">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title"><b>Terms And Conditions</b></h5>
         ...
         <div class="modal-body">
            <div class="basic-form get_data_model_info_term">
            </div>
         </div>
      </div>
   </div>
...
<!-- add btn modal  -->
<!-- packages -->
<div class="modal fade" id="notification_spaimage_view_model" style="display: none;" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
         <div class="modal-header">
         ...
         <div class="modal-body">
            <div class="guest-profile get_data_model_info_image">
            </div>
         </div>
      </div>
   </div>
</div>
<div class="modal fade" id="notification_spa_request_model" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
         <div class="modal-header">
         ...
         <div class="modal-body">
            <div class="basic-form get_note_model_sparequest">
            </div>
         </div>
         <div class="modal-footer">
            <button type="button" class="btn btn-light css_btn" data-dismiss="modal">Close</button>
...
<script type="text/javascript">
   $(document).ready(function() {
      ...
      //  console.log(hello);
      table_spa = $('#requestOrder_tb_spa').DataTable({
         "order": [],
         'processing': true,
         'serverSide': true,
         "bDestroy": true,
         'serverMethod': 'post',
         'ajax': {
            'url': '<?= base_url() ?>' + 'HoteladminController/get_spa_order_data',
         },
         'columns': [{
               data: 'Sr_No'
            },
      ...
      setInterval(function() {
         table_spa.ajax.reload();
      }, 30000);
   });
   
   $(document).on('click', '.edit_model_info', function() {
   
      var id = $(this).attr('data-unic-idinfo');
   
      $('#notification_spa_view_model').modal('show');
      ...
      $.ajax({
         // method: "POST",
         // url: base_url+"HoteladminController/get_view_name_data_notification",
         url: '<?= base_url('HoteladminController/get_discri_name_data_info') ?>',
         type: "post",
         data: {
            id: id
         },
         ...
         success: function(response) {
            console.log(response);
            $('.get_data_model_info').html(response);
         }
      });
   });
   
   $(document).on('click', '.edit_model_info_term', function() {
   
      var id = $(this).attr('data-unic-idinfoterm');
   
      $('#notification_spaterm_view_model').modal('show');
      ...
      $.ajax({
         // method: "POST",
         // url: base_url+"HoteladminController/get_view_name_data_notification",
         url: '<?= base_url('HoteladminController/get_discri_name_data_infoterm') ?>',
         type: "post",
         data: {
            id: id
         },
         ...
         success: function(response) {
            console.log(response);
            $('.get_data_model_info_term').html(response);
         }
      });
   });
   
   $(document).on('click', '.edit_model_info_image', function() {
   
      var id = $(this).attr('data-unic-idinfoimage');
   
      $('#notification_spaimage_view_model').modal('show');
      ...
      $.ajax({
         // method: "POST",
         // url: base_url+"HoteladminController/get_view_name_data_notification",
         url: '<?= base_url('HoteladminController/get_discri_name_data_infoimage') ?>',
         type: "post",
         data: {
            id: id
         },
         ...
         success: function(response) {
            console.log(response);
            $('.get_data_model_info_image').html(response);
         }
      });
   });
   $(document).on('click', '.edit_spa_request_click', function() {
   
      var id = $(this).attr('data-sparequest-id');
   
      $('#notification_spa_request_model').modal('show');
      ...
      $.ajax({
         // method: "POST",
         // url: base_url+"HoteladminController/get_view_name_data_notification",
         url: '<?= base_url('HoteladminController/get_discri_name_data_spa_request') ?>',
         type: "post",
         data: {
            id: id
         },
         ...
         success: function(response) {
            console.log(response);
            $('.get_note_model_sparequest').html(response);
         }
      });
   });
...
<script>
   $(document).on('click', '#edit_spa_data', function() {
      ...
      $.ajax({
         ...
         success: function(data) {
            console.log(data);
            $('#spa_service_request_id1').val(data.spa_service_request_id);
            $('#u_id').val(data.u_id);
         ...
         success: function(res) {
            ...
            setTimeout(function() {
               ...
               $(".update_spa_modal_change").on("hidden.bs.modal", function() {
                  ...
                  $('#spa_service_request_id1').css('display', 'none');
                  $('.rejectreasonddd').css('display', 'none');
               });
               $(".updatemessage").show();
               $(".append_data11").html(res);
...
<script>
   ...
   $(document).on('click', '#edit_spa_info', function() {
      var id = $(this).attr('data-idspainfo');
      // alert(id);a
      $.ajax({
         url: '<?= base_url('HoteladminController/geteditspainfo') ?>',
         type: "post",
         data: {
            id: id
         },
         ...
         success: function(data) {
            ...
            console.log(data.data);
                  ...
                  $('#front_ofs_service_imageinfo2').val(data.images.front_ofs_service_id);
                  $("#img_info2").attr('src', data.images.image);
                  ...
                  html += '<div id="TextBoxContainer12_' + s_im.front_ofs_service_id + '" class="mb-1">';
                  html += '</div>'; 
...
$('#editspaCenterinfo').submit(function(e) {
        ...
        $.ajax({
           ...
           success: function(res) {
              ...
              setTimeout(function() {
                 ...
                 $(".loader_block").hide();
                 $("#edit_spa_model_info").modal('hide');
...
<div class="col-md-12">
   <div class="card card-topline-aqua">
      ...
      <div class="card-body" >
         <div class="table-scrollable sub_iconlist" id="Pool_div">
            <table id="example1" class="display full-width">
               <thead>
                  <tr>
                     <th><strong>Sr. No.</strong></th>
   ...
   $(document).bind('submit').on('submit', '#editpoolCenterForm', function(e) {
      ...
      $.ajax({
         ...
         success: function(res) {
            ...
            $.get('<?= base_url('HoteladminController/ajaxpoolIconView_v1'); ?>', function(data) {
               var resu = $(data).find('#Pool_div').html();
               $('#Pool_div').html(resu);
               setTimeout(function() {
                  $('#example1').DataTable();
            ...
            <table id="example1" class="display full-width">
               ...
               <tbody id="searchTable">
                  ...
                  <tr>
                     ...
                     <td><?php echo date('d-m-Y',strtotime($gl['actual_checkout'])) ?></td>
...
<div class="col-md-3">
<button style="float:right;" type="button" class="btn btn-primary css_btn today_arrival_add_guest_btn ">Add Walking Guest</button>
</div>
</div>
<br>
<div class="table-scrollable today_arrival_tbl_div">
<!-- id="example1" -->
<table id="today_arrival_tbl_id" class="display full-width">
<thead>
<tr>
<th>Sr. No.</th>
<th>Booking ID</th>
...
<td>
<?php echo date('d-m-Y',strtotime($t_h_b['check_in'])); ?>
</td>
<td>
<?php echo date('d-m-Y',strtotime($t_h_b['check_out'])); ?>
</td>
<td>
<?php echo $mobile_no ?>
</td>
...
<!-- Chiragi Start :: modal for add guest (today arrival) -->
<div class="modal fade today_arrival_add_guest_modal" tabindex="-1" style="display: none;" aria-hidden="true">
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title">Add Walking Guest</h5>
         ...
         <form id="form_today_arrival" method="post" enctype="multipart/form-data">
            <div class="modal-body">
               <div class="col-lg-12">
                  <div class="basic-form">
                     <div class="row">
...
<!-- Chiragi End :: modal for add guest (today arrival) -->
...
<script>
   $(document).ready(function() {
     today_arrival_datatable = $('#today_arrival_tbl_id').DataTable({
        "order": [],
        'processing': true,
        'serverSide': true,
        "bDestroy": true,
        'serverMethod': 'post',
        'ajax': {
           "url": '<?= base_url() ?>' + 'HoteladminController/new_data_of_today_arrival_data',
        },
        'columns': [{
              data: 'sr_no'
           },
     ...
     setInterval(function() {
        today_arrival_datatable.ajax.reload();
     }, 30000);
   
     $(document).on('click','.today_arrival_add_guest_btn', function () {
        $('.today_arrival_add_guest_modal').modal('show');
     });
   
     $('#form_today_arrival').submit(function(e){
        e.preventDefault(); 
        // alert('hello!');
        $(".loader_block").show();
        var form_data = new FormData(this);
        ...
        $.ajax({
           url         : '<?= base_url('HoteladminController/add_walking_guest') ?>',
           method      : 'POST',
           data        : form_data,
           processData : false,
           contentType : false,
           ...
           success     : function(res) {
              ...
              setTimeout(function(){  
              $(".loader_block").hide();
              $(".today_arrival_add_guest_modal").modal('hide');
              $("#form_today_arrival")[0].reset();
              $("#display_rooms_no").html('');
              $(".successmessage").show();
              }, 200);
              setTimeout(function(){  
                 $(".successmessage").hide();
...
<div class="card-body">
   <div class="new_orders_div_service">
      <div class="table-scrollable sub_iconlist" id="shuttle_data">
         <table id="example1" class="display full-width">
            <thead>
               <tr>
                  <th>Sr. No.</th>
                  ...
                  <td>
                     ...
                     <a  href="#" title="Availability" 
                        class="btn btn-info shadow btn-xs sharp" onclick="orderservice1(<?php echo $sh_f_s['front_ofs_service_id'] ?>)" ><i
                            class="fa fa-list"  ></i></a>
                     <!-- <a href="#" class="btn btn-secondary shadow btn-xs sharp me-1 shuttle_model" data-bs-toggle="modal" room-id=<?= $sh_f_s['front_ofs_service_id'] ?> data-bs-target=".bd-view-modal"><i class="fa fa-list"></i> -->
                     </a>
                  </td>
               </tr>
               <?php
            ...
            <div class="tab-pane" id="monday_div" style="background-color:white;">
               ...
               <div class="table-scrollable">
                  <table id="monday_tbl" class="display full-width">
                     ...
                     <tbody id="searchTable" class="append_monday">
                        <?php
                           if ($mon_list) {
                           ...
                           <td>
                              <div class="container">
                                 ...
                                 <?php
                                    ...
                                    ?>
                                 <input type="checkbox" value="1" name="available_status" id="status_<?php echo $thu_l['shuttle_service_avaibility_id'] ?>" onchange="change_status(<?php echo $thu_l['shuttle_service_avaibility_id'] ?>)" class="switch-input">
                                 <span class="switch-label" data-off="Unavailable"></span>
                                 <span class="switch-handle"></span>
                                 <?php
                                    }
...
<script>
   ...
   $(document).unbind('submit').on('submit', '#editshuttleCenterForm12', function(e) {
         ...
         var form_data = new FormData(this);
         $.ajax({
            url: '<?= base_url('HoteladminController/add_shuttle_service_staff_avaibility') ?>',
            method: 'POST',
            data: form_data,
            processData: false,
            contentType: false,
            ...
            success: function(res) {
               // console.log(res);
               $.get('<?= base_url('HoteladminController/shuttle_availabilty'); ?>', function(data) {
                  var resu = $(data).find('#sunday_div').html();
                  var resu1 = $(data).find('#monday_div').html();
                  var resu2 = $(data).find('#tuesday_div').html();
                  var resu3 = $(data).find('#wednesday_div').html();
                  var resu4 = $(data).find('#thursday_div').html();
                  var resu5 = $(data).find('#friday_div').html();
                  var resu6 = $(data).find('#saturday_div').html();

                  $('#sunday_div').html(resu);
                  $('#monday_div').html(resu1);
                  $('#tuesday_div').html(resu2);
                  $('#wednesday_div').html(resu3);
                  $('#thursday_div').html(resu4);
                  $('#friday_div').html(resu5);
                  $('#saturday_div').html(resu6);
                     ...
                     setTimeout(function() {
                        ...
                        $('#friday_tbl').DataTable();
                        $('#saturday_tbl').DataTable();
                        var day = form_data.get('day'); 
                        // console.log("hi");return false;
                        // console.log(day);return false;// Change this to your desired condition
                           if (day === "Sunday") {
                              $('a[href="#sunday_div"]').tab('show');
                           } else if (day === "Monday") {
                              $('a[href="#monday_div"]').tab('show');  
                           } else if (day === "Tuesday") {
                              $('a[href="#tuesday_div"]').tab('show');   
                           } else if (day === "Wednesday") {
                              $('a[href="#wednesday_div"]').tab('show');  
                           } else if (day === "Thursday") {
                              $('a[href="#thursday_div"]').tab('show');   
                           } else if (day === "Friday") {
                              $('a[href="#friday_div"]').tab('show');  
                           } else if (day === "Saturday") {
                              $('a[href="#saturday_div"]').tab('show');   
                           }  
                           else {
                              $('a[href="#sunday_div"]').tab('show');
                           }
   ...
   $(document).bind('submit').on('submit', '#editshuttleCenterForm', function(e) {
      ...
      $.ajax({
         ...
         success: function(res) {
            ...
            $.get( '<?= base_url('HoteladminController/ajaxshuttleIconView_v1'); ?>', function( data ) {
                    var resu = $(data).find('#shuttle_data').html();
                    $('#shuttle_data').html(resu);
...
<div class="col-md-12">
   <div class="card card-topline-aqua">
      ...
      <div class="card-body ">
         <div class="table-scrollable sub_iconlist" id="baby_data">
            <table id="example1" class="display full-width">
               <thead>
                  <tr>
                     <th><strong>Sr. No.</strong></th>
   ...
   $(document).bind('submit').on('submit', '#editbabyCenterForm', function(e) {
      ...
      $.ajax({
         ...
         success: function(res) {
            ...
            $.get( '<?= base_url('HoteladminController/ajaxbabyIconView_v1'); ?>', function( data ) {
                    var resu = $(data).find('#baby_data').html();
                    $('#baby_data').html(resu);
      ...
      <div class="card-body ">
         ...
         <div class="tab-content">
            <div class="tab-pane active" style="background-color:white;" id="new_orders_div">
               ...
               <div class="table-scrollable sub_iconlist car_change_record">
                  <table id="requestOrder_tb_carwash" class="display full-width">
                     <thead>
                        <tr>
                           <th><strong>Sr. No.</strong></th>
                           <th><strong>Guest Name</strong></th>
            ...
            <div class="tab-pane" id="accepted_orders_div" style="background-color:white;">
               <div class="table-scrollable car_change_record1 sub_iconlist">
                        ...
                        <tr>
                           ...
                           <td>
                              <div id="lightgallery" class="room-list-bx  align-items-center">
                                 <a href="<?php echo $v_w_r['vehicle_img'] ?>" target=".blank" data-exthumbimage="<?php echo $v_w_r['vehicle_img'] ?>" data-src="<?php echo $v_w_r['vehicle_img'] ?>" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                           ...
                           <input type="hidden" name="caruid" id="caruid<?php echo $v_w_r['vehicle_wash_request_id']; ?>" value="<?php echo $v_w_r['u_id']; ?>">
                           <td>
            ...
            <div class="tab-pane" id="completed_orders_div_new" style="background-color:white;">
               <div class="table-scrollable car_change_record2 sub_iconlist">
                  <table id="completedOrder_tb" class="display full-width">
                     ...
                     <tbody id="searchTable">
                        ...
                        <tr>
                           ...
                           <td>
                              <div id="lightgallery" class="room-list-bx  align-items-center">
                                 <a href="<?php echo $v_w_c['vehicle_img'] ?>"  target=".blank" data-exthumbimage="<?php echo $v_w_c['vehicle_img'] ?>" data-src="<?php echo $v_w_c['vehicle_img'] ?>" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
            ...
            <div class="tab-pane" id="rejected_orders_div_new" style="background-color:white;">
               <div class="table-scrollable car_change_record3 sub_iconlist">
            ...
            <div class="tab-pane" id="rejected_orders_div" style="background-color:white;">
               <div>
                  <button style="float:right" type="button" class="btn btn-primary css_btn add_charges" data-bs-toggle="modal">Add Washing
                  Charges</button>
               </div>
               <br><br>
               <!-- add -->
               <div class="table-scrollable sub_iconlist">
                  <table id="rejectedOrder_tb" class="display full-width">
                     ...
                     <tbody id="searchTable" class="append_data_charges">
                        <?php
                           $i = 1;
...
<div class="modal fade add_charges_modal" tabindex="-1" style="display: none;" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
         <div class="modal-header">
               ...
               <div class="basic-form">
                  <div class="row">
                     <div class="mb-3 col-md-12">
                        ...
                        <input type="hidden" name="hotel_id" id="hotel_id1">
...
<div class="modal fade" id="notification_car_request_model" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title">Description:</h5>
         ...
         <div class="modal-body">
            <div class="basic-form get_note_model_carrequest">
            </div>
         </div>
         <div class="modal-footer">
            <button type="button" class="btn btn-light css_btn" data-dismiss="modal">Close</button>
...
<script type="text/javascript">
   $(document).ready(function() {
      ...
      // var table_visiters = $('#visiters_tb').DataTable();
      //  console.log(hello);
      table_carwash = $('#requestOrder_tb_carwash').DataTable({
         "order": [],
         'processing': true,
         'serverSide': true,
         "bDestroy": true,
         'serverMethod': 'post',
         'ajax': {
            'url': '<?= base_url() ?>' + 'HoteladminController/get_carwash_order_data',
         },
         'columns': [
      ...
      setInterval(function() {
         table_carwash.ajax.reload();
      }, 30000);
   });
   
   $(document).on('click', '.edit_car_request_click', function() {
   
      var id = $(this).attr('data-carrequest-id');
   
      $('#notification_car_request_model').modal('show');
      ...
      $.ajax({
         // method: "POST",
         // url: base_url+"HoteladminController/get_view_name_data_notification",
         url: '<?= base_url('HoteladminController/get_discri_name_data_carwash_request') ?>',
         type: "post",
         data: {
            id: id
         },
         ...
         success: function(response) {
            console.log(response);
            $('.get_note_model_carrequest').html(response);
         }
      });
   });
...
<script>
   $(document).ready(function() {
      // $('#requestOrder_tb_carwash').DataTable();
      $('#acceptedOrder_tb').DataTable();
      $('#completedOrder_tb').DataTable();
      //   $('#completedOrder_tb').DataTable();
      $('#rejectedOrder_tb_new').DataTable();
...
<script>
   $(document).on('click', '#edit_car_data', function() {
      ...
      $.ajax({
         ...
         success: function(data) {
            console.log(data);
            $('#vehicle_wash_request_id1').val(data.vehicle_wash_request_id);
            $('#u_id1').val(data.u_id);
         ...
         success: function(res) {
            ...
            setTimeout(function() {
               ...
               $(".update_car_modal_change").on("hidden.bs.modal", function() {
                  ...
                  $('#vehicle_wash_request_id1').css('display', 'none');
                  $('.rejectreasonddd').css('display', 'none');
...
<script>
   $(document).on("click",".add_charges",function(){
       $(".add_charges_modal").modal('show');
   });
   $(document).on("click",".edit_charges",function(){
       $(".edit_charges_model").modal('show');
   });
   $('#frmblockcharges').submit( function(e){
       ...
       var form_data = new FormData(this);
       $.ajax({
           url         : '<?= base_url('HoteladminController/add_vehicle_washing_charges') ?>',
           method      : 'POST',
           data        : form_data,
           processData : false,
           contentType : false,
           ...
           success     : function(res) {
            ...
            $.get( '<?= base_url('HoteladminController/ajaxSubIconBlockView1');?>', function( data ) {
                    var resu = $(data).find('#rejected_orders_div').html();
                    $('#rejected_orders_div').html(resu);
                    setTimeout(function(){
                ...
                if(res == 1)
               {
                ...
                $(".add_charges_modal").modal('hide');
                  $(".add_charges_modal").on("hidden.bs.modal", function() {
   ...
   $(document).ready(function (id) {
       ...
       $.ajax({
           url         : '<?= base_url('HoteladminController/edit_vehicle_washing_charges') ?>',
           method      : 'POST',
           data        : form_data,
           processData : false,
           contentType : false,
...
<div class="tab-pane active" style="background-color:white;" id="new_orders_div1">
   ...
   <div class="table-scrollable luggage_change_record sub_iconlist">
      <table id="requestOrder_tb_luggage" class="display full-width">
         <thead>
            <tr>
               <th><strong>Sr. No.</strong></th>
               <th><strong>Guest Name</strong></th>
...
<div class="tab-pane" id="accepted_orders_div1" style="background-color:white;">
   <div class="table-scrollable luggage_change_record1 sub_iconlist">
      <table id="acceptedOrder_tb1" class="display full-width">
         ...
         <tbody id="searchTable">
            ...
            <tr>
               ...
               <input type="hidden" name="luggageuid" id="luggageuid<?php echo $lug_r['luggage_request_id']; ?>" value="<?php echo $lug_r['u_id']; ?>">
               <td>
...
<div class="tab-pane" id="completed_orders_div1_new" style="background-color:white;">
   <div class="table-scrollable luggage_change_record2 sub_iconlist">
...
<div class="tab-pane" id="rejected_orders_div1_new" style="background-color:white;">
   <div class="table-scrollable luggage_change_record3 sub_iconlist">
               ...
               <div class="basic-form">
                  <div class="row">
                     <div class="mb-3 col-md-12">
                        ...
                        <input type="hidden" name="hotel_id" id="hotel_id2">
                        <input type="hidden" name="u_id" id="u_id2">
                        <label class="form-label">Change Order Status</label>
...
<!-- add btn modal  -->
<div class="modal fade" id="notification_luggage_request_model" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title">Description:</h5>
         ...
         <div class="modal-body">
            <div class="basic-form get_note_model_luggagerequest">
            </div>
         </div>
         <div class="modal-footer">
            <button type="button" class="btn btn-light css_btn" data-dismiss="modal">Close</button>
...
<script type="text/javascript">
   $(document).ready(function() {
      ...
      // var table_visiters = $('#visiters_tb').DataTable();
      //  console.log(hello);
      table_luggage = $('#requestOrder_tb_luggage').DataTable({
         "order": [],
         'processing': true,
         'serverSide': true,
         "bDestroy": true,
         'serverMethod': 'post',
         'ajax': {
            'url': '<?= base_url() ?>' + 'HoteladminController/get_luggage_order_data',
         },
         'columns': [{
               data: 'Sr_No'
            },
      ...
      setInterval(function() {
         table_luggage.ajax.reload();
      }, 30000);
   });
   
   
   $(document).on('click', '.edit_luggage_request_click', function() {
   
      var id = $(this).attr('data-luggagerequest-id');
   
      $('#notification_luggage_request_model').modal('show');
      ...
      $.ajax({
         // method: "POST",
         // url: base_url+"HoteladminController/get_view_name_data_notification",
         url: '<?= base_url('HoteladminController/get_discri_name_data_luggage_request') ?>',
         type: "post",
         data: {
            id: id
         },
         ...
         success: function(response) {
            console.log(response);
            $('.get_note_model_luggagerequest').html(response);
         }
      });
   });
   ...
   function luggage_change_status(cnt) {
      ...
      var uid = $('#uid' + cnt).val();
      var luggageuid = $('#luggageuid' + cnt).val();
...
<script>
   $(document).ready(function() {
      // $('#requestOrder_tb_luggage').DataTable();
      $('#acceptedOrder_tb1').DataTable();
      $('#completedOrder_tb1').DataTable();
      $('#rejectedOrder_tb1_new').DataTable();
...
<script>
   $(document).on('click', '#edit_luggage_data', function() {
      ...
      $.ajax({
         ...
         success: function(data) {
            console.log(data);
            $('#luggage_request_id1').val(data.luggage_request_id);
            $('#u_id2').val(data.u_id);
         ...
         success: function(res) {
            ...
            setTimeout(function() {
               ...
               $(".update_luggage_modal_change").on("hidden.bs.modal", function() {
                  ...
                  $('#luggage_request_id1').css('display', 'none');
                        $('.rejectreasonddd').css('display', 'none');
               });
               $(".updatemessage").show();
               $(".append_data13").html(res);
      ...
      <div class="card-body">
         ...
         <div class="tab-content">
            <div class="tab-pane active" style="background-color:white;" id="new_orders_div2">
               ...
               <div class="table-scrollable cab_change_record sub_iconlist">
                  <table id="requestOrder_tb_cab" class="display full-width">
                     <thead>
                        <tr>
                           <th><strong>Sr. No.</strong></th>
            ...
            <div class="tab-pane" id="accepted_orders_div2" style="background-color:white;">
               <div class="table-scrollable cab_change_record1 sub_iconlist">
                  <table id="acceptedOrder_tb2" class="display full-width">
                     ...
                     <tbody id="searchTable">
                        ...
                        <tr>
                           ...
                           <td>
                              <?php echo date('d-m-Y',strtotime($cb_s['request_date'])) ?> /<sub> <?php echo date('h:i a', strtotime($cb_s['request_time'])) ?></sub>
                           </td>
                           ...
                           <input type="hidden" name="cabuid" id="cabuid<?php echo $cb_s['cab_service_request_id']; ?>" value="<?php echo $cb_s['u_id']; ?>">
                           <td>
            ...
            <div class="tab-pane" id="completed_orders_div2" style="background-color:white;">
               <div class="table-scrollable cab_change_record2 sub_iconlist">
                  <table id="completedOrder_tb2" class="display full-width">
                     ...
                     <tbody id="searchTable">
                        ...
                        <tr>
                           ...
                           <td>
                              <?php echo date('d-m-Y',strtotime($cb_c['request_date'])) ?> /<sub> <?php echo date('h:i a', strtotime($cb_c['request_time'])) ?></sub>
                           </td>
                           <td><?php echo $full_name ?></td>
                           <td><?php echo $mobile_no ?></td>
            ...
            <div class="tab-pane" id="rejected_orders_div2" style="background-color:white;">
               <div class="table-scrollable cab_change_record3 sub_iconlist">
            ...
            <div class="tab-pane" id="cancle_orders_div2" style="background-color:white;">
               <div class="table-scrollable">
                  <table id="cancelOrder_tb2" class="display full-width">
                     <thead>
                        <tr>
                           <th><strong>Sr. No.</strong></th>
                           <th><strong>Passengers</strong></th>
...
<div class="modal fade change_cab_action" tabindex="-1" role="dialog"  aria-hidden="true">
   <div class="modal-dialog modal-md">
      <div class="modal-content">
         <div class="modal-header">
         ...
         <form id="frmupdateblock" method="post" enctype="multipart/form-data">
            ...
            <input type="hidden" name="hotel_id" id="hotel_id3">
            <input type="hidden" name="u_id" id="u_id3">
            <div class="modal-body">
               ...
               <div class="red box cab_acceptation"  style="display:none;" >
                  <div class="mb-3 col-md-12">
               ...
               <div class="green box cab_rejection"  style="display:none;">
...
<div class="modal fade" id="notification_cab_request_model" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title">Description:</h5>
         ...
         <div class="modal-body">
            <div class="basic-form get_note_model_cabrequest">
            </div>
         </div>
         <div class="modal-footer">
            <button type="button" class="btn btn-light css_btn" data-dismiss="modal">Close</button>
...
<script type="text/javascript">
   $(document).ready(function() {
      ...
      // var table_visiters = $('#visiters_tb').DataTable();
      //  console.log(hello);
      table_cab = $('#requestOrder_tb_cab').DataTable({
         "order": [],
         'processing': true,
         'serverSide': true,
         "bDestroy": true,
         'serverMethod': 'post',
         'ajax': {
            'url': '<?= base_url() ?>' + 'HoteladminController/get_cab_order_data',
         },
         'columns': [{
               data: 'Sr_No'
            },
   ...
   $(document).on('click', '.edit_cab_request_click', function() {
   
      var id = $(this).attr('data-cabrequest-id');
   
      $('#notification_cab_request_model').modal('show');
      ...
      $.ajax({
         // method: "POST",
         // url: base_url+"HoteladminController/get_view_name_data_notification",
         url: '<?= base_url('HoteladminController/get_discri_name_data_cab_request') ?>',
         type: "post",
         data: {
            id: id
         },
         ...
         success: function(response) {
            console.log(response);
            $('.get_note_model_cabrequest').html(response);
         }
      });
   });
   ...
   $(document).ready(function() {
      ...
      $(document).on('submit', '#frmupdateblock', function(e) {
         ...
         setTimeout(function() {
            ...
            $('.cab_rejection').css('display','none');
            $('.cab_acceptation').css('display','none');
...
<script>
   ...
   $('#orderserviceDropdown2').change(function() {
      ...
      if (selected_orderservice == 'accepted_order2') {
         ...
         $('.rejected_orders_div2').css('display', 'none');
         $('.accepted_orders_div2').css('display', 'none');
         $('.cancle_orders_div2').css('display', 'none');
      ...
      if (selected_orderservice == 'cancel_order2') {
         selectedOrderserviceurl = 'HoteladminContrller/ajaxSubIconBlockView3';
         $('.page_header_title2').text('Cancel Cab Request');
         $('.accepted_orders_div2').css('display', 'none');
         $('.new_orders_div2').css('display', 'none');
         $('.completed_orders_div2').css('display', 'none');
         $('.rejected_orders_div2').css('display', 'none');
         $('.cancle_orders_div2').css('display', 'block');
   ...
   $(document).ready(function() {
      $('.nav-tabs a').on('click', function() {
         ...
         if (tabId === '#new_orders_div2') {
            ...
            $('.page_header_title2').text('Rejected Cab Request');
            $('.add_cab_feature').css('display', 'none');
         }else if (tabId === '#cancle_orders_div2') {
            $('.page_header_title2').text('Cancel Cab Request');
            $('.add_cab_feature').css('display', 'none');
         }
      });
...
<script>
   $(document).on('click', '.shuttle_model', function() {
