...
.manager_login .container-fluid {
                 ...
                 <div class="card card-topline-aqua">
                     ...
                     <div class="card-body">
                        ...
                        <button id="addRow1" class="btn btn-info">
                         ...
                         <div class="btn-group r-btn">
                             <a class="btn btn-info add_login_person" href="javascript:void(0)">Create Manager Login
                                 ID</a>
                         ...
                         <div class="table-scrollable manager_login">
                             <table id="example1" class="display full-width">
                                 ...
                                 <tbody class="append_data">
                                     ...
                                     <tr>
                                         ...
                                         <td>
                                             <div class="lightgallery">
                                                 <a href="<?php echo $profile_photo ?>"
                                                     ...
                                                     data-src="assets/dist/images/tab/staff.png"
                                         ...
                                         <td><?php echo date('h:i a',strtotime($p_ad['shift_start_time'])) ?> to
                                             <?php echo date('h:i a',strtotime($p_ad['shift_end_time'])) ?></td>
                                         <td>
                                             <?php
                                                      if($p_ad['user_type'] == 3)
                                                      {
                                             ...
                                             <a href="#" class="badge badge-rounded badge-secondary booking_id"
                                                 data-bs-toggle="modal" u-id1=<?= $p_ad['u_id']?>
                                                 data-bs-target=".bd-view-modal-customer-view"><i
                                             ...
                                             <?php
                                                      ...
                                                      else
                                                      {
                                                          if($p_ad['user_type'] == 5)
                                                          {
                                                              $user_type = "House keeping";
                                                      ?>
                                             <a href="#" class="badge badge-rounded badge-secondary booking_id1"
                                                 data-bs-toggle="modal" u-id1=<?= $p_ad['u_id']?>
                                                 data-bs-target=".bd-view-modal-customer-view1"><i
                                                     class="fa fa-check"></i></a>
                                             <?php
                                                      }
                                                      else
                                             ...
                                             <a href="#" class="badge badge-rounded badge-secondary booking_id2"
                                                 data-bs-toggle="modal" u-id1=<?= $p_ad['u_id']?>
                                                 data-bs-target=".bd-view-modal-customer-view2"><i
                                                     class="fa fa-check"></i></a>
                                             <?php
                                                      }
                                                      else
                                                      {
                                                          if($p_ad['user_type'] == 7)
                                                          {
                                                              $user_type = "Foods and Beverage";
                                                      ?>
                                             <a href="#" class="badge badge-rounded badge-secondary booking_id3"
                                                 data-bs-toggle="modal" u-id1=<?= $p_ad['u_id']?>
                                                 data-bs-target=".bd-view-modal-customer-view3"><i
                                                     class="fa fa-check"></i></a>
                                         ...
                                         <td>
                                             <select class="default-select form-control wide"
                                                 id="status_<?php echo $p_ad['u_id'] ?>"
                                                 onchange="change_status(<?php echo $p_ad['u_id'] ?>)">
                                                 <option <?php if($p_ad['is_active'] == 1){echo "Selected";}?>
                                                     value="1">Active</option>
                                                 <option <?php if($p_ad['is_active'] == 0){echo "Selected";}?>
                                                     value="0">Deactive</option>
                                             </select>
                                         </td>
                                         <td>
                                            
                                                     <a href="#"  class="btn btn-danger shadow btn-xs sharp me-1"  id="delete_data" delete-id="<?= $p_ad['u_id']?>" ><i class="fa fa-trash"></i></a> 
                                         </td>
                                     </tr>
                                     <?php
                                                }
 ...
 <div class="modal fade  bd-view-modal-customer-view <?php echo $p_ad['u_id']??0 ?>" tabindex="-1"
 ...
 <div class="modal fade  bd-view-modal-customer-view1 <?php echo $p_ad['u_id']??0 ?>" tabindex="-1"
     style="display: none;" aria-hidden="true">
     <div class="modal-dialog modal-lg" style="max-width:90%">
         <div class="modal-content">
             <form id="frmblock" method="post" enctype="multipart/form-data">
 ...
 <div class="modal fade  bd-view-modal-customer-view2 <?php echo $p_ad['u_id']??0 ?>" tabindex="-1"
     style="display: none;" aria-hidden="true">
     <div class="modal-dialog modal-lg" style="max-width:90%">
         <div class="modal-content">
             <form id="frmblock" method="post" enctype="multipart/form-data">
 ...
 <div class="modal fade  bd-view-modal-customer-view3 <?php echo $p_ad['u_id']??0 ?>" tabindex="-1"
     style="display: none;" aria-hidden="true">
     <div class="modal-dialog modal-lg" style="max-width:90%">
         <div class="modal-content">
             <form id="frmblock" method="post" enctype="multipart/form-data">
...
$(document).on('submit', '#frmblock1', function(e) {
    ...
    $.ajax({
        ...
        success: function(res) {
            $.get('<?= base_url('HoteladminController/login_departments');?>', function(data) {
