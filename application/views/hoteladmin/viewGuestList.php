        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-topline-aqua">
                    ...
                    <div class="col-md-12 col-sm-12">
                        ...
                        <header class="panel-heading panel-heading-gray custom-tab ">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item"><a href="#new_orders_div" data-bs-toggle="tab" class="<?= (empty($type) || $type == 'inhouse_guest') ? 'active' : ''; ?>">Inhouse Guest</a>
                                    </li>
                                    <li class="nav-item"><a href="#accepted_orders_div" data-bs-toggle="tab" class="<?= ($type == 'departd_guest') ? 'active' : ''; ?>">Departed Guest</a>
                                    </li>
                                    <li class="nav-item"><a href="#rejected_orders_div" class="<?= ($type == 'upcoming_guest') ? 'active' : ''; ?>" data-bs-toggle="tab">Upcoming Guest</a>
                                    </li>
                                </ul>
                            </header>
                            </div>
                       ...
                       <div class="row">
                                ...
                                <div class="tab-pane<?= (empty($type) || $type == 'inhouse_guest') ? ' active' : ''; ?> " id="new_orders_div">          
                    ...
                    <div class="tab-pane<?= ($type == 'departd_guest') ? ' active' : ''; ?>" id="accepted_orders_div">         
                        <div class="table-scrollable">
                        ...
                        <div class="tab-pane <?= ($type == 'upcoming_guest') ? ' active' : ''; ?>" id="rejected_orders_div">        
                        <div class="table-scrollable">
