   ...
   <div class="page-content">
      <div class="page-bar">
         <div class="page-title-breadcrumb">
            <div class=" pull-left">
               <div class="page-title">Other Complaint Management</div>
            </div>
            <ol class="breadcrumb page-breadcrumb pull-right">
               ...
               <li class="active">Other Complaint Management</li>
            </ol>
         </div>
      </div>
      ...
      <div class="row">
         <div class="col-md-12">
            <div class="card card-topline-aqua">
               <div class="card-head">
                  <header><span class="page_header_title11">All Other Complaints</span></header>
               </div>
               <div class="card-body">
                     ...
                     <div class="panel tab-border card-box">
                        <header class="panel-heading panel-heading-gray custom-tab">
                           <ul class="nav nav-tabs">
                              <li class="nav-item"><a href="#new_orders_div" data-bs-toggle="tab" class="active">All Other Complaints</a>
                              </li>
                              <li class="nav-item"><a href="#accepted_orders_div" data-bs-toggle="tab">All Closed Complaints</a>
                              </li>
                           </ul>
                        </header>
                     </div>
                           ...
                           <table id="example1" class="display full-width">
                              ...
                              <?php
                                    ...
                                    if($list)
                                    {
                                        ...
                                        {
                                          $room_no = '';
                                          $wh_rm_no_s = '(booking_id ="' . $cm['booking_id'] . '")';
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                    <h5><?php echo date('d-m-Y',strtotime($cm['created_at']));?></h5>
                                        </td>
                                    ...
                                    <td>
                                       <select onchange="change_status(<?php echo $cm['complaint_id']?>)" id="status<?php echo $cm['complaint_id']?>"
                                          class="default-select form-control wide text-center">
...
<script>
   ...
   $('#orderserviceDropdownNew').change(function () {
       ...
       {
           $('.page_header_title11').text('All Other Complaints');
       ...
       function change_status(cnt) {
             ...
             $(".loader_block").show();
              ...
              if (status != '') {
                  ...
                  $.ajax({
                      url: base_url + "HoteladminController/other_complaints_status",
                      method: "POST",
                      data: {
                        status: status,
                          uid: uid
                      ...
                      success: function(data) {
                        $.get( '<?= base_url('HoteladminController/other_complaints');?>', function( data ) {
