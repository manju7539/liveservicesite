  ...
  .remove-icon {
                        ...
                        <div class="modal-body">
                           ...
                           <div class="mb-12 col-md-12 form-group">
                              ...
                              <!-- <input type="text" name="facility_name[]"
                                 ...
                                 required> -->
                              <input type="text" name="facility_name" id="business_facility" class="form-control" placeholder="" data-role="tagsinput" required="">
                           </div>
                           <div class="mb-12 col-md-12 form-group">
                              <label class="form-label">Upload Photos</label>
               ...
               <div class="modal-body">
                  <div class="col-12 ">
                     ...
                     <div class="row">
                        ...
                        <div class="mb-3 col-md-6 form-group">
                           <label class="form-label">Facilties</label>
                           <input type="text" name="facility_name[]" id="facility_name" data-role="tagsinput" class="form-control">
                        </div>
                        <div class="mb-3 col-md-12 form-group">
                           <label class="form-label">Upload Photos</label>
                           <input type="file" name="image"  class="form-control" placeholder="">
   ...
   $('#addBusinesssCenterForm').submit( function(e){
           ...
           $(document).on('click','#edit_businesscenter_data',function(){
               ...
               $.ajax({
                  ...
                  success: function (data) {
                     ...
                     $('#facility_name').tagsinput('removeAll');
                    
                     if (data.business_center_facility) {
                      
                        console.log(data.business_center_facility);
                     data.business_center_facility.forEach(function (facility) {

                        $('#facility_name').tagsinput('add', facility.facility_name);
                     });
                     }
      ...
      $(document).unbind('submit').on('submit', '#editBusinessCenterForm', function(e){
       ...
       $(document).ready(function() {
    // Initialize the tagsinput plugin on the input element
    $("#business_facility").tagsinput();

    // Capture the keypress event on the input element
    $("#business_facility").on("keypress", function(event) {
        // Check if the pressed key is either the space key (key code 32) or the enter key (key code 13)
        if (event.which === 32 || event.which === 13) {
            event.preventDefault(); // Prevent the default space key or enter key behavior (e.g., scrolling down)
               ...
               <table id="example1" class="display full-width">
                  ...
                  <tbody class="append_data_lost">
                     ...
                     <tr>
                        ...
                        <td>
                           <div class="lightgallery">
                              <a href="<?php echo $lost_f['img'] ?>" target="_blank"
