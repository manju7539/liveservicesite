                        ...
                        <div class="modal-content">
                           ...
                           <div class="table-scrollable">
                            <table id="example1" class="display full-width">
                                <thead>
                                                        <tr>
                                                        <th style="width:15%!important"><strong>Sr.no.</strong></th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="lightgallery">
                                                                <a href="<?php echo $banquet_hall_img['images']??''?>" target="_blank"
     ...
     $(document).on('submit', '#frmblock', function(e){
        ...
        $.ajax({
            ...
            success     : function(res) {
                $.get( '<?= base_url('banquet_hall');?>', function( data ) {
    ...
    <script>
     $(document).ready(function (id) {
            $(document).on('click','#edit_data',function(){
                ...
                // alert(id);
                $.ajax({
                    url: '<?= base_url('HoteladminController/getEditDataofbanquet') ?>',
                    ...
                    success: function (data) {
                        ...
                        console.log(data);
                        $('#banquet_hall_id').val(data.list.banquet_hall_id);
                        $('#banquet_hall_name').val(data.list.banquet_hall_name);
                        $('#no_of_people').val(data.list.no_of_people);
                        $("#img").attr('src',data.banquet_hall_images[0].images);
                        // $("#files").val(data.banquet_hall_images[0].images);
                        // $("#banquet_hall_image_id").val(data.banquet_hall_images[].banquet_hall_image_id);
