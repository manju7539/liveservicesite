        ...
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                ...
                <ol class="breadcrumb page-breadcrumb pull-right">
                    ...
                    <li class="active">Completed Service Orders</li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-topline-aqua">
                    <div class="card-head">
                        <header>All Completed Orders</header>
                        <div class="tools">
                    ...
                    <div class="row">
                                ...
                                <div class="col-md-3">
                                    <select select class="form-control" id="categoryDropdown">
                                                    ...
                                                    <td><h5><?php echo $i;?></h5></td>
                                                     ...
                                                     <td><h5><?php echo $floor_no ;?></h5></td>
                                                        ...
                                                        <td><a href="#"
                                                                ...
                                                                data-bs-target=".bd-example-modal-lg_<?php echo $l['rmservice_services_order_id'];?>"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
