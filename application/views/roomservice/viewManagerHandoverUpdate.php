        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-topline-aqua">
                    <div class="card-head">
                        <header>List of Completed Handover</header>
                        <div class="tools">
                    ...
                    <div class="row d-flex align-items-center">
                                ...
                                <div class="col-md-3 d-flex justify-content-end ">
                                    <select class="form-control" id="categoryDropdown">
                                        ...
                                        <option value=""><a href="<?php echo base_url('managerHandover')?>" style="color:white;">Pending Handover</a></option>
                                        <option value=""><a href="<?php echo base_url('managerHandoverUpdate')?>" style="color:white;">Completed Handover</a></option>
                        ...
                        <div class="table-scrollable">
                            ...
                            <table id="example1" class="display full-width">
                                <thead>
                                <tr>
                                    <th class="table-headings">Sr.no.</th>
                                    <th class="table-headings"> Name <br>
                                        (Created by)</th>
                                    <th class="table-headings">Date & Time</th>
                                    <th class="table-headings"><strong> Name <br>
                                            (Completed by)</strong></th>
                                        <th class="table-headings">Description</th>
                                ...
                                <?php 
                                                    if(!empty($list))
                                                    {
                                                        ...
                                                        foreach($list as $l)
                                                        {
                                                            ...
                                                            //completed name
                                                            $wh2 ='(u_id="'.$l['completed_manger_id'].'")';
                                                            ...
                                                            <td><h5><?php echo $date."   ".$time?></h5></td>

                                                         
                                                         
                                                          <td><h5><?php echo $c_uname;?></h5></td>

                                                          <td>
                                                                <a href="#"
                                                                    class="btn btn-secondary shadow btn-xs sharp me-1"
                                                                    data-bs-toggle="modal"
                                                                    data-bs-target="#exampleModalCenter_<?php echo $l['m_handover_id'];?>"><i
                                                                ...
                                                                ?>
                                                            <!-- <td>
                                                            <a class="badge badge-rounded badge-outline-success" data-bs-toggle="modal"
                                                                    data-bs-target="#edit_<?php echo $l['m_handover_id']?>">
                                                                    complete</a>
                                                        ...
                                                        <div class="modal fade" id="exampleModalCenter_<?php echo $l['m_handover_id'];?>" style="display: none;" aria-hidden="true">
                                                                <div class="modal-dialog modal-dialog-centered " role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <div class="mb-1">
                                                                         <b><?php echo $uname;?>( <?php echo $l['date'];?> / <?php echo $l['time'];?> )</b>
                                                               ...
                                                               <div class="modal fade" id="edit_<?php echo $l['m_handover_id']?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                                <div class="modal-dialog  modal-dialog-centered  modal-md">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <form action="<?php echo base_url('MainController/update_completed_handover');?>" method="post" enctype="multipart/form-data">
                                                                                <input type="hidden" name="m_handover_id" id="m_handover_id<?php echo $l['m_handover_id'];?>" value="<?php echo $l['m_handover_id'];?>"> 
                                                                                ...
                                                                                <div class="row">
                                                                                        <div class="mb-3 col-md-12">
                                                                                            ...
                                                                                            <input type="hidden" name="m_handover_id" id="m_handover_id<?php echo $l['m_handover_id'];?>" value="<?php echo $l['m_handover_id'];?>">
                                                                                                ...
                                                                                                <select class="default-select form-control wide" name="is_complete" id="active<?php echo $l['m_handover_id'];?>" onchange="change_status_1(<?php echo $l['m_handover_id']?>);">
                                                                                                    <option <?php if($l['is_complete']=="0") {echo "Selected";}?> value="0" selected>Pending</option>
                                                                                                    <option <?php if($l['is_complete']=="1") {echo "Selected";}?> value="1">Completed</option>
                                                                                        ...
                                                                                        <div class="mb-3 col-md-12">
                                                                                         ...
                                                                                         <textarea class="summernote" name="description"  id="description" value="<?php echo $l['description']; ?>" style="min-height: 400px;"></textarea>
