                        ...
                        <div class="panel tab-border card-box">
                            <header class="panel-heading panel-heading-gray custom-tab ">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item"><a href="#new_orders_div" id="New_Orders_tab" data-bs-toggle="tab" class="active">New Orders</a>
                                    </li>
                                    <li class="nav-item"><a href="#accepted_orders_div" id="accepted_ord_tab" data-bs-toggle="tab">Accepted Order</a>
                                    </li>
                                            ...
                                            <table id="newOrder_tb" class="display full-width">
                                                ...
                                                <tbody class="append_data">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h5><?php echo $i;?><h5></td>
                                                            <td><h5><?php echo $l['room_service_unique_id'];?></h5>
                                                        </td>  
                                                        <td>
                                                        ...
                                                        <td>
                                                            <a href="#"  style="margin-left: 30px" class="btn btn-secondary shadow btn-xs sharp me-4" data-bs-toggle="modal"   data-bs-target=".bd-example-modal-lg_<?php echo $l['rmservice_services_order_id'];?>"><i class="fa fa-eye"></i></a>
                                                        </td>
                                                        <td>
                                                            <h5><?php
                                                        ...
                                                        <td>
                                                            <div>
                                                                <a href="#" style="margin-left: 0px" ><div class="badge badge-info" data-bs-toggle="modal" data-bs-target=".order_desc_<?php echo $l['rmservice_services_order_id']?>"> view</div></a>
                                                            </div>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <a href="#" style="margin-left: 5px" class="btn btn-warning btn-xs sharp me-1" data-bs-toggle="modal" data-bs-target=".status_<?php echo $l['rmservice_services_order_id']?>"><i class="fa fa-share"></i></a>
                                                        </td>
                                                    </tr>
                                                    <!-- modal for status  -->
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="basic-form">
                                                                        <form action="<?php echo base_url('RoomserviceController/change_order_status')?>"
                                                                            method="POST">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="mb-3 col-md-6">
                                                                                    ...
                                                                                    <select id="drop_<?php echo $l['rmservice_services_order_id']?>" name="order_status" onchange="show_typewise(this)" class="default-select form-control wide">
                                                                                ...
                                                                                <div class="mb-3 col-md-6" name="staff_id" style="display:none;" id="type_drop_<?php echo $l['rmservice_services_order_id']?>">
                                                                                    <label class="form-label">Assign To</label>
                                                                                    <select id="inputState" class="default-select form-control wide status_css" name="staff_id" 
                                                                                        style="display: none;">
                                                                                        <option selected>Choose</option>
                                                                                        <?php 
                                                ...
                                                <table id="acceptedOrder_tb" class="display full-width">
                                                    ...
                                                    <tbody>
                                                        <?php if(!empty($order_data)){
                                                            ...
                                                            $get_guest_name = $this->MainModel->getData('register',$where1);
                                                            // echo "<pre>";
                                                            // print_r($get_guest_name['guest_type']);
                                                            if(!empty($get_guest_name))
                                                            {
                                                                $guest_name = $get_guest_name['full_name'];
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><h5><?php echo $row['room_service_unique_id'];?></h5></td>
                                                            <?php 
                                                                if($row['order_from'] == 1)
                                                                {
                                                                    $order_type = 'On Call';
                                                            ...
                                                            <td><h5><?php echo  $row['room_no']; ?></h5></td>
                                                            <td><h5><?php echo $guest_name ?></h5></td>
                                                            <td>
                                                                <a href="#" style="margin-left: 30px" class="btn btn-secondary shadow btn-xs sharp me-1" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg_<?php echo $row['rmservice_services_order_id'];?>"><i class="fa fa-eye"></i></a>
                                                            </td>
                                                            <td>
                                                                <h5><?php
                                                                if($guest_typee == 1)
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            ?>
                                                            <h5><?php echo $order_type;?></h5>
                                                        </td>                        
                                                        <td><h5><?php echo $l['reject_date'];?></h5></td>
                                                        <td> <h5> <?php echo  $l['room_no'];?></h5></td>
                                                        <td><h5><?php echo $guest_name?></h5></td>
                                                        <td>
                                                            <a href="#" style="margin-left: 30px" class="btn btn-secondary shadow btn-xs sharp me-1"  data-bs-toggle="modal"  data-bs-target=".bd-example-modal-lg_<?php echo $l['rmservice_services_order_id'];?>"><i class="fa fa-eye"></i></a>
                                                        </td>                    
                                                        <td>
                                                            <h5><?php
                                                            if($get_guest_typee == 1)
                                                        ...
                                                        <td>
                                                            ...
                                                            ?>
                                                            <h5><a href="#"> <div class="badge badge-danger">
                                                                    <?php echo $order_status;?></div></a></h5>
                                                        </td>
                                                                <!-- <td>
                                                ...
                                                <table id="completedOrder_tb" class="display full-width completedorder_tb_class">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><h5><?php echo $i;?></h5></td>
                                                            <td>
                                                                <h5><?php echo $l['room_service_unique_id'];?></h5>
                                                            </td>
                                                            <td><h5><?php echo $floor_no ;?></h5></td>
                                                            <!-- <td>#1223</td> -->
                                                            <?php 
                                                            ...
                                                            <td><h5 class=""><?php echo $l['room_no'];?></h5></td>
...
<!-- start :: New orders requirement -->
<?php
    $i = 1;
    if(!empty($list)){
    foreach ($list as $l) {

        $wh_l = '(rmservice_services_order_id  = "' . $l['rmservice_services_order_id'] . '")';
        $get_f_orders_data = $this->MainModel->getAllData1('rmservice_services_details', $wh_l);

    ?>
    <div class="modal fade bd-example-modal-lg_<?php echo $l['rmservice_services_order_id'];?>" tabindex="-1" style="display: none;"
        aria-hidden="true">
                                ...
                                <table class="table-responsive-lg table sortable table-bordered mb-0 text-center table_list">
                                    ...
                                    <tbody id="geeks">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    <h5 class=""><?php echo $service_name ?></h5>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="lightgallery">
                                                    <a href="<?php echo $image ?>"
                                                        ...
                                                        data-src="assets/dist/images/icons/cutlery1.png"
...
?>
<!-- End :: New orders requirement -->

<!-- start :: Accepted orders requirement -->
<?php 
    if (!empty($order_data)) 
    {
        $i=1;
        ...
        {
            $wh1 = '(rmservice_services_order_id ="'.$l1['rmservice_services_order_id'].'")';
            $get_h_orders_data = $this->MainModel->getAllData1('rmservice_services_details',$wh1);
    ?>    
    <div class="modal fade bd-example-modal-lg_<?php echo $l1['rmservice_services_order_id'];?>" tabindex="-1" style="display: none;"
        aria-hidden="true">
        <div class="modal-dialog modal-xl slideInDown animated">
            <div class="modal-content">
                <div class="modal-header">
...
?>
<!-- End :: Accepted orders requirement -->

<!-- Start :: Completed orders requirement-->
<?php
    $i = 1;
    foreach ($completed_list as $l) {
    ...
    $i++;
?>
<!-- End :: Completed orders requirement-->

<!-- start :: rejected order requirement -->
<?php
    $i = 1;
    if(!empty($rejected_list)){
    foreach ($rejected_list as $l) {
...
?>
<!-- End :: rejected order requirement -->
<!-- add btn modal  -->
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select class="form-control default-select" id="room_no" name="room_no" required>
                                        ...
                                        <?php  
                                            // $today = date('Y-m-d');
                                            // $where1 = '(hotel_id = "'.$hotel_id.'" AND check_out >= "'.$today.'")';
                                            // $till_checkout_date = $this->MainModel->getAllData1($tbl ='user_hotel_booking',$where1);
                                            // echo "<pre>";
                                            // print_r($till_checkout_date);
                                            // exit;
...
<script>
    ...
    $(document).on('submit', '#frmblock', function(e){
        ...
        var base_url = '<?php echo base_url();?>';
        var goto_method = 'RoomserviceController/Serviceadd_into_accepted';
        $.ajax({
            ...
            success     : function(res) {
                $("#New_Orders_tab").removeClass("active");
                $('#accepted_ord_tab').addClass("active");
                $('#new_orders_div').css('display','none');
                $('#accepted_orders_div').css('display','block');
