                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                        <table id="staff_menu_accep_tb" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                                                            <thead>
                                                                <tr>
                                                                    <th>Sr.No.</th>
                                                                    <th>Order Id</th>
                                                            ...
                                                            <tbody id="geeks">
                                                                <?php 
                                                                    if(!empty($menu_accepted_ord))
                                                                    {
                                                                        $i=1;
                                                                        foreach($menu_accepted_ord as $u_c_order)
                                                                        {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <h5> <?php if(!empty($o_price)){ echo '<i class="fa fa-rupee"></i>'.$o_price; }?></h5>
                                                                    </td>
                                                                    <td>  
                                                                        <?php 
                                                                        ...
                                                                        ?>
                                                                        <div>
                                                                            <a href="#"><div class="badge badge-success">Accepted</div></a>
                                                                        </div>
                                                                        <?php 
                                                                            }
                                                                        ?>
                                    ...
                                    <div class="tab-content">                           
                                        <div class="tab-pane active show" id="accepted">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                        <table id="staff_menu_completed_tb" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                                                            <thead>
                                                                <tr>
                                                                    <th>Sr.No.</th>
                                                                    <th>Order Id</th>
                                                            ...
                                                            <tbody id="geeks">
                                                            <?php 
                                                                if(!empty($menu_copleted_ord))
                                                                {
                                                                    $i=1;
                                                                    foreach($menu_copleted_ord as $u_c_order)
                                                                    {
                                    ...
                                    <div class="tab-content">                           
                                        <div class="tab-pane active show" id="accepted">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                        <table id="staff_service_accep_tb" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                                                            <thead>
                                                                <tr>
                                                                    <th>Sr.No.</th>
                                                                    <th>Order Id</th>
                                                            ...
                                                            <tbody id="geeks">
                                                            <?php 
                                                                        if(!empty($service_accepted_ord))
                                                                        {
                                                                            $i=1;
                                                                            foreach($service_accepted_ord as $u_c_order)
                                                                            {
                                    ...
                                    <div class="tab-content">                           
                                        <div class="tab-pane active show" id="accepted">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                        <table id="staff_service_completed_tb" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                                                            <thead>
                                                                <tr>
                                                                    <th>Sr.No.</th>
                                                                    <th>Order Id</th>
                                                            ...
                                                            <tbody id="geeks">
                                                            <?php 
                                                                        if(!empty($service_copleted_ord))
                                                                        {
                                                                            $i=1;
                                                                            foreach($service_copleted_ord as $u_c_order)
                                                                            {
...
<script>
    $(document).ready(function () {
        $('#staff_menu_accep_tb').DataTable();
    });
    $(document).ready(function () {
        $('#staff_menu_completed_tb').DataTable();
    });
    $(document).ready(function () {
        $('#staff_service_accep_tb').DataTable();
    });
    $(document).ready(function () {
        $('#staff_service_completed_tb').DataTable();
    });
</script>
</body>
