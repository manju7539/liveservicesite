                            ...
                            <table id="example1" class="display full-width">
                                ...
                                <tbody class="append_data">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" style="margin-left: 30px;"><div class="badge badge-secondary" data-bs-toggle="modal" data-bs-target=".example_<?php echo $l['room_service_menu_order_id'];?>">view</div>
                                            </a>
                                        </td>
                                        <td>
                                            <a href="#">
                            ...
                            <table class="table-responsive-lg table sortable table-bordered  mb-0 text-center table_list">
                                ...
                                if(!empty($get_f_orders_data)){
                                    ...
                                    foreach ($get_f_orders_data as $g1) {
                                        ...
                                        {
                                            $menu_name = $get_menu_name['menu_name'];
                                            $amount = $get_menu_name['price'] * $g1['quantity'];
                                        }
                                        else
                                        {
                                            $menu_name ='';
