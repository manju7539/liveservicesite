                            ...
                            <table id="example1" class="display full-width">
                                ...
                                <tbody class="append_data">
                                    ...
                                    <tr>
                                        ...
                                        <td><h5><?php echo $l['room_service_unique_id'];?></h5></td>
                                        <td>
                                            <h5><?php
                                            if($l['order_from'] == 1)
                                            {
                                        ...
                                        <td>
                                            <h5><?php echo $l['complete_date'];?><sub><?php echo date('h:i A', strtotime($l['created_at']));?></sub><h5>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div>
                                                <h5 class=""><?php echo $staff_name;?></h5>
                                            </div>
                                        </td>
                                        <?php 
                                            if($l['order_status'] == 0)
                                        ...
                                        ?>
                                        <td>
                                            <h5> <span class="badge badge-success"><?php echo $order_status?></span></h5>
                                        </td>
                                    </tr>
                                    <?php                 
                                        $i++;
...
<?php
        ...
        foreach ($list as $l) {
            ...
            $wh_l = '(room_service_menu_order_id = "' . $l['room_service_menu_order_id'] . '")';
            $get_f_orders_data = $this->MainModel->getAllData1('room_service_menu_details', $wh_l);

            // $wh12 = '(room_servs_category_id ="' . $l['room_service_menu_order_id'] . '")';
            // $get_category_name = $this->MainModel->getData('room_servs_category', $wh12);
            

        ?>
            <div class="modal fade example_<?php echo $l['room_service_menu_order_id'];?>" tabindex="-1" role="dialog" aria-hidden="true">
                                        ...
                                        <table
                                            ...
                                            if(!empty($get_f_orders_data)){
                                                ...
                                                foreach ($get_f_orders_data as $g1) {
                                                    ...
                                                    $get_menu_name = $this->MainModel->getData('room_serv_menu_list', $wh11);
...
<!--                                                   
                                                    <td>
                                                        <div>
                                                        <h5 class=""><?php echo $get_category_name['category_name'] ?></h5>
                                                        </div>
                                                    </td> -->
                                                    ...
                                                    <!-- <td>
                                                        <div class="lightgallery"
                                                            ...
                                                            <a href="assets/icons/breakfast.png"
                                                                ...
                                                                <img class="me-3  " src="assets/icons/breakfast.png"
                                                    ...
                                                    <td>
                                                                ...
                                                                <h5 class=""><?php echo $get_menu_name['menu_name'] ?></h5>
                                                    ...
                                                    <td>
                                                        ...
                                                        <h5 class=""><?php echo $get_menu_name['price'] ?></h5>
