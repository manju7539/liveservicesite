                            ...
                            <table id="example1" class="display full-width">
                                ...
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h5><?php echo $row['order_date'];?><sub><?php echo date('h:i A', strtotime($row['order_time']));?></sub></h5>
                                        </td>
                                        <td>
                                            <h5><?php
                                            if($row['order_from'] == 1)
                                        ...
                                        <td>
                                            <h5><?php
                                                if($row['order_from'] != 3)
                                                {
                                                    ...
                                                    elseif($row['Guest_type'] == 2)
                                                    {
                                                        echo "VIP";
                                                    }
                                                    elseif($row['Guest_type'] == 3)
                                                    {
                                                        echo "Complete House Guest";
                                                    }
                                                    elseif($row['Guest_type'] == 4)
                                                    {
                                                        echo "WHC";
                                                    }
                                                    else
