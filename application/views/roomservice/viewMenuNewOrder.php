                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="btn btn-warning btn-xs sharp me-1"
                                                data-bs-toggle="modal" data-bs-target=".status_<?php echo $l['room_service_menu_order_id']?>"><i class="fa fa-share"></i>
                                            </a>
                                        </td>
                                    </tr>
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control"  id="guest_type" 
                                    name="gest_type"  placeholder="" required>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control default-select" id="main_cat"
                                            ...
                                            <option value="" class="form-control js-example-disabled-results" selected>Select</option>
                                            <?php 
                                            $admin_id = $this->session->userdata('u_id');
