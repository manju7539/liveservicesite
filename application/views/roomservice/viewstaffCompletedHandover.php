                    ...
                    <div class="row d-flex align-items-center">
                                ...
                                <div class="col-md-3 d-flex justify-content-end ">
                                    <select class="form-control" id="categoryDropdown">
                                        ...
                                        <option value=""><a href="<?php echo base_url('staffHandover')?>" style="color:white;">Pending Handover</a></option>
                                        <option value=""><a href="<?php echo base_url('staffCompletedHandover')?>" style="color:white;">Completed Handover</a></option>
                            ...
                            <table id="example1" class="display full-width">
                                ...
                                <?php
                                                    ...
                                                    <tr>
                                                        ...
                                                        <!-- <td>
                                                            <div>
                                                                <h5 class="text-nowrap">03/04/2020 /<sub>2.25PM</sub>
                                                                </h5>
                                                            </div>
                                                        </td> -->
                                                        <td>
                                                            <div>
                                                                <h5 class="text-nowrap"><?php echo $creator_full_name ?></h5>
                                                            </div>
                                                        </td>
                                                        <td><h5><?php echo $s_com['date']." ".date('h:i a',strtotime($s_com['time'])) ?></h5></td>

                                                        <td>
                                                            <div>
                                                                <h5 class="text-nowrap"><?php echo $completor_full_name ?></h5>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div>
                                                                <h5 class="text-nowrap"><?php echo $s_com['complete_date']." ".date('h:i a',strtotime($s_com['complete_time'])) ?>
                                                                </h5>
                                                            </div>
                                                        </td>
