                           ...
                           <form method="POST">
                              <div class="d-flex">
                                 <div class="input-group" style="margin-right:10px">
                                    <input type="text" class="form-control wide" name="check_in" id="main_cat"
                                          ...
                                          <tr>
                                             ...
                                             <td class="w-space-no">
                                                <a href="#" class="btn btn-warning shadow btn-xs sharp me-1" data-bs-toggle="modal"
                                                   ...
                                                   <!-- <a href="<?php //echo base_url('check_out_view/' . $gl['booking_id'].'/'.$gl['u_id']) 
                                                                  ?>" class="btn btn-success shadow btn-xs sharp  "><i class="fa fa-file"></i>
                                                </a> -->
                        ...
                        ?>
                              ...
                              <div class="mb-3 col-md-6">
                                 ...
                                 <select class="form-control" name="room_type[]" id="room_type">
                                    ...
                                    ?>
                                          <option <?php if ($rm_t['room_type_id'] == $u_bd['room_type']) {
                                                      echo "Selected";
                                                   } ?> value="<?php echo $rm_t['room_type_id'] ?>"><?php echo $rm_t['room_type_name'] ?></option>
                                    <?php
                                       }
                                    }
                                    ?>
                              ...
                              <div class="mb-3 col-md-6">
                                 ...
                                 <select class="form-control" name="room_no[]" id="room_no">
                                    ...
                                    ?>
                                          <option <?php if ($rn['room_no'] == $u_bd['room_no']) {
                                                      echo "Selected";
                                                   } ?> value="<?php echo $rn['room_no'] ?>"><?php echo $rn['room_no'] ?></option>
                                    <?php
                                       }
                                    }
                                    ?>
...
<script>
   ...
   $(document).ready(function() {
      $('#main_cat').change(function() {
         ...
         if (cat) {
            $.ajax({
               url: base_url + "FrontofficeController/change_check_in_guest",
               method: "post",
               data: {
                  cat: cat
            ...
            $('#sub_cat').html('<option>Select Guest</option>');
         }
      });
   });
</script>
