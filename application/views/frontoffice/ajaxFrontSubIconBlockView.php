        ...
        foreach ($vehicle_wash_request2 as $v_wash_char) {
            ...
            ?>
               <tr>
                  ...
                  <td>
                     <div>
                     <a href="#"  class="btn btn-warning shadow btn-xs sharp me-1" id="edit_charges_data" data-bs-toggle="modal" data-id-editcharges="<?= $v_wash_char['vehicle_washing_charge_id']?>"
        ...
        foreach ($list as $c_s) {
            ...
            ?>
                     <tr>
                        ...
                        <td>
                        <a href="#"  class="btn btn-warning shadow btn-xs sharp me-1 change_cab" id="edit_data" data-bs-toggle="modal"  data-id= "<?php echo $c_s['cab_service_request_id'] ?>"><i class="fa fa-share"></i></a>
                        </td>
                        <!-- assign modal -->
                        <!--/.  assign modal  -->
                     </tr>
