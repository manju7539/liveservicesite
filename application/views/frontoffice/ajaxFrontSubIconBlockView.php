...
<?php if ($sub_icon_id == 1) { ?>
   ...
   <script
      src="<?php echo base_url('assets/plugins/datatables/plugins/bootstrap/dataTables.bootstrap4.min.js') ?>"></script>
                  ...
                  if ($list) {
                     foreach ($list as $g_f_s) {
                        ...
                        <tr>
                           ...
                           <td>
                              <?php echo date('h:i a', strtotime($g_f_s['open_time'])) . "-" . date('h:i a', strtotime($g_f_s['close_time'])) ?>
                           </td>
                           <td>
                              <?php echo date('h:i a', strtotime($g_f_s['break_start_time'])) . "-" . date('h:i a', strtotime($g_f_s['break_close_time'])) ?>
                           </td>
                           <!-- <td>
                     <button
                         class="btn btn-secondary_<?php echo $g_f_s['front_ofs_service_id'] ?> shadow btn-xs sharp me-1"><i
                           ...
                           <td>
                              <a style="margin:auto" data-bs-toggle="modal" data-idgym="<?= $g_f_s['front_ofs_service_id'] ?>"
                                 id="edit_gym_data" data-bs-target=".bd-terms-modal-sm"
                                 class="btn btn-secondary shadow btn-xs sharp"><i class="fa fa-eye"></i></a>
                           </td>
                           <td>
                              <a style="margin:auto" data-bs-toggle="modal" data-idgym="<?= $g_f_s['front_ofs_service_id'] ?>"
                                 id="edit_gym_data" data-bs-target=".bd-terms-modal-sm1"
                                 class="btn btn-secondary shadow btn-xs sharp"><i class="fa fa-eye"></i></a>
                           </td>
                           <!-- <td>
                     <a href="" data-bs-toggle="modal"
                         ...
                         <img src="<?php echo base_url('assets/dist/images/term.jpg') ?>" alt=""
                           ...
                           <td>
                              <div class="lightgallery" class="room-list-bx d-flex align-items-center">
                                 <a href="<?php echo $services_img['image'] ?>" target="_blank"
                                    ...
                                    <img class="me-3 " src="<?php echo $services_img['image'] ?>" alt=""
                           ...
                           <!--/. image gallery -->
                           <td>
                              <a href="#" class="btn btn-warning shadow btn-xs sharp me-1" id="edit_gym_data"
                                 data-bs-toggle="modal" data-idgym="<?= $g_f_s['front_ofs_service_id'] ?>"
                                 data-bs-target="#edit_gym_model"><i class="fa fa-pencil"></i></a>
                           </td>
                        </tr>
                        ...
                        <div class="basic-form">
                           ...
                           <div class="row">
                              <div class="mb-3 col-md-6 form-group">
                                 ...
                                 <input type="text" name="staff_name" id="staff_name1" class="form-control"
                                    value="Amit Sahane" required="">
                              </div>
                              <div class="mb-3 col-md-6 form-group">
                                 <label class="form-label">Contact Number</label>
                                 <input type="text" name="contact_no" maxlength="10" id="contact_no"
                                    oninput="this.value=this.value.replace(/[^0-9]/g,'');" class="form-control"
                                    value="9878675645" required="">
                              </div>
                           </div>
                           <div class="row">
                              <div class="mb-3 col-md-6 form-group">
                           ...
                           <div class="row">
                              <div class="mb-3 col-md-6 form-group">
                                 ...
                                 <textarea class="summernote" name="description" rows="3" id="comment1"
                                    required=""></textarea>
                              </div>
                              <div class="mb-3 col-md-6 form-group">
                              ...
                              <div class="row">
                                 ...
                                 foreach ($services_imgs as $se_i) {
                                    ...
                                    <div class="mb-3 col-md-4 ">
                                       <input type="hidden" name="front_ofs_service_image_id[]"
                                          value="<?php echo $se_i['front_ofs_service_image_id'] ?>">
                                       <input type="file" class="dropify form-control" name="image[<?php echo $j ?>]" id="files"
                                          accept="image/jpeg, image/png," data-default-file="<?php echo $se_i['image'] ?>">
                                    </div>
                                    <br>
      ...
      <div class="card card-topline-aqua">
         ...
         <div class="card-body ">
               ...
               <div class="panel tab-border card-box">
                  <header class="panel-heading panel-heading-gray custom-tab">
                     <ul class="nav nav-tabs">
                        <li class="nav-item"><a href="#arrival1_div_spa" data-bs-toggle="tab" class="active">Spa
                              Information</a>
                        </li>
            ...
            <div class="btn-group r-btn add_spa_require">
               <button style="float:right;" type="button" class="btn btn-primary css_btn added_spa_request"
                  data-bs-toggle="modal">Add Request</button>
            </div>
            <div class="tab-content">
               <!-- upcoming guest -->
               <div class="tab-pane active" style="background-color:white;" id="arrival1_div_spa">
                  <div class="table-scrollable services_block">
                     <table id="example1" class="display full-width">
                        <thead>
                           ...
                           if ($list) {
                              foreach ($list as $spa_f_s) {
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <?php echo date('h:i a', strtotime($spa_f_s['open_time'])) . "-" . date('h:i a', strtotime($spa_f_s['close_time'])) ?>
                                    </td>
                                    <td>
                                       <?php echo date('h:i a', strtotime($spa_f_s['break_start_time'])) . "-" . date('h:i a', strtotime($spa_f_s['break_close_time'])) ?>
                                    </td>
                                    <td>
                                       <a style="margin:auto" data-bs-toggle="modal" id="edit_gym_data"
                                          data-idgym="<?= $spa_f_s['front_ofs_service_id'] ?>"
                                          data-bs-target=".bd-terms-modal-sm" class="btn btn-secondary shadow btn-xs sharp"><i
                                             class="fa fa-eye"></i></a>
                                    </td>
                                    <td>
                                       <span class="badge light badge-warning" data-bs-toggle="modal" id="edit_gym_data1"
                                          data-idgym="<?= $spa_f_s['front_ofs_service_id'] ?>"
                                          data-bs-target="#exampleModalCenter1">View</span>
                                    </td>
                                    <!-- packages -->
                                    <div class="modal fade" id="exampleModalCenter1"
                                       data-idgym="<?= $spa_f_s['front_ofs_service_id'] ?>" style="display: none;"
                                       aria-hidden="true">
                                    ...
                                    <!--/. packages -->
                                    <td>
                                       <a style="margin:auto" data-bs-toggle="modal" data-bs-target=".bd-terms-modal-sm1"
                                          id="edit_gym_data" data-idgym="<?= $spa_f_s['front_ofs_service_id'] ?>"
                                          class="btn btn-secondary shadow btn-xs sharp"><i class="fa fa-eye"></i></a>
                                    </td>
                                    <!-- modal for terms and conditions -->
                                    <div class="modal fade"
                                       id="exampleModalCenter_<?php echo $spa_f_s['front_ofs_service_id'] ?>"
                                    ...
                                    <td>
                                       <div class="">
                                          <a href="#" class="btn btn-warning shadow btn-xs sharp me-1" id="edit_gym_data"
                                             data-bs-toggle="modal" data-idgym="<?= $spa_f_s['front_ofs_service_id'] ?>"
                                             data-bs-target="#edit_spa_model"><i class="fa fa-pencil"></i></a>
                                       </div>
                                    </td>
                                 </tr>
                                 <div class="modal fade bd-terms-modal-sm" tabindex="-1" style="display: none;"
                                    aria-hidden="true">
                                    <div class="modal-dialog modal-md">
                                       <div class="modal-content">
                                          <div class="modal-header">
                                 ...
                                 <div class="modal fade bd-terms-modal-sm1" tabindex="-1" style="display: none;"
                                    aria-hidden="true">
                                    <div class="modal-dialog modal-md">
                                       <div class="modal-content">
                                          <div class="modal-header">
               ...
               <div class="tab-pane" style="background-color:white;" id="arrival2_div1_spa">
                  <div class="table-scrollable spa_added services_block">
                           ...
                           if (!empty($spa_request)) {
                              foreach ($spa_request as $spa_r_s) {
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <a href="#" class="btn btn-secondary shadow btn-xs sharp me-1" data-bs-toggle="modal"
                                          id="edit" data-id="<?php echo $spa_r_s['spa_service_request_id'] ?>"
                                          data-bs-target="#description_model1"><i class="fa fa-eye"></i></a>
                                    </td>
                                    ...
                                    <td>
                                       <div>
                                          <a href="#" class="btn btn-warning shadow btn-xs sharp me-1 update_spa_modal_btn"
                                             id="edit_spa_data" data-id1="<?= $spa_r_s['spa_service_request_id'] ?>"><i
               ...
               <div class="tab-pane" style="background-color:white;" id="arrival3_div_spa">
                  <div class="table-scrollable spa_change_record1 services_block">
                           ...
                           if (!empty($spa_request1)) {
                              foreach ($spa_request1 as $spa_r_s) {
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <a href="#" class="btn btn-secondary shadow btn-xs sharp me-1" data-bs-toggle="modal"
                                          data-bs-target="#description_model_<?php echo $spa_r_s['spa_service_request_id'] ?>"><i
                                             class="fa fa-eye"></i></a>
                                    </td>
                                    <!-- modal forDescription -->
                                    <div class="modal fade"
                                       id="description_model_<?php echo $spa_r_s['spa_service_request_id'] ?>"
                                       style="display: none;" aria-hidden="true">
                                       <div class="modal-dialog modal-dialog-centered" role="document">
                                          <div class="modal-content">
                                             <div class="modal-header">
                                    ...
                                    <!--/. modal for Description-->
                                    <input type="hidden" name="user_id" id="uid<?php echo $spa_r_s['spa_service_request_id']; ?>"
                                       value="<?php echo $spa_r_s['spa_service_request_id']; ?>">
                                    <td>
                                       <!-- <a href="#">
                                 <div class="badge badge-warning"
                                     ...
                                     Assign</div>
                                       ...
                                       <select class="form-control" name="status"
                                          id="spastatus<?php echo $spa_r_s['spa_service_request_id']; ?>"
                                          onchange="spa_change_status(<?php echo $spa_r_s['spa_service_request_id'] ?>);"
               ...
               <div class="tab-pane" style="background-color:white;" id="arrival5_div_spa">
                  <div class="table-scrollable spa_change_record2 services_block">
                           ...
                           if (!empty($spa_request6)) {
                              foreach ($spa_request6 as $spa_c_s) {
                                 ...
                                 <tr>
                                    ...
                                    <td><?php echo $user_data['full_name'] ?></td>
                                    <td><?php echo $user_data['mobile_no'] ?></td>
                                    <td><?php echo date('d-m-Y', strtotime($spa_c_s['select_date'])) ?></td>
                                    <!-- <td>23/12/2022</td> -->
                                    <td><?php echo date('h:i a', strtotime($spa_c_s['select_time'])) ?></td>
                                    <td><?php echo $spa_type; ?></td>
                                    <td>
                                       <a href="#" class="btn btn-secondary shadow btn-xs sharp me-1" data-bs-toggle="modal"
                                          data-bs-target="#description_model_<?php echo $spa_c_s['spa_service_request_id'] ?>"><i
                                             class="fa fa-eye"></i></a>
                                    </td>
                                    <!-- modal forDescription -->
                                    <div class="modal fade"
                                       id="description_model_<?php echo $spa_c_s['spa_service_request_id'] ?>"
                                       style="display: none;" aria-hidden="true">
               ...
               <div class="tab-pane" style="background-color:white;" id="arrival4_div_spa">
                  <div class="table-scrollable spa_change_record3 services_block">
                                 ...
                                 <div class="mb-3 col-md-6 form-group">
                                    ...
                                    <div class="input-group">
                                       <input type="time" name="break_start_time" id="break_start_time"
                                          class="form-control">
                                       <input type="time" name="break_close_time" id="break_close_time"
                                          class="form-control">
                                    </div>
                                 </div>
                              </div>
...
//                                           foreach ($spa_images as $s_im) {
                              ...
                              <div id="TextBoxContainer12_<?php echo $spa_f_s['front_ofs_service_id'] ?>" class="mb-1">
                              </div>
                              <?php
                                 ...
                                 <div class="row">
                                    ...
                                    foreach ($services_imgs as $se_i) {
                                       ...
                                       <div class=" col-md-6 ">
                                          <input type="hidden" name="front_ofs_service_image_id[]"
                                             value="<?php echo $se_i['front_ofs_service_image_id'] ?>">
                                          <input type="file" class="dropify form-control" name="image[<?php echo $j ?>]"
                                             id="files" accept="image/jpeg, image/png,"
            ...
            <form id="spa_request" method="post" enctype="multipart/form-data">
               ...
               <div class="modal-body">
                  <div class="row">
                     ...
                     <div class="mb-3 col-md-6 form-group">
                        <label class="form-label">Contact Number</label>
                        <input type="text" maxlength="10" name="mobile_no" id="mobile_no" onkeyup="add_booking_id()"
                           oninput="this.value=this.value.replace(/[^0-9]/g,'');" class="form-control"
                           placeholder="Contact Number" required="">
                     </div>
                     <div class="mb-3 col-md-6 form-group">
                        <label class="form-label">Booking ID</label>
                        <input type="number" name="booking_id" class="form-control" id="booking_id"
                           placeholder="Booking ID" required="" disable>
                     </div>
                     <div class="mb-3 col-md-6 form-group">
                     ...
                     <div class="mb-3 col-md-6 form-group">
                        <label class="form-label">Spa Type</label>
                        <select id="spa_type" name="spa_type"
                           class="default-select form-control wide  dropdown js-example-disabled-results" required="">
                           ...
                           foreach ($spa_images as $s_im) {
                              ?>
                              <option value="<?php echo $s_im['front_ofs_spa_service_images_id'] ?>">
                                 <?php echo $s_im['spa_type'] ?></option>
                              <?php
                           }
                           ?>
                        </select>
                     ...
                     <div class="mb-3 col-md-12 form-group">
                        ...
                        <textarea class="summernote" id="description1" name="additional_note"
                  ...
                  <div class="basic-form">
                     <div class="row">
                        <div class="mb-3 col-md-12">
                           ...
                           <input type="hidden" name="spa_u_id" id="spa_u_id">
   ...
   <script>
      $(document).ready(function () {
         $(document).on('click', '#edit_gym_data1', function () {
            var id = $(this).attr('data-idgym');
            // alert(id);
            $.ajax({
   ...
   <script>
      $(document).on('submit', '#spa_request', function (e) {
         e.preventDefault();
         var form = $(this);
         var submitButton = form.find('button[type="submit"]'); // Assuming your submit button is of type "submit"
   ...
   <script>
      $(document).on('click', '#edit_spa_data', function () {
         ...
         $.ajax({
            ...
            success: function (data) {
               console.log(data);
               $('#spa_service_request_id1').val(data.spa_request.spa_service_request_id);
               $('#spa_u_id').val(data.spa_request.u_id);
            }
         });
      })
                     ...
                     if ($list) {
                        foreach ($list as $p_f_s) {
                           ...
                           <tr>
                              ...
                              <td>
                                 <?php echo date('h:i a', strtotime($p_f_s['open_time'])) . "-" . date('h:i a', strtotime($p_f_s['close_time'])) ?>
                              </td>
                              <td>
                                 <?php echo date('h:i a', strtotime($p_f_s['break_start_time'])) . "-" . date('h:i a', strtotime($p_f_s['break_close_time'])) ?>
                              </td>
                              <td>
                                 <div>
                                    <span class="badge light badge-warning" data-bs-toggle="modal" id="edit_pool_data"
                              ...
                              <td>
                                 <a href="#" class="btn btn-secondary shadow btn-xs sharp me-1" data-bs-toggle="modal"
                                    id="edit_pool_data" data-idpool="<?= $p_f_s['front_ofs_service_id'] ?>"
                                    data-bs-target=".bd-terms-modal-sm"><i class="fa fa-eye"></i></a>
                              </td>
                              <td>
                                 <div class="">
                                    <a href="#" class="btn btn-warning shadow btn-xs sharp me-1" id="edit_pool_data"
                                       data-bs-toggle="modal" data-idpool="<?= $p_f_s['front_ofs_service_id'] ?>"
                  ...
                  <div class="col-lg-12">
                     <div class="basic-form">
                        ...
                        <div class="row">
                           <div class="mb-3 col-md-6 form-group">
                              <label class="form-label">Staff Name</label>
                              <input type="text" name="staff_name" id="staff_name" class="form-control" value="Amit Sahane"
                                 required="">
                           </div>
                           <div class="mb-3 col-md-6 form-group">
                              <label class="form-label">Contact Number</label>
                        ...
                        <div class="row">
                           ...
                           <div class="mb-3 col-md-6 form-group">
                              <label class="form-label">Terms & Conditions</label>
                              <textarea class="summernote" name="t_nd_c" rows="3" id="t_nd_c" required="">t_nd_c</textarea>
                           </div>
                        </div>
                        <?php
                        ...
                        if ($services_imgs) {
                           ...
                           <div class="mb-3 col-md-6 form-group">
                              ...
                              foreach ($services_imgs as $se_i) {
                                 ...
                                 <input type="hidden" name="front_ofs_service_image_id[]"
                                    value="<?php echo $se_i['front_ofs_service_image_id'] ?>">
                                 <input type="file" class="dropify form-control" name="image[<?php echo $j ?>]" id=""
                                    accept="image/jpeg, image/png, image/gif," data-default-file="<?php echo $se_i['image'] ?>">
                                 <br>
                                 <output id="Filelist"></output>
                                 <?php
                                 $j++;
...
<?php } elseif ($sub_icon_id == 4) { ?>
                  ...
                  <table id="example1" class="display full-width">
                     ...
                     <tbody class="shuttle_new_data">
                        ...
                        if ($list) {
                           foreach ($list as $sh_f_s) {
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <a style="margin:auto" data-bs-toggle="modal" data-bs-target=".bd-terms-modal-sm"
                                       id="edit_shuttle_data" data-idshuttle="<?= $sh_f_s['front_ofs_service_id'] ?>"
                                       class="btn btn-secondary shadow btn-xs sharp"><i class="fa fa-eye"></i></a>
                                 </td>
                                 <td>
                                    <a style="margin:auto" data-bs-toggle="modal" data-bs-target=".bd-terms-modal-sm1"
                        ...
                        <a href="" data-bs-toggle="modal"
                            ...
                            <img src="assets/dist/images/term.jpg" alt=""
                                height="40px" width="90px">
                                 ...
                                 <!-- image gallery -->
                                 <div class="modal fade bd-example1-modal-md_<?php echo $sh_f_s['front_ofs_service_id'] ?>"
                                    tabindex="-1" style="display: none;" aria-hidden="true">
                                    <div class="modal-dialog modal-md">
                                       <div class="modal-content">
                                          <div class="modal-header">
                                 ...
                                 <!--/. image gallery -->
                                 <td>
                                    <a href="#" class="btn btn-warning shadow btn-xs sharp me-1" id="edit_shuttle_data"
                                       data-bs-toggle="modal" data-idshuttle="<?= $sh_f_s['front_ofs_service_id'] ?>"
                                       data-bs-target="#edit_shuttle_model"><i class="fa fa-pencil"></i></a>
                                    <!-- <a href="#" onclick="delete_data(<?php echo $sh_f_s['front_ofs_service_id'] ?>)"
                           class="btn btn-info shadow btn-xs sharp"><i
                               class="fa fa-list"></i></a> -->
                                    <a href="#" title="Availability" class="btn btn-info shadow btn-xs sharp"
                                       onclick="orderservice1(<?php echo $sh_f_s['front_ofs_service_id'] ?>)"><i
                                          class="fa fa-list"></i></a>
                                 </td>
                                 <!-- <td>
                        <div class="active_deactive"><label class="switchToggle">
                           ...
                           <input type="checkbox" name="yes_no" active-deactive-subid="<?php echo $sub_icon_id; ?>" class="yes_no" data-id="<?php echo $sh_f_s['front_ofs_service_id'] ?>" <?php if ($sh_f_s['status'] == 1) {
                        ...
                        <div class="modal-content">
                           ...
                           <form id="editshuttleCenterForm" method="post" enctype="multipart/form-data">
                              <div class="modal-body">
                                 <div class="col-lg-12">
                                    <div class="basic-form">
                                       <input type="hidden" name="front_ofs_service_id"
                                          value="<?php echo $sh_f_s['front_ofs_service_id'] ?>">
                                       <input type="hidden" class="form-control" value="4" name="service_name">
                                       <div class="row">
                                          <div class="mb-3 col-md-6 form-group">
                                             <label class="form-label">Staff Name</label>
                                             <input type="text" name="staff_name" value="<?php echo $sh_f_s['staff_name'] ?>"
                                                class="form-control" value="Amit Sahane" required="">
                                          </div>
                                          <div class="mb-3 col-md-6 form-group">
                                             <label class="form-label">Contact Number</label>
                                             <input type="text" name="contact_no" maxlength="10"
                                                value="<?php echo $sh_f_s['contact_no'] ?>"
                                                oninput="this.value=this.value.replace(/[^0-9]/g,'');" class="form-control"
                                                value="9878675645" required="">
                                          </div>
                                       </div>
                                       ...
                                       if ($services_imgs) {
                                          ...
                                          <div class="mb-3 col-md-6 form-group">
                                             ...
                                             // {
                                             ?>
                                             <input type="hidden" name="shuttle_service_image_id"
                                                value="<?php echo $services_imgs['front_ofs_service_image_id'] ?>">
                                             <input type="file" class="dropify form-control" name="shuttle_img" id="files"
                                                accept="image/jpeg, image/png, image/gif,"
                                                data-default-file="<?php echo $services_imgs['image'] ?>">
                                             <br>
                                             <output id="Filelist"></output>
                                             <?php
                                             //     $j++;
            ...
            <div class="accepted_orders_div_service" style="display: none;">
               <div class="col-md-12 col-sm-12">
                  <div class="panel tab-border card-box">
                     <header class="panel-heading panel-heading-gray custom-tab">
                        <ul class="nav nav-tabs">
                           <li class="nav-item"><a href="#sun_div" data-bs-toggle="tab" class="active">Sunday</a>
                           </li>
                           <li class="nav-item"><a href="#monday_div" data-bs-toggle="tab">Monday</a>
                           </li>
                           <li class="nav-item"><a href="#tue_div" data-bs-toggle="tab">Tuesday</a>
                           </li>
                           <li class="nav-item"><a href="#wed_div" data-bs-toggle="tab">Wednesday</a>
                           </li>
                           <li class="nav-item"><a href="#thu_div" data-bs-toggle="tab">Thursday</a>
                           </li>
                           <li class="nav-item"><a href="#fri_div" data-bs-toggle="tab">Friday</a>
                           </li>
                           <li class="nav-item"><a href="#sat_div" data-bs-toggle="tab">Saturday</a>
                           </li>
                        </ul>
                     </header>
                  </div>
               ...
               <div class="tab-content">
                  <div class="tab-pane active" style="background-color:white;" id="sun_div">
                              ...
                              <tbody id="searchTable" class="append_data">
                                 ...
                                 if ($sun_list) {
                                    foreach ($sun_list as $sun_l) {
                                       ?>
                                       <tr>
                                          <td><strong><?php echo date('h:i a', strtotime($sun_l['start_time'])) . " - " . date('h:i a', strtotime($sun_l['end_time'])) ?>
                                             </strong></td>
                                          <td>
                                             <div class="container">
                                                <label class="switch">
                                                   ...
                                                   if ($sun_l['available_status'] == 1) {
                                                      ?>
                                                      <input type="checkbox" value="0" name="available_status"
                                                         id="status_<?php echo $sun_l['shuttle_service_avaibility_id'] ?>"
                                                         onchange="change_status(<?php echo $sun_l['shuttle_service_avaibility_id'] ?>)"
                                                      ...
                                                      ?>
                                                      <input type="checkbox" value="1" name="available_status"
                                                         id="status_<?php echo $sun_l['shuttle_service_avaibility_id'] ?>"
                                                         onchange="change_status(<?php echo $sun_l['shuttle_service_avaibility_id'] ?>)"
                                                         class="switch-input">
                  ...
                  <div class="tab-pane " style="background-color:white;" id="monday_div">
                     <div class="monday_div">
                        <br>
                        <form id="editshuttleCenterForm12" method="post">
                        ...
                        <div class="table-scrollable">
                           <table id="monday_tbl" class="display full-width">
                              ...
                              <tbody id="searchTable" class="append_data_mon">
                                 <?php
                                 if ($mon_list) {
                                    foreach ($mon_list as $ml) {
                                       ?>
                                       <tr>
                                          <td><strong><?php echo date('h:i a', strtotime($ml['start_time'])) . " - " . date('h:i a', strtotime($ml['end_time'])) ?>
                                             </strong></td>
                                          <td>
                                             <div class="container">
                                                <label class="switch">
                                                   ...
                                                   if ($ml['available_status'] == 1) {
                                                      ?>
                                                      <input type="checkbox" value="0" name="available_status"
                                                         id="status_<?php echo $ml['shuttle_service_avaibility_id'] ?>"
                                                         onchange="change_status(<?php echo $ml['shuttle_service_avaibility_id'] ?>)"
                                                         class="switch-input" checked>
                                                      <span class="switch-label" data-on="Available"></span>
                                                      <span class="switch-handle"></span>
                                                      <?php
                  ...
                  <div class="tab-pane " style="background-color:white;" id="tue_div">
                     <div class="tuesday_div">
                        <br>
                        <form id="editshuttleCenterForm12" method="post">
                              ...
                              <tbody id="searchTable">
                                 ...
                                 if ($tue_list) {
                                    foreach ($tue_list as $tuel) {
                                       ?>
                                       <tr>
                                          <td><strong><?php echo date('h:i a', strtotime($tuel['start_time'])) . " - " . date('h:i a', strtotime($tuel['end_time'])) ?>
                                             </strong></td>
                                          <td>
                                             <div class="container">
                                                <label class="switch">
                                                   ...
                                                   if ($tuel['available_status'] == 1) {
                                                      ?>
                                                      <input type="checkbox" value="0" name="available_status"
                                                         id="status_<?php echo $tuel['shuttle_service_avaibility_id'] ?>"
                                                         onchange="change_status(<?php echo $tuel['shuttle_service_avaibility_id'] ?>)"
                                                         class="switch-input" checked>
                                                      <span class="switch-label" data-on="Available"></span>
                                                      <span class="switch-handle"></span>
                                                      <?php
                  ...
                  <div class="tab-pane " style="background-color:white;" id="wed_div">
                     <div class="wednesday_div">
                        <br>
                        <form id="editshuttleCenterForm12" method="post">
                              ...
                              <tbody id="searchTable">
                                 ...
                                 if ($wed_list) {
                                    foreach ($wed_list as $wed_l) {
                                       ?>
                                       <tr>
                                          <td><strong><?php echo date('h:i a', strtotime($wed_l['start_time'])) . " - " . date('h:i a', strtotime($wed_l['end_time'])) ?>
                                             </strong></td>
                                          <td>
                                             <div class="container">
                                                <label class="switch">
                                                   ...
                                                   if ($wed_l['available_status'] == 1) {
                                                      ?>
                                                      <input type="checkbox" value="0" name="available_status"
                                                         id="status_<?php echo $wed_l['shuttle_service_avaibility_id'] ?>"
                                                         onchange="change_status(<?php echo $wed_l['shuttle_service_avaibility_id'] ?>)"
                                                         class="switch-input" checked>
                                                      <span class="switch-label" data-on="Available"></span>
                                                      <span class="switch-handle"></span>
                                                      <?php
                  ...
                  <div class="tab-pane " style="background-color:white;" id="thu_div">
                     <div class="thursday_div">
                        <br>
                        <form id="editshuttleCenterForm12" method="post">
                              ...
                              <tbody id="searchTable">
                                 ...
                                 if ($thurs_list) {
                                    foreach ($thurs_list as $thu_l) {
                                       ?>
                                       <tr>
                                          <td><strong><?php echo date('h:i a', strtotime($thu_l['start_time'])) . " - " . date('h:i a', strtotime($thu_l['end_time'])) ?>
                                             </strong></td>
                                          <td>
                                             <div class="container">
                                                <label class="switch">
                                                   ...
                                                   if ($thu_l['available_status'] == 1) {
                                                      ?>
                                                      <input type="checkbox" value="0" name="available_status"
                                                         id="status_<?php echo $thu_l['shuttle_service_avaibility_id'] ?>"
                                                         onchange="change_status(<?php echo $thu_l['shuttle_service_avaibility_id'] ?>)"
                                                         class="switch-input" checked>
                                                      <span class="switch-label" data-on="Available"></span>
                                                      <span class="switch-handle"></span>
                                                      <?php
                  ...
                  <div class="tab-pane " style="background-color:white;" id="fri_div">
                     <div class="friday_div">
                        <br>
                        <form id="editshuttleCenterForm12" method="post">
                              ...
                              <tbody id="searchTable">
                                 ...
                                 if ($fri_list) {
                                    foreach ($fri_list as $fr_l) {
                                       ?>
                                       <tr>
                                          <td><strong><?php echo date('h:i a', strtotime($fr_l['start_time'])) . " - " . date('h:i a', strtotime($fr_l['end_time'])) ?>
                                             </strong></td>
                                          <td>
                                             <div class="container">
                                                <label class="switch">
                                                   ...
                                                   if ($fr_l['available_status'] == 1) {
                                                      ?>
                                                      <input type="checkbox" value="0" name="available_status"
                                                         id="status_<?php echo $fr_l['shuttle_service_avaibility_id'] ?>"
                                                         onchange="change_status(<?php echo $fr_l['shuttle_service_avaibility_id'] ?>)"
                                                         class="switch-input" checked>
                                                      <span class="switch-label" data-on="Available"></span>
                                                      <span class="switch-handle"></span>
                                                      <?php
                  ...
                  <div class="tab-pane " style="background-color:white;" id="sat_div">
                     <div class="saturday_div">
                        <br>
                        <form id="editshuttleCenterForm12" method="post">
                              ...
                              <tbody id="searchTable">
                                 ...
                                 if ($sat_list) {
                                    foreach ($sat_list as $sat_l) {
                                       ?>
                                       <tr>
                                          <td><strong><?php echo date('h:i a', strtotime($sat_l['start_time'])) . " - " . date('h:i a', strtotime($sat_l['end_time'])) ?>
                                             </strong></td>
                                          <td>
                                             <div class="container">
                                                <label class="switch">
                                                   ...
                                                   if ($sat_l['available_status'] == 1) {
                                                      ?>
                                                      <input type="checkbox" value="0" name="available_status"
                                                         id="status_<?php echo $sat_l['shuttle_service_avaibility_id'] ?>"
                                                         onchange="change_status(<?php echo $sat_l['shuttle_service_avaibility_id'] ?>)"
                                                         class="switch-input" checked>
                                                      <span class="switch-label" data-on="Available"></span>
                                                      <span class="switch-handle"></span>
                                                      <?php
      ...
      <script>
         ...
         $(document).unbind('submit').on('submit', '#editshuttleCenterForm12', function (e) {
            ...
            $.ajax({
               ...
               success: function (res) {
                  // console.log(res);
                  $.get('<?= base_url('FrontofficeController/shuttle_Avil'); ?>', function (data) {
                     var resu = $(data).find('#sun_div').html();
                     var resu1 = $(data).find('#monday_div').html();
                     var resu2 = $(data).find('#tue_div').html();
                     var resu3 = $(data).find('#wed_div').html();
                     var resu4 = $(data).find('#thu_div').html();
                     var resu5 = $(data).find('#fri_div').html();
                     var resu6 = $(data).find('#sat_div').html();

                     $('#sun_div').html(resu);
                     $('#monday_div').html(resu1);
                     $('#tue_div').html(resu2);
                     $('#wed_div').html(resu3);
                     $('#thu_div').html(resu4);
                     $('#fri_div').html(resu5);
                     ...
                     setTimeout(function () {
                        ...
                        var day = res;
                        console.log(day);// Change this to your desired condition
                        if (day === "Sunday") {
                           $('a[href="#sun_div"]').tab('show');
                        } else if (day === "Monday") {
                           $('a[href="#monday_div"]').tab('show');
                        } else if (day === "Tuesday") {
                           $('a[href="#tue_div"]').tab('show');
                        } else if (day === "Wednesday") {
                           $('a[href="#wed_div"]').tab('show');
                        } else if (day === "Thursday") {
                           $('a[href="#thu_div"]').tab('show');
                        } else if (day === "Friday") {
                           $('a[href="#fri_div"]').tab('show');
                        } else if (day === "Saturday") {
                           $('a[href="#sat_div"]').tab('show');
                        }
                        else {
                           $('a[href="#sun_div"]').tab('show');
                        }
               ...
               <div class="table-scrollable">
                  <table id="example1" class="display full-width">
                     ...
                     <td><?php //echo $baby_f_s['break_start_time'] ?> - <?php //echo $baby_f_s['break_close_time'] ?></td> -->
                                 <td>
                                    <?php echo date('h:i a', strtotime($baby_f_s['open_time'])) . "-" . date('h:i a', strtotime($baby_f_s['close_time'])) ?>
                                 </td>
                                 <td>
                                    <?php echo date('h:i a', strtotime($baby_f_s['break_start_time'])) . "-" . date('h:i a', strtotime($baby_f_s['break_close_time'])) ?>
                                 </td>
                                 <!-- <td>
                        <button class="btn btn-secondary_<?php echo $baby_f_s['front_ofs_service_id'] ?> shadow btn-xs sharp me-1"><i
                            class="fa fa-eye"></i></button>
                                 ...
                                 <td>
                                    <a href="#" class="btn btn-secondary shadow btn-xs sharp me-1" data-bs-toggle="modal"
                                       id="edit_baby_data" data-idbaby="<?= $baby_f_s['front_ofs_service_id'] ?>"
                                       data-bs-target=".bd-terms-modal-sm"><i class="fa fa-eye"></i></a>
                                 </td>
                                 <td>
                                    <div>
                                       <span class="badge light badge-warning" data-bs-toggle="modal" id="edit_baby_data"
                                 ...
                                 <td>
                                    <div class="d-flex">
                                       <a href="#" class="btn btn-warning shadow btn-xs sharp me-1" id="edit_baby_data"
                                          data-bs-toggle="modal" data-idbaby="<?= $baby_f_s['front_ofs_service_id'] ?>"
                        ...
                        <div class="active_deactive"><label class="switchToggle">
                           <input type="hidden" name="sub_icon_id" class="active_deactive_subid" value="<?php echo $sub_icon_id; ?>">
                           <input type="checkbox" name="yes_no" active-deactive-subid="<?php echo $sub_icon_id; ?>" class="yes_no" data-id="<?php echo $baby_f_s['front_ofs_service_id'] ?>" <?php if ($baby_f_s['status'] == 1) {
                                    echo "checked='checked'";
                                 } ?>>
                           <span class="slider yellow round"></span></label>
                        </div>
                           ...
                           <div class="col-lg-12">
                              <div class="basic-form">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="mb-3 col-md-6 form-group">
                                       <label class="form-label">Terms & Conditions</label>
                                       <textarea class="summernote" name="t_nd_c" rows="3" id="t_nd_c" required=""></textarea>
                                    </div>
                                 </div>
                                 <?php
            ...
            <div class="card-body ">
               <div class="col-md-12 col-sm-12">
                  <div class="panel tab-border card-box">
                     <header class="panel-heading panel-heading-gray custom-tab">
                        <ul class="nav nav-tabs">
                           <li class="nav-item"><a href="#arrival1_div" data-bs-toggle="tab" class="active">Car Wash
                                 Request</a>
                           </li>
                           ...
                           <li class="nav-item"><a href="#completed_orders_div_new" data-bs-toggle="tab">Completed Car
                                 Request</a>
                           </li>
   ...
   <select class="form-control" id="orderserviceDropdown">
       ...
       <option value="rejected_order">Washing Charges</option>
               ...
               <div class="new_orders_div">
                  ...
                  <div class="tab-content">
                     <div class="tab-pane active" style="background-color:white;" id="arrival1_div">
                        ...
                        <div class="table-scrollable1 table-scrollable services_block">
                           <table id="example1" class="display full-width">
                              <thead>
                                 <tr>
                                    <th><strong>Sr. No.</strong></th>
                                             ...
                                             <td>
                                                <div id="lightgallery" class="room-list-bx  align-items-center">
                                                   <a href="<?php echo $v_w_r['vehicle_img'] ?>" target="_blank"
                                                      ...
                                                      class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                                      <img class="me-3 " src="<?php echo $v_w_r['vehicle_img'] ?>" alt=""
                                                         style="width:50px;">
                                                   </a>
                                                </div>
                                             </td>
                             ...
                             class="fa fa-eye"></i></button>
                                             ...
                                             data-bs-target=".exampleModalCenter"><i class="fa fa-eye"></i></a>  -->
                                                <a style="margin:auto" data-bs-toggle="modal" id="edit_data"
                                                   data-bs-target=".bd-terms-modal-sm"
                                                   data-id="<?php echo $v_w_r['vehicle_wash_request_id'] ?>"
                                                   class="btn btn-secondary shadow btn-xs sharp"><i class="fa fa-eye"></i></a>
                                             </td>
                                             <td>
                                                <div>
                                                   <a href="#" class="btn btn-warning shadow btn-xs sharp update_car_modal_btn"
                                                      id="edit_car_data" data-id2="<?= $v_w_r['vehicle_wash_request_id'] ?>"><i
                                                         class="fa fa-share"></i></a>
                                                </div>
                                             </td>
                                          </tr>
                     ...
                     <div class="tab-pane" id="completed_orders_div_new" style="background-color:white;">
                        <div class="table-scrollable7 table-scrollable services_block">
                                    ...
                                    foreach ($vehicle_wash_request7 as $v_w_c) {
                                       ...
                                       if ($user_data) {
                                          ...
                                          <tr>
                                             ...
                                             <td>
                                                <div class="d-flex">
                                                   <a href="#"><span class="badge badge-success" data-bs-toggle="modal"
                                 ...
                                 if ($vehicle_wash_request3) {
                                    foreach ($vehicle_wash_request3 as $v_w_r) {
                                       ...
                                       if ($user_data) {
                                          ...
                                          <div class="modal fade bd-terms-modal-sm_<?php echo $v_w_r['vehicle_wash_request_id'] ?>"
                                             tabindex="-1" style="display: none;" aria-hidden="true">
                                             <div class="modal-dialog modal-md">
                                                <div class="modal-content">
                                                   <div class="modal-header">
                     ...
                     <div class="tab-pane" style="background-color:white;" id="arrival4_div">
                        <div class="rejected_orders_div">
                           <div>
                              <button style="float:right;margin-bottom:20px;" type="button" class="btn btn-primary css_btn"
                                 data-bs-toggle="modal" data-bs-target="#exampleModalCenter1">Add Washing
                                 Charges</button>
                           </div>
                        </div>
                        <div class="table-scrollable table-scrollable services_block">
                                          ...
                                          <td>
                                             <div>
                                                <a href="#" class="btn btn-warning shadow btn-xs sharp me-1"
                                                   id="edit_charges_data" data-bs-toggle="modal"
                                                   data-id-editcharges="<?= $v_wash_char['vehicle_washing_charge_id'] ?>"
                                                   data-bs-target=".edit_charges_model"><i class="fa fa-pencil"></i></a>
                                                <a href="#" class="btn btn-danger shadow btn-xs sharp me-1"
                                                   id="delete_data_charges"
                                                   delete-id-charges="<?= $v_wash_char['vehicle_washing_charge_id'] ?>"><i
                                                      class="fa fa-trash"></i></a>
                     ...
                     <!-- edit -->
                     <div class="modal fade edit_charges_model" style="display: none;" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                           <div class="modal-content">
                              <div class="modal-header">
                              ...
                              <form id="editchargesForm" method="post" enctype="multipart/form-data">
                                 <div class="basic-form">
                                    <input type="hidden" name="vehicle_washing_charge_id" id="vehicle_washing_charge_id">
                                    <div class="modal-body">
                                       <div class="row">
                                          <div class="mb-3 col-md-12 form-group">
                                       ...
                                       if ($user_data) {
                                          ...
                                          <tr>
                                             ...
                                             <input type="hidden" name="user_id"
                                                id="uid<?php echo $v_w_r['vehicle_wash_request_id']; ?>"
                                                value="<?php echo $v_w_r['vehicle_wash_request_id']; ?>">
                                             <td>
                                                <select class="form-control" name="status"
                                                   id="carwashstatus<?php echo $v_w_r['vehicle_wash_request_id']; ?>"
                                                   onchange="car_change_status(<?php echo $v_w_r['vehicle_wash_request_id'] ?>);"
                                                   style="min-width:85px;text-align:center">
                                                   <?php
                                                   if ($v_w_r['request_status'] == "1") {
                                                      ?>
                  ...
                  <div class="modal fade" id="exampleModalCenter1" style="display: none;" aria-hidden="true">
                     <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                           ...
                           <form id="frmblockcharges" method="post" enctype="multipart/form-data">
                              <div class="modal-body">
                                 <div class="row">
                                    <div class="mb-3 col-md-12 form-group">
                                       <label class="form-label">Vehicle Type</label>
               ...
               <!-- add btn modal  -->
               <div class="modal fade bd-add-modal add_facility_modal_car" tabindex="-1" style="display: none;"
                  aria-hidden="true">
                  <div class="modal-dialog modal-lg">
                     <div class="modal-content">
                        <form id="car_wash_request" method="post" enctype="multipart/form-data">
                           <div class="modal-header">
                              <h5 class="modal-title" style="font-weight: bold;font-size: 15px !important;">Add Car Wash
                                 Request</h5>
                              <button type="button" class="btn-close" data-bs-dismiss="modal">
                              </button>
                           </div>
                              ...
                              <div class="row">
                                 <div class="mb-3 col-md-6 form-group">
                                    ...
                                    <input type="text" maxlength="10" name="mobile_no" id="mobile_no"
                                       onkeyup="add_booking_id()" oninput="this.value=this.value.replace(/[^0-9]/g,'');"
                                 ...
                                 <div class="mb-3 col-md-6 form-group">
                                    <label class="form-label">Request Date</label>
                                    <input type="date" class="form-control minDate" name="request_date" placeholder="Date"
                                       required>
                                 </div>
                                 <div class="mb-3 col-md-6 form-group">
                                    <label class="form-label">Request Timcar_we</label>
                                    <input type="time" class="form-control minDate" name="request_time" placeholder="time"
                                       required>
                                 </div>
                                 <div class="mb-3 col-md-6 form-group">
                                    <label class="form-label">Vehicle Name</label>
                                    <input type="text" class="form-control minDate" name="vehicle_name"
                                       placeholder="Vehicle Name" required>
                                 </div>
                                 <div class="mb-3 col-md-6 form-group">
                                    <label class="form-label">Vehicle No.</label>
                                    <input type="text" class="form-control minDate" name="vehicle_no"
                                       placeholder="Vehicle No" required>
                                 </div>
                                 <div class="mb-3 col-md-6 form-group">
                                    <label class="form-label">Vehicle Type</label>
                                    <select id="vehicle_washing_charge_id" name="vehicle_washing_charge_id"
                                       class="default-select form-control wide  dropdown js-example-disabled-results"
                                       required="">
                                       <option selected="">Select... </option>
                                       <?php
                                       $u_id = $this->session->userdata('u_id');
                                       ...
                                       foreach ($vehicle_washing_charges as $s_im) {
                                          ?>
                                          <option value="<?php echo $s_im['vehicle_washing_charge_id'] ?>">
                                             <?php echo $s_im['vehicle_type'] ?></option>
                                          <?php
                                       }
                                       ?>
                                    </select>
                              ...
                              <div class="basic-form">
                                 <div class="row">
                                    <div class="mb-3 col-md-12">
                                       ...
                                       <input type="hidden" name="car_u_id" id="car_u_id">
                                       <label class="form-label">Change Order Status</label>
                                       <select id="send_user1" name="request_status"
               ...
               <script>
                  $('#frmblockcharges').submit(function (e) {
                     e.preventDefault();
                     $(".loader_block").show();
                     var form_data = new FormData(this);
                     $.ajax({
                        url: '<?= base_url('FrontofficeController/add_vehicle_washing_charges') ?>',
                        method: 'POST',
                        data: form_data,
                        processData: false,
                        contentType: false,
                        ...
                        success: function (res) {
                           ...
                           $.get('<?= base_url('FrontofficeController/ajaxOrderIconView_v1'); ?>', function (data) {
                              var resu = $(data).find('#arrival4_div').html();
                              $('#arrival4_div').html(resu);
                              setTimeout(function () {
                  ...
                  //  update business center data
                  $('#editchargesForm').submit(function (e) {
                     e.preventDefault();
                     $(".loader_block").show();
                     var form_data = new FormData(this);

                     $.ajax({
                        url: '<?= base_url('FrontofficeController/edit_vehicle_washing_charges') ?>',
                        method: 'POST',
                        data: form_data,
                        processData: false,
                        contentType: false,
                  ...
                  $(document).on('click', '#delete_data_charges', function (event) {
                     event.preventDefault(); // Prevent the default behavior of the form submit button

                     var id = $(this).attr('delete-id-charges');
                     ...
                     swal({
                        ...
                        if (isConfirm) {
                           $.ajax({
                              url: '<?= base_url('FrontofficeController/delete_vehicle_washing_charges') ?>',
                              method: "POST",
                              data: { id: id },
                              dataType: "html",
                              success: function (data) {
                  ...
                  $(document).ready(function (id) {
                     $(document).on('click', '#edit_charges_data', function () {
                        var id = $(this).attr('data-id-editcharges');
                        // alert(id);
                        $.ajax({
                           url: '<?= base_url('HoteladminController/getEditchargesData') ?>',
                           type: "post",
                           data: { id: id },
                           dataType: "json",
                           success: function (data) {
                              ...
                              console.log(data);
                              $('#vehicle_washing_charge_id').val(data.vehicle_washing_charge_id);
                  ...
                  $(document).on('click', '#edit_car_data', function () {
                     ...
                     $.ajax({
                        ...
                        success: function (data) {
                           console.log(data);
                           $('#vehicle_wash_request_id1').val(data.vehicle_wash_request.vehicle_wash_request_id);
                           $('#car_u_id').val(data.vehicle_wash_request.u_id);
                        }
                     });
                  })
                        ...
                        $.ajax({
                           ...
                           success: function (data) {
                              ...
                              $.get('<?= base_url('FrontofficeController/ajaxOrderIconView_v1'); ?>', function (data) {
                                 ...
                                 var resu3 = $(data).find('#completed_orders_div_new').html();
                                 $('#arrival1_div').html(resu);
                                 $('#arrival2_div').html(resu1);
                                 $('#arrival3_div').html(resu2);
                                 $('#completed_orders_div_new').html(resu3);
                                 setTimeout(function () {
                                    $('#example1').DataTable();
            ...
            <?php } elseif ($sub_icon_id == 7) { ?>
               ...
               <div class="col-md-12">
                  <div class="card card-topline-aqua">
                     ...
                     <div class="card-body ">
                        <div class="col-md-12 col-sm-12">
                           <div class="panel tab-border card-box">
                              <header class="panel-heading panel-heading-gray custom-tab">
                                 <ul class="nav nav-tabs">
                                    <li class="nav-item"><a href="#arrival1_div" data-bs-toggle="tab"
                                          class="active">Luggage Request</a>
                                    </li>
                                    <li class="nav-item"><a href="#arrival2_div" data-bs-toggle="tab">Accepted Luggage
                                          Request</a>
                                    </li>
                                    <li class="nav-item"><a href="#arrival3_div" data-bs-toggle="tab">Rejected Luggage
                                          Request</a>
                                    </li>
                                    <li class="nav-item"><a href="#completed_orders_div1_new" data-bs-toggle="tab">Luggage
                                          Return</a>
                                    </li>
                                 </ul>
                              </header>
                        ...
                        <div class="new_orders_div1">
                           ...
                           <div class="tab-content">
                                                ...
                                                if ($user_data) {
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td>
                                                         <div>
                                                            <a href="#"
                                                               class="btn btn-warning shadow btn-xs sharp me-1 update_luggage_modal_btn"
                                                               id="edit_luggage_data"
                                                               data-id3="<?= $lug_r['luggage_request_id'] ?>"><i
                                                                  class="fa fa-share"></i></a>
                                                         </div>
                                                      </td>
                                                   </tr>
                                                   ...
                                                   <div
                                                      class="modal fade bd-terms-modal-sm_<?php echo $lug_r['luggage_request_id'] ?>"
                                                      tabindex="-1" style="display: none;" aria-hidden="true">
                                                      <div class="modal-dialog modal-md">
                                                         <div class="modal-content">
                                                            <div class="modal-header">
                              ...
                              <div class="tab-pane" id="completed_orders_div1_new" style="background-color:white;">
                                 <div class="table-scrollable14 table-scrollable services_block">
                                             ...
                                             foreach ($luggage_request4 as $lug_c) {
                                                ...
                                                if ($user_data) {
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td><?php echo $user_data['full_name'] ?></td>
                                                      <td><?php echo $user_data['mobile_no'] ?></td>
                                                      <td><?php echo date('d-m-Y', strtotime($lug_c['select_date'])) ?></td>
                        ...
                        <button
                            class="btn btn-secondary_<?php echo $lug_r['luggage_request_id'] ?> shadow btn-xs sharp me-1"><i
                                class="fas fa-eye"></i></button>
                                                   ...
                                                   <div
                                                      class="modal fade bd-terms-modal-sm_<?php echo $lug_c['luggage_request_id'] ?>"
                                                      tabindex="-1" style="display: none;" aria-hidden="true">
                                                      <div class="modal-dialog modal-md">
                                                         <div class="modal-content">
                                                            <div class="modal-header">
                                             ...
                                             foreach ($luggage_request2 as $lug_r) {
                                                ...
                                                if ($user_data) {
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td>
                                                         <a href="#">
                                                            <div class="badge badge-danger" data-bs-toggle="modal"
                                                               data-bs-target="">
                                                               Rejected
                                                            </div>
                                                         </a>
                        ...
                        <button
                            class="btn btn-secondary_<?php echo $lug_r['luggage_request_id'] ?> shadow btn-xs sharp me-1"><i
                                class="fas fa-eye"></i></button>
                                                      ...
                                                      <td>
                                                         <a href="#">
                                                            <div class="badge badge-success" data-bs-toggle="modal"
                                                               data-bs-target="">
                                                               Accepted
                                                            </div>
                                                         </a>
                                                      ...
                                                      <td>
                                                         ...
                                                         if ($lug_r['is_completed'] == "0") {
                                                            ?>
                                                            <input type="hidden" name="user_id"
                                                               id="uid<?php echo $lug_r['luggage_request_id']; ?>"
                                                               value="<?php echo $lug_r['luggage_request_id']; ?>">

                                                            <select class="form-control" name="status"
                                                               id="luggagestatus<?php echo $lug_r['luggage_request_id']; ?>"
                                                               onchange="luggage_change_status(<?php echo $lug_r['luggage_request_id'] ?>);"
                                                               style="min-width:85px;text-align:center">
                              ...
                              <div class="modal fade" id="exampleModalCenter1" style="display: none;" aria-hidden="true">
                                 <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                       ...
                                       <form action="<?php echo base_url('FrontofficeController/add_luggage_charges') ?>"
                                          method="post">
                                          <div class="modal-body">
                                             <div class="row">
                                                <div class="mb-3 col-md-12 form-group">
                                                   ...
                                                   <input type="text" name="luggage_type" class="form-control"
                                                      placeholder="Luggage ajaxluggageIconView_v1Type" required="">
                                                </div>
                                                <div class="mb-3 col-md-12 form-group">
                                                   <label class="form-label">Charges</label>
                     ...
                     <!-- add btn modal  -->
                     <div class="modal fade bd-add-modal add_facility_modal_luggage" tabindex="-1" style="display: none;"
                        aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                           <div class="modal-content">
                              <form id="luggage_request" method="post" enctype="multipart/form-data">
                                 <div class="modal-header">
                                    <h5 class="modal-title" style="font-weight: bold;font-size: 15px !important;">Add
                                       Luggage Request</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal">
                                    </button>
                                 </div>
                     ...
                     <input type="text" class="form-control"  name="name" id="name" placeholder="Enter agent name">
                                       ...
                                       <div class="mb-3 col-md-6 form-group">
                                          <label class="form-label">Request Date</label>
                                          <input type="date" class="form-control minDate" name="request_date"
                                             placeholder="Date" required>
                                       </div>
                                       <div class="mb-3 col-md-6 form-group">
                                          <label class="form-label">Request Time</label>
                                          <input type="time" class="form-control minDate" name="request_time"
                     ...
                     <input type="text" class="form-control minDate" name="luggage_type" placeholder="Luggage" required>
                                       ...
                                       <div class="mb-3 col-md-6 form-group">
                                          ...
                                          <input type="number" class="form-control minDate" name="quantity"
                                    ...
                                    <div class="basic-form">
                                       <div class="row">
                                          <div class="mb-3 col-md-12">
                                             ...
                                             <input type="hidden" name="luggage_u_id" id="luggage_u_id">
                                             <label class="form-label">Change Order Status</label>
                                             <select id="send_user3" name="request_status"
                                                class="default-select form-control wide" required>
                                                <option value="">Choose...</option>
                                                <option value="1">Accept</option>
                                                <option value="2">Reject</option>
                     ...
                     <script>
                        ...
                        $('#frmupdateblock_luggage').submit(function (e) {
                           ...
                           $.ajax({
                              ...
                              success: function (res) {
                                 ...
                                 setTimeout(function () {
                                    $(".loader_block").hide();
                                    $("#frmupdateblock_luggage")[0].reset();
                                    $('.rejectreasonddd').css('display', 'none');
                        ...
                        $(document).on('click', '#edit_luggage_data', function () {
                           ...
                           $.ajax({
                              ...
                              dataType: "json",
                              success: function (data) {
                                 // console.log(data.luggage_request);
                                 $('#luggage_request_id1').val(data.luggage_request.luggage_request_id);
                                 $('#luggage_u_id').val(data.luggage_request.u_id);
                              }
                           });
                        })
                     </script>
                              ...
                              <div class="col-md-12 col-sm-12">
                                 <div class="panel tab-border card-box">
                                    <header class="panel-heading panel-heading-gray custom-tab">
                                       <ul class="nav nav-tabs">
                                          <li class="nav-item"><a href="#arrival1_div" data-bs-toggle="tab"
                                                class="active">Cab Service Request</a>
                                          </li>
                                          <li class="nav-item"><a href="#arrival2_div" data-bs-toggle="tab">Accepted Cab
                                                Request</a>
                                          </li>
                                          <li class="nav-item"><a href="#arrival3_div" data-bs-toggle="tab">Rejected Cab
                                                Request</a>
                                          </li>
                                          <li class="nav-item"><a href="#completed_orders_div2"
                                                data-bs-toggle="tab">Completed Cab Request</a>
                                          </li>
                                          <li class="nav-item"><a href="#cancle_orders_div2" data-bs-toggle="tab">Cancel
                                                Cab Request</a>
                                          </li>
                                       </ul>
                                    </header>
            ...
            <select class="form-control" id="orderserviceDropdown2">
               ...
               <option value="accepted_order2">Accepted Cab Request</option>
                                                ...
                                                if ($list) {
                                                   foreach ($list as $c_s) {
                                                      ...
                                                      <tr>
                                                         ...
                                                         <td>
                                                            <?php echo date('d-m-Y', strtotime($c_s['request_date'])) ?> /<sub>
                               ...
                               class="btn btn-secondary_<?php echo $c_s['cab_service_request_id'] ?> shadow btn-xs sharp me-1"><i
                                   class="fas fa-eye"></i></button>
                                                         ...
                                                         <td>
                                                            <a style="margin:auto" data-bs-toggle="modal" id="edit_data"
                                                               data-bs-target=".bd-terms-modal-sm"
                                                               data-id="<?php echo $c_s['cab_service_request_id'] ?>"
                                                               class="btn btn-secondary shadow btn-xs sharp"><i
                                                                  class="fa fa-eye"></i></a>
                                                         </td>
                                                         <td>
                                                            <a href="#"
                                                               class="btn btn-warning shadow btn-xs sharp me-1 change_cab"
                                                               id="edit_data" data-bs-toggle="modal"
                                                               data-id="<?php echo $c_s['cab_service_request_id'] ?>"><i
                                                                  class="fa fa-share"></i></a>
                                                         </td>
                                                         <!-- assign modal -->
                                                         <!--/.  assign modal  -->
                                                      </tr>
                                                      <div class="modal fade bd-terms-modal-sm" tabindex="-1"
                                                         style="display: none;" aria-hidden="true">
                                                         <div class="modal-dialog modal-md">
                                                            <div class="modal-content">
                                                               <div class="modal-header">
                                                ...
                                                if ($list2) {
                                                   foreach ($list2 as $cb_s) {
                                                      ...
                                                      <tr>
                                                         ...
                                                         <td>
                                                            <?php echo date('d-m-Y', strtotime($cb_s['request_date'])) ?> /<sub>
                                                               <?php echo date('h:i a', strtotime($cb_s['request_time'])) ?></sub>
                                                         </td>
                                                         <td><?php echo $full_name ?></td>
                                                         <td><?php echo $mobile_no ?></td>
                                                         ...
                                                         <td>
                                                            <div class="d-flex">
                                                               <a href="#"><span class="badge badge-danger"
                                                                     data-bs-toggle="modal" data-bs-target="">rejected</span>
                                                               </a>
                                                            </div>
                                                         </td>
                                                      </tr>
                                                      <div
                                                         class="modal fade bd-terms-modal-sm_<?php echo $cb_s['cab_service_request_id'] ?>"
                                                         tabindex="-1" style="display: none;" aria-hidden="true">
                                                         <div class="modal-dialog modal-md">
                                                            <div class="modal-content">
                                                               <div class="modal-header">
                                                ...
                                                if ($list3) {
                                                   foreach ($list3 as $cb_c) {
                                                      ...
                                                      <tr>
                                                         ...
                                                         <td>
                                                            <?php echo date('d-m-Y', strtotime($cb_c['request_date'])) ?> /<sub>
                                                               <?php echo date('h:i a', strtotime($cb_c['request_time'])) ?></sub>
                                                         </td>
                                                         <td><?php echo $full_name ?></td>
                                                         <td><?php echo $mobile_no ?></td>
                                                         ...
                                                         <td>
                                                            <div class="d-flex">
                                                               <a href="#"><span class="badge badge-success"
                                                                     data-bs-toggle="modal" data-bs-target="">Completed</span>
                                                               </a>
                                                            </div>
                                                         </td>
                                                      </tr>
                                                      <div
                                                         class="modal fade bd-terms-modal-sm_<?php echo $cb_c['cab_service_request_id'] ?>"
                                                         tabindex="-1" style="display: none;" aria-hidden="true">
                                                         <div class="modal-dialog modal-md">
                                                            <div class="modal-content">
                                                               <div class="modal-header">
                                  ...
                                  class="btn btn-secondary_<?php echo $cb_c['cab_service_request_id'] ?> shadow btn-xs sharp me-1"><i
                                      class="fas fa-eye"></i></button>
                                                         ...
                                                         <td>
                                                            <div class="d-flex">
                                                               <a href="#"><span class="badge badge-danger"
                                                                     data-bs-toggle="modal" data-bs-target="">Cancel</span>
                                                               </a>
                                                            </div>
                                                         </td>
                                                      </tr>
                           ...
                           <button
                               class="btn btn-secondary_<?php echo $cb_s['cab_service_request_id'] ?> shadow btn-xs sharp me-1"><i
                                   class="fas fa-eye"></i></button>
                                                         ...
                                                         <input type="hidden" name="user_id"
                                                            id="uid<?php echo $cb_s['cab_service_request_id']; ?>"
                                                            value="<?php echo $cb_s['cab_service_request_id']; ?>">
                                                         <td>
                                                            <select class="form-control" name="status"
                                                               id="cabstatus<?php echo $cb_s['cab_service_request_id']; ?>"
                                                               onchange="cab_change_status(<?php echo $cb_s['cab_service_request_id'] ?>);"
                                                               style="min-width:85px;text-align:center">
                                                               <?php
                        ...
                        <div class="modal-dialog modal-md">
                           <div class="modal-content">
                              ...
                              <form id="frmupdateblock" method="post" enctype="multipart/form-data">
                                 ...
                                 <input type="hidden" name="cab_u_id" id="cab_u_id">
                                 <div class="modal-body">
                                    <div class="row offset-md-1">
                                       <div class="col-md-6">
                                          <label><input type="radio" name="request_status" value="red" required> Accept
                                             <img src="assets/dist/images/download.png" alt="" height="26px;"></label>
                                       </div>
                                       <div class="col-md-6">
                                          <label><input type="radio" name="request_status" value="green" required> Reject
                                             <img src="assets/dist/images/cross.png" alt="" height="22px;"></label>
                                       </div>
                                    </div>
                                    <div class="red box accept">
                                          ...
                                          <div class="row">
                                             <div class="mb-3 col-md-12">
                                                ...
                                                <input type="text" maxlength="10"
                                                   ...
                                                   name="driver_contact_no" class="form-control">
                                             </div>
                                          </div>
                                          <div class="row">
                                             <div class="mb-3 col-md-12">
                     ...
                     <!-- add btn modal  -->
                     <div class="modal fade bd-add-modal add_facility_modal_cab" tabindex="-1" style="display: none;"
                        aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                           <div class="modal-content">
                              <form id="cab_request" method="post" enctype="multipart/form-data">
                                 <div class="modal-header">
                                    <h5 class="modal-title" style="font-weight: bold;font-size: 15px !important;">Add Cab
                                       Service Request</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal">
                                    </button>
                                 </div>
                                 <div class="modal-body">
                                    <div class="row">
                                       ...
                                       <div class="mb-3 col-md-6 form-group">
                                          ...
                                          <input type="number" class="form-control" name="total_passanger" id="name"
                                             placeholder="Passengers">
                                       </div>
                                       <div class="mb-3 col-md-6 form-group">
                                          <label class="form-label">Vehicle Type</label>
                                          <!-- <input type="text" class="form-control minDate" name="vehicle_type" placeholder="Vehicle Type" required> -->
                                          <select class="default-select form-control wide " name="vehicle_type" required>
                                       ...
                                       <div class="mb-3 col-md-6 form-group">
                                          ...
                                          <input type="text" class="form-control minDate" name="destination"
                     ...
                     <script>
                        ...
                        $('#frmupdateblock').submit(function (e) {
                           // alert('hi');die;
                           e.preventDefault();
                           $(".loader_block").show();
                           var form_data = new FormData(this);
                           $.ajax({
                              url: '<?= base_url('FrontofficeController/change_cab_service_request') ?>',
                              method: 'POST',
                              data: form_data,
                              processData: false,
                              contentType: false,
                              ...
                              success: function (res) {
                                 ...
                                 $.get('<?= base_url('FrontofficeController/ajaxOrderIconView_v3'); ?>', function (data) {
                                    ...
                                    var resu2 = $(data).find('#arrival2_div').html();
                                    var resu3 = $(data).find('#arrival3_div').html();
                                    var resu4 = $(data).find('#completed_orders_div2').html();
                                    var resu5 = $(data).find('#cancle_orders_div2').html();

                                    // $('#new_orders_div2').html(resu);
                                    $('#arrival1_div').html(resu1);
                                    $('#arrival2_div').html(resu2);
                                    $('#arrival3_div').html(resu3);
                                    $('#completed_orders_div2').html(resu4);
                                    $('#cancle_orders_div2').html(resu5);
                  ...
                  <script>
                     ...
                     function change_status(id) {
                        ...
                        if (status != '') {
                           $.ajax({
                              url: base_url + 'FrontofficeController/change_available_status',
                              method: "post",
