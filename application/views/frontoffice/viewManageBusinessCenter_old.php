      ...
      <div class="col-md-12">
         <div class="card card-topline-aqua">
            ...
            <div class="card-body ">
               ...
               <div class="table-scrollable" id="arrival1_div">
                                          ...
                                          <form id="frmupdateblock"  method="post" enctype="multipart/form-data">
                                             ...
                                             <div class="row">
                                                ...
                                                <div class="mb-3 col-md-12 form-group">
                                                   ...
                                                   <input name="image[<?php echo $j?>]" type="file" id="ima" accept=".jpg,.jpeg,.png,/application" class="dropify" data-default-file="<?php echo $bus_im['image']?>"/>
                                                   <?php
                                                      $j++;
                                                      }
                                                      }
