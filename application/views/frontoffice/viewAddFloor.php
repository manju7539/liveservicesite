...
<style>
    .add_floor_block .container-fluid{
        padding:0px
    }
</style> 
<!-- start page content -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-topline-aqua">
                    ...
                    <div id="floors">      
                        <div class="table-scrollable add_floor_block">
    ...
    // });
     ...
     $(document).on('submit', '#frmblock', function(e){
        ...
        $.ajax({
            ...
            success     : function(res) {
                console.log(res);
                $.get( '<?=base_url('FrontofficeController/ajax_floors');?>', function( data ) {
                       var resu = $(data).find('#floors').html();
                       $('#floors').html(resu);
                       setTimeout(function(){
                           $('#example1').DataTable();  
                       }, 2000);
