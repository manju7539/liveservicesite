...
<div class="page-content-wrapper">
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">Facility Updated</div>
                </div>
  ...
  <span class="tooltiptext">Tooltip text</span>
                                ...
                                <div id="aniimated-thumbnials" class="list-unstyled row clearfix gallery_subsection"
                                    style="background: #e8e8e8bd;padding: 14px;margin-top: 10px;">
                                    <div class=" services_subsection inactive" id="sub_icon_16" sub-id="1" data-id="10">
                                        <a href="#gym" data-sub-html="Demo Description">
                                            <img src="<?php echo base_url('assets/dist/images/new/gym.png') ?>"
                                                title="Gym Service" alt="" class='icon_size'>
                                            <p class="icon_header">Gym </p>
                                        </a>
                                    </div>
                                    <div class="inactive services_subsection" id="sub_icon_16" sub-id="5" data-id="10">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                            <img src="<?php echo base_url('assets/dist/images/new/baby_care.png') ?>"
                                                title="Baby Care Service" alt="" class='icon_size'>
                                            <p class="icon_header">Baby Care</p>
                                        </a>
                                    </div>
                                    <!-- <div class="services_subsection inactive" id="sub_icon_16" sub-id="2" data-id="10">
                                            <a href="javascript:void(0)" data-sub-html="Demo Description">
                                                <img src="<?php echo base_url('assets/dist/images/new/spa.png') ?>" alt="" style="height:75px;">
                                            </a> 
                                        </div> -->
                                    <div class="services_subsection inactive" id="sub_icon_16" sub-id="3" data-id="10">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                            <img src="<?php echo base_url('assets/dist/images/new/swiming.png') ?>"
                                                alt="" title="Pool Service" class='icon_size'>
                                            <p class="icon_header">Pool</p>
                                        </a>
                                    </div>
                                    <div class="inactive services_subsection" id="sub_icon_16" sub-id="4" data-id="10">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                            <img src="<?php echo base_url('assets/dist/images/new/shuttle.png') ?>"
                                                alt="" title="Shuttle Service" class='icon_size'>
                                            <p class="icon_header">Shuttle</p>
                                        </a>
                                    </div>
                                    <!-- <div class="inactive services_subsection" id="sub_icon_16" sub-id="5" data-id="10">
                                            <a href="javascript:void(0)" data-sub-html="Demo Description">
                                                <img src="<?php echo base_url('assets/dist/images/new/baby_care.png') ?>" alt="" style="height:75px;">
                                                <p class="icon_header">Baby care</p>
                                            </a> 
                                        </div> -->
                                    <div class="inactive services_subsection" id="sub_icon_16" sub-id="6" data-id="10">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                            <img src="<?php echo base_url('assets/dist/images/new/car_wash.png') ?>"
                                                alt="" class='icon_size'>
                                    ...
                                    <div class="inactive services_subsection" id="sub_icon_16" sub-id="7" data-id="10">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                            <img src="<?php echo base_url('assets/dist/images/new/cloackroom.png') ?>"
                                                alt="" class='icon_size'>
                                            <p class="icon_header">Cloack room</p>
                                        </a>
                                    </div>
                                    <div class="inactive services_subsection" id="sub_icon_16" sub-id="8" data-id="10">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                            <img src="<?php echo base_url('assets/dist/images/new/cab.png') ?>" alt=""
                                                class='icon_size'>
