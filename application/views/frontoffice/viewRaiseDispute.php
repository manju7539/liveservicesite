    ...
    <div class="page-content">
        <div class="page-bar">
            <div class="page-title-breadcrumb">
                <div class=" pull-left">
                    <div class="page-title">Raise Dispute</div>
                </div>
            ...
            <div class="col-md-12">
                <div class="card card-topline-aqua">
                    ...
                    <!-- <button type="button" class="btn btn-secondary "><a href="<?php //echo base_url('upcomingArrival')?>" style="color:white;">Upcoming Arrival</a></button> 
                        ...
                        <div class="table-scrollable raise_dispute">
                            ...
                            <table id="example1" class="display full-width">
                                ...
                                <tr>
                                    ...
                                    <!-- <select class="form-control" id="categoryDropdown">
                                        ...
                                        <option value=""><a href="<?php echo base_url('frontArrival')?>" style="color:white;">Todays Arrival</a></option>
                                        <option value=""><a href="<?php echo base_url('')?>" style="color:white;">Departed Arrival</a></option>
                                        <option value=""><a href="<?php echo base_url('upcomingArrival')?>" style="color:white;">Upcoming Arrival</a></option>
