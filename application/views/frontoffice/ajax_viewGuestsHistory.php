                            ...
                            <div class="table-responsive">
                                ...
                                ?>
                                        ...
                                        <td><?php echo $i++?></td>
                                            ...
                                            <td><a href="#" class="btn btn-secondary shadow btn-xs sharp me-1 booking_id" data-bs-toggle="modal" data-bs-target=".bd-example_<?php echo $bk_h['booking_id'] ?>"><i class="fa fa-eye"></i>
                                                                        </a></td>
                             </span></a>
...
?>
    <div class="modal fade bd-example_<?php echo $bk_h['booking_id'] ?>" tabindex="-1" role="dialog" aria-hidden="true">
