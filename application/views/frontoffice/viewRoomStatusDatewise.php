        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-topline-aqua">
                    ...
                    <div class="card-body">
                        <div class="btn-group r-btn"></div>
                        <div class="table-scrollable room_status">
                            <table id="example1" class="display full-width">
                                ...
                                <tbody class="append_data">
                                    ...
                                    <tr>
                                        <td>
                                            <b><?php echo $fl['floor']?><sup><?php echo $extension?></sup></b>
                                        </td>
                                        <td>
                                            ...
                                            <?php
                                                ...
                                                if($room_no)
                                                {
                                                    ...
                                                    {
                                                        $wh = '(room_no = "'.$rn['room_no'].'" AND room_status = 2  AND hotel_id = "'.$admin_id.'" AND (DATE_FORMAT(created_at, "%Y-%m-%d") = "'.$date.'" OR DATE_FORMAT(updated_at, "%Y-%m-%d") = "'.$date.'"))';
                                        ...
                                        <div  class="px-1" style="display:flex;flex-wrap: wrap;justify-content: center;">
                                            <?php
                                                ...
                                                if($room_no)
                                                {
                                                    ...
                                                    foreach ($room_no as $rn) 
                                                    {
                                                        $wh1 = '(room_no = "'.$rn['room_no'].'" AND room_status = 3 AND hotel_id = "'.$admin_id.'" AND (DATE_FORMAT(created_at, "%Y-%m-%d") = "'.$date.'" OR DATE_FORMAT(updated_at, "%Y-%m-%d") = "'.$date.'"))';

                                                        $room_status1 = $this->FrontofficeModel->getData('room_status',$wh1);
                                                        // print_r($room_status1);die;
                                                        if($room_status1)
                                                        {
                                            ?>
                                        ...
                                        <div  class="px-1" style="display:flex;flex-wrap: wrap;justify-content: center;">
                                            <?php
                                                ...
                                                if($room_no)
                                                {
                                                    ...
                                                    foreach ($room_no as $rn) 
                                                    {
                                                        $wh2 = '(room_no = "'.$rn['room_no'].'" AND room_status = 1 AND hotel_id = "'.$admin_id.'" AND (DATE_FORMAT(created_at, "%Y-%m-%d") = "'.$date.'" OR DATE_FORMAT(updated_at, "%Y-%m-%d") = "'.$date.'"))';
                                        ...
                                        <div  class="px-1" style="display:flex;flex-wrap: wrap;justify-content: center;">
                                            <?php
                                                ...
                                                if($room_no)
                                                {
                                                    ...
                                                    foreach ($room_no as $rn) 
                                                    {
                                                        $wh3 = '(room_no = "'.$rn['room_no'].'" AND room_status = 4 AND hotel_id = "'.$admin_id.'" AND (DATE_FORMAT(created_at, "%Y-%m-%d") = "'.$date.'" OR DATE_FORMAT(updated_at, "%Y-%m-%d") = "'.$date.'"))';
