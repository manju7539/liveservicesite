...
$get_notification_data = $this->MainModel->get_notifications_for_food_1($admin_id);
    ...
    foreach($get_notification_data as $g)
    {
        ...
        if($notifictions_department_id)
        {
                                                   ...
                                                   <td><?php echo $nt['title']?></td>
                                                        ...
                                                        <td>
                                                                <div class="">
                                                                    <a href="<?php echo base_url('MainController/resend_notification_to_user/'.$nt['notification_id'])?>"
                                                                        class="btn btn-warning shadow btn-xs sharp me-1"
