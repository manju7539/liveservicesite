...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <!-- chiragi Start :: super admin notificatio -->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <h5><?php echo date('d F Y',strtotime($sa_n['created_at']))." - ".date('h:i a',strtotime($sa_n['created_at'])) ?></h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <?php } ?>
        <!-- Chiragi End :: super admin notificatio -->
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <h5><?php echo date('d F Y',strtotime($all_n['created_at']))." - ".date('h:i a',strtotime($all_n['created_at'])) ?></h5>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
