<style>
   .manage_business .container-fluid{
   padding:0px
   }
</style>
         ...
         <div class="col-md-12">
            <div class="card card-topline-aqua">
               ...
               <div class="card-body ">
                  ...
                  <div class="table-scrollable manage_business" id="arrival1_div">
            ...
            <div class="modal-body">
               <div class="row">
                  ...
                  <div class=" mb-3 col-md-12">
                     ...
                     <textarea class="summernote" id="description1" rows="3" name="description" id="comment"
                        required=""></textarea>
               ...
               <form id="frmupdateblock"  method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                     ...
                     <div class="mb-3 col-md-12 form-group">
                        ...
                        <input type="hidden" name="business_center_image_id[]" id="business_center_image_id">
                        <input name="image[<?php echo $j?>]" type="file" id="ima" accept=".jpg,.jpeg,.png,/application" class="dropify" />
                        <?php
                           $j++;
                           ?>
                     </div>
...
<script>
    ...
    event.preventDefault(); // Prevent the default behavior of the form submit button
        ...
        swal({
            ...
            if (isConfirm) {
                $.ajax({
                    url: '<?= base_url('FrontofficeController/delete_business_center') ?>',
                    method: "POST",
                    data: { id: id },
                    dataType: "html",
               ...
               //  alert(id);
                $.ajax({
                                          ...
                                          success: function (data) {
                                             ...
                                             $('#business_center_image_id').val(data.business_center_image_id);
                                             $(".img").html("<img src='" + data.image + "' height='50px' width='50px' />");
                                          }
