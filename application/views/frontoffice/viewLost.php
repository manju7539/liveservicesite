<style>
   .viewlost_table .container-fluid{
      padding:0px
   }
</style>
               ...
               <div class="card-body ">
                  ...
                  <div class="tab-content">
                     <div class="tab-pane active" id="lost_pending_div">
                        <div class="table-scrollable viewlost_table">
                        ...
                        <table id="lost_manage_completed" class="display full-width">
                           ...
                           <tbody class="append_data1">
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <h5><?php echo date('d-m-Y',strtotime($com['lost_found_date']));?></h5>
                                 </td>
                                 <td>
                                 ...
                                 <td>
                                    <div class="lightgallery">
                                       <a href="<?php echo $com['img'] ?>" target="_blank"
