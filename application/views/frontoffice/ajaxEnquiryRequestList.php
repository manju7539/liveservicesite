...
?>
        ...
        <tr class="sub-container">
            ...
            <td>
                <select name="room_type" onchange="change_status(<?php echo $e_req['hotel_enquiry_request_id']?>)" id="status_<?php echo $e_req['hotel_enquiry_request_id']?>"> 
                    <?php
                        ...
                        $room_type_exist= $this->FrontofficeModel->getAllData('room_type',$wh_room_type);
                        ...
                        if($room_type_exist)
                        {
                            ...
                            $room_type_exist11= $this->FrontofficeModel->getAllData('room_type',$wh_room_type);
          ...
          <?php 
                ...
                $room_type_exist = $this->FrontofficeModel->getData('room_type',$wh_room_type);
