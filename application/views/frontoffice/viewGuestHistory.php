                           ...
                           <table id="example1" class="display full-width">
                              ...
                              <tbody id="searchTable">
                                 ...
                                 <tr>
                                    ...
                                    <td><a href="#" class="badge badge-info service_data"  data-unic-id="<?= $bk_h['booking_id'] ?>" user_id="<?= $bk_h['u_id'] ?>">view</a>
                                    </td>
    ...
    $(document).ready(function() {
      ...
      $(document).on('click','.service_data', function (e) {
         ...
         $.ajax({
            ...
            url: '<?= base_url('FrontofficeController/get_all_order_data') ?>',
            type: "post",
