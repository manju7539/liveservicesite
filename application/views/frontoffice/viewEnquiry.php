                            ...
                            <div class="table-scrollable enquary_field">
                                <table id="rejectedOrder_tb" class="display full-width">
                                   ...
                                   <th>Room Names</th>                                               
                                    ...
                                    <td><h5 style="white-space: nowrap;"><?php echo date('d-m-Y',strtotime($e_req['check_in_date'])) ?></h5></td>
                                    <td><h5 style="white-space: nowrap;"><?php echo date('d-m-Y',strtotime($e_req['check_out_date'])) ?></h5></td>
