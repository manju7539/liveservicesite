...
<div class="page-content-wrapper">
    <div class="page-content">
        ...
        <div class="row">
                                        ...
                                        <header class="panel-heading panel-heading-gray custom-tab">
                                            <ul class="nav nav-tabs">
                                                <li class="nav-item"><a href="#arrival1_div" data-bs-toggle="tab"
                                                        class="active">New Enquiry Request</a>
                                                </li>
                                                <li class="nav-item"><a href="#arrival2_div"
                                                        data-bs-toggle="tab">Accepted By User</a>
                                                </li>
                                                <li class="nav-item"><a href="#arrival3_div"
                                                        data-bs-toggle="tab">Rejected By User</a>
                                                </li>
                                            </ul>
                                        </header>
                                    </div>
                                ...
                                <div class="tab-content">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <h5 style="white-space: nowrap;">
                                                                            <?php echo date('d-m-Y', strtotime($e_req['check_in_date'])) ?>
                                                                        </h5>
                                                                    </td>
                                                                    <td>
                                                                        <h5 style="white-space: nowrap;">
                                                                            <?php echo date('d-m-Y', strtotime($e_req['check_out_date'])) ?>
                                                                        </h5>
                                                                    </td>
                                    ...
                                    <td><?php echo $e_req['total_childs'] ?></td> -->
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <div class="modal fade bd-terms-modal-sm_<?php echo $e_req['hotel_enquiry_request_id'] ?>"
                                    ...
                                    <div class="tab-pane" style="background-color:white;" id="arrival2_div">
                                        ...
                                        <td><?php echo $e_req['total_childs'] ?></td> -->
                                                                        <td>
                                                                            <h5><?php echo $e_req['hotel_enquiry_request_id'] ?>
                                                                            </h5>
                                                                        </td>
                                                                        <td>
                                                                            <a style="margin:auto" data-bs-toggle="modal"
                                            ...
                                            <td><?php echo $e_req['total_childs'] ?></td> -->
                                                                    ...
                                                                    <td>
                                                                        <select name="room_type"
                                                                            class="nice-select default-select form-control wide dropdown"
                                                                            onchange="change_status(<?php echo $e_req['hotel_enquiry_request_id'] ?>)"
                                                                            data-id=""
                                                                            id="status_<?php echo $e_req['hotel_enquiry_request_id'] ?>">
                                                            ...
                                                            data-bs-target=".update_modal"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp; -->
                                                                            ...
                                                                            <a
                                                                                href="<?php echo base_url('FrontofficeController/reject_enquiry_request/' . $e_req['hotel_enquiry_request_id']) ?>"><span
                                                                        ...
                                                                        <!-- accept modal  -->
                                                                        <div class="modal fade close_enquiry_request_modal bd-example-modal-sm"
                                                                            tabindex="-1" style="display: none;" aria-hidden="true">
                                                                                ...
                                                                                <div class="modal-content">
                                                                                    ...
                                                                                    if ($room_type_exist) {
                                                                                        ...
                                                                                        <form id="enquiry_accept" method="post">
                                                                                            <input type="hidden"
                                                                                                name="hotel_enquiry_request_id"
                                                                                                id="hotel_enquiry_request_id">
                                                                                            <input type="hidden" name="enquiry_u_id"
                                                                                                id="enquiry_u_id">
                                                                                            <div class="modal-body">
                                                                                                <div class="mb-3 col-md-12 form-group">
                                                                                                    ...
                                                                                                    <input type="number"
                                                                                                        name="room_charges"
                                                                                                        value="<?php echo $room_type_exist['price'] ?>"
                                                                                                        onKeyUp="change_amount()"
                                                                                                        id="price" class="form-control"
                                                                                                        required="">
                                                                                                    <input type="hidden"
                                                                                                        value="<?php echo $room_type_exist['lux_tax'] ?>"
                                                                                                        id="lux_tax"
                                                                                                        class="form-control"
                                                                                                        required="">
                                                                                                    <input type="hidden"
                                                                                                        value="<?php echo $room_type_exist['serv_tax'] ?>"
                                                                                                        id="serv_tax"
                                                                                                        class="form-control"
                                                                                                        required="">
                                                                                                </div>
                                                                                                <div class="mb-3 col-md-12 form-group">
                                                                                                    ...
                                                                                                    <input type="number"
                                                                                                        name="service_tax"
                                                                                                        value="<?php echo $room_type_exist['serv_tax_amt'] ?>"
                                                                                                        id="serv_tax_amt"
                                                                                                        class="form-control">
                                                                                                </div>
                                                                                                <div class="mb-3 col-md-12 form-group">
                                                                                                    <label class="form-label">Luxury Tax
                                                                                                        Amount</label>
                                                                                                    <input type="number"
                                                                                                        name="luxury_tax"
                                                                                                        value="<?php echo $room_type_exist['lux_tax_amt'] ?>"
                                                                                                        id="lux_tax_amt"
                                                                                                        class="form-control">
                                                                                                </div>
                                                                                            </div>
                                                                                        ...
                                                                                        ?>
                                                                                        <h5 style="color:red;padding:5px">Please Select
                                                                                            Room Type First...</h5>
                                                                                        <?php
                                                                                    }
                                                                                    ?>
            ...
            <!-- add btn modal  -->
            <div class="modal fade bd-add-modal add_facility_modal" tabindex="-1" style="display: none;"
                aria-hidden="true">
...
<script>
    ...
    $(document).ready(function (id) {
        $(document).on('click', '#edit_data', function () {
            ...
            //    alert(id);
            $.ajax({
                url: '<?= base_url('FrontofficeController/enquiryId') ?>',
                type: "post",
                data: { id: id },
                dataType: "json",
    ...
    $(document).on('submit', '#enquiry_accept', function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                console.log(data);
                if (data == 0) {
                    alert('Your Wallet Amount Is Less');
                    location.reload();
                }
                else {
                    location.reload();
...
<script>
    $(document).ready(function () {
        ...
        let intervalId = setInterval(myFunction, 20000);
        function myFunction() {
            var base_url = '<?php echo base_url(); ?>';
            $.ajax({
                url: base_url + "FrontofficeController/encquery_auot_load_data",
                method: "GET",
                success: function (data) {
                    $('#encquery_auto_load').html('');
                    $('#encquery_auto_load').append(data);
                }
            });
        }
    });
    ...
    $(document).ready(function () {
        ...
        function load_data(query) {
            $.ajax({
                url: "<?php echo base_url(); ?>FrontofficeController/enquiry",
                method: "POST",
                data: { query: query },
                success: function (data) {
                    $(".append_data").html(res);
