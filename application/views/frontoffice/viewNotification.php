<style>
    .view_notification .container-fluid{
        padding:0px
    }
</style>
    ...
    <div class="page-content">
                ...
                <div class="card card-topline-aqua">
                    ...
                    <div class="btn-group r-btn">
                        ...
                        <div class="table-scrollable">
                            ...
                            <table id="example1" class="display full-width view_notification">
                                <thead>
                                <tr>
                                    <th>Sr.no.</th>
                                    <th>Send To</th>
        ...
        <div class="modal fade bd-add-modal add_facility_modal" tabindex="-1" style="display: none;" aria-hidden="true">
            ...
            <div class="row">
                                                    ...
                                                    <div id="all_customer" class=" mb-3 col-md-6 form-group " style="display: none;"
                                                    >
                                                        ...
                                                        <select name="skills" multiple="" name="users[]" class="label ui selection fluid dropdown">
                                                                    <?php 
                                                                        if($user_list)
                                                                        {
                                                    ...
                                                    <div id="all_guest" class=" mb-3 col-md-6 form-group " style="display: none;"
                                                       >
...
<script>
     $(document).on('click', '#delete_data', function (event) {
         ...
         swal({
               ...
               if (isConfirm) {
                  $.ajax({
                     url: '<?= base_url('FrontofficeController/delete_notification') ?>',
                     method: "POST",
                     data: { id: id },
                     dataType: "html",
                     success: function (data) {
                           swal("Deleted!", "Notification has been deleted!", "success");
                           $.get( '<?= base_url('notification');?>', function( data ) {
