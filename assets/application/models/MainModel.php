                     ...
                     // room service complete order count------supriya
                       ...
                       // }
                             ...
                             public function get_total_converted_revenue_leads($request_status1)
                                            ...
                                            public function get_total_active_guest() {
                                                $query = $this->db->query("SELECT COUNT(*) AS total_active_guests FROM register WHERE is_active = 1");
                                        
                                                if ($query->num_rows() > 0) {
                                                    return $query->row()->total_active_guests; // ✅ Return total active guests
                                                } else {
