...
class RoomserviceModel extends CI_Model {
    ...
    public function get_oncall_list($hotel_id,$order_type, $todays_date)
    {
        ...
        function service_completed_list_pagination()
        {
            $data = array();
            $this->db->select('*');
        ...
        function get_service_accepted_orders($hotel_id)
        {
            $data = array();
            $this->db->select('*');
            $this->db->order_by('rmservice_services_order_id','DESC');
        ...
        function get_Service_rejected_pagination()
        {
            $data = array();
            $this->db->select('*');
            $this->db->order_by('rmservice_services_order_id ','DESC');
        ...
        public function staff_pending_hendover_Data($rowperpage, $row, $search,$columnName,$hotel_id)
        {
            ...
            $this->db->select('hns.staff_handover_id,hns.created_at,reg.full_name');
