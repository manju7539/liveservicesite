...
class RoomserviceController extends CI_Controller
{
    ...
    public function newroomServiceOrder()
    {
        ...
        $neworderfrom_room_Data = $this->RoomserviceModel->get_neworderfrom_room_Data($rowperpage, $row, $search,$columnName,$hotel_id);

        $total_neworderfrom_room_ = $this->RoomserviceModel->getTotal_neworderfrom_room($search, $hotel_id);
        ...
        foreach($neworderfrom_room_Data AS $val)
        {
            ...
            $data[] = array(
                "sr_no"         => $i++,
                "order_id"      => $val['room_service_menu_order_id'],
    ...
    public function roomServiceReview()
    {
        ...
        $admin_details = $this->MainModel->getData($tbl = 'register', $where);
        $admin_id = $admin_details['hotel_id'];
        $data['review_list'] = $this->RoomserviceModel->get_user_review_pagination($admin_id);

        $this->load->view('include/header');
        $this->load->view('roomservice/viewRoomServiceReview', $data);
        $this->load->view('include/footer');
    }
    ...
    {
        $room_serv_cat_id = $this->input->post('selected_menu_service');
        // echo "<pre>";
    ...
    public function ServiceAcceptedOrder_getdata()
    {
        ...
        $insert_order_data = $this->RoomserviceModel->insert_data($tbl='rmservice_services_orders', $arr);
