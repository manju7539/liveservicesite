...
<form id="hand_over_status_chang" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="mb-3 col-md-12">
            ...
            <textarea class="summernote" name="description" style="min-height: 400px;"><?php echo $list[0]['description']?></textarea>
        </div>
    </div>
