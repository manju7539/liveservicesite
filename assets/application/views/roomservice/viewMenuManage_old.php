                        ...
                        <div class="table-scrollable">
                            ...
                            <table id="example1" class="display full-width">
                                ...
                                <?php
                                                    ...
                                                    <!-- modal  -->
                                                    <div class="modal fade bd-example-modal-lg update_staff_modal" id="edit_<?php echo $row['room_serv_menu_id']?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                                                    ...
                                                                                    <div class="input-group">
                                                                                        ...
                                                                                        <input type="number" name ="prepartion_time" id="prepartion_time" value="<?php echo $row['prepartion_time'];?>"   class="form-control"  placeholder="" required>
                                                                                            <select class="form-control"  name="time_in" id="time_in" require="">
                                                                                                ...
                                                                                                <option value="1"<?php echo set_select('time_in','1', ( !empty($row['time_in']) && $row['time_in'] == "1" ? TRUE : FALSE )); ?>> Minute</option>
                                                                                                <option value="2" <?php echo set_select('time_in','2', ( !empty($row['time_in']) && $row['time_in'] == "2" ? TRUE : FALSE )); ?>>Hour</option>
                                                                                            </select>
                                                                                    </div>
                                                                                </div>
