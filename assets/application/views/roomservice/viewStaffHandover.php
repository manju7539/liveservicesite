                ...
                <div class="card card-topline-aqua">
                    ...
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-md-3 d-flex justify-content-end ">
                            <select class="form-control" id="staff_handoverDropdown">
                                <!-- <option value="">Select Option</option> -->
                                <option value="pending_Handover">Pending Handover</option>
                                <option value="completed_Handover">Completed Handover</option>
                            </select>                                       
                        </div>
                    </div>
                   
                    <div class="pending_Handover_div">
                    ...
                    <div class="completed_Handover_div" style="display: none;">
                        <div class="table-scrollable">
...
$(document).ready(function() {
    ...
    $('#pending_Handover_table').DataTable({
        "order": [],
        'processing': true,
        'serverSide': true,
        "bDestroy": true,
