        ...
        <tr>
            ...
            <td>
                <div class="lightgallery">
                    <!-- <a href="" data-exthumbimage="<?php echo $row['icon_img'];?>" data-src="<?php echo $row['icon_img'];?>" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6"> -->
                        <img class="me-3" src="<?php echo $row['icon_img'];?>" alt="" style="width:30px; height:40px;">
                    <!-- </a> -->
                </div>
            </td>
