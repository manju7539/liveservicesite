                                                ...
                                                <div class="col-sm-7">
                                                    <div class="row">
                                                        <div class="col-sm-4"> <strong>Check In:</strong>
                                                            <p><?php echo $booking_details['check_in']?></p>
                                                        </div>
                                                        <div class="col-sm-4"> <strong>Check Out:</strong>
                                                            <p><?php echo $booking_details['check_out']?></p>
                                                        </div>
            ...
            <div class="modal fade bd-payment-modal-sm" tabindex="-1" style="display: none;" aria-hidden="true">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <form action="<?php echo base_url('FrontofficeController/checkout_bill')?>" method="post">
                            ...
                            <div class="modal-body">
                                <div class="col-lg-12">
                                    <div class="basic-form">
                                        <div class="row">
                                          <div>
                                            <h6>Do you want add the Todays(<?php echo date('Y-m-d')?>) Room Charge.
                                            </h6>
                                          </div>
                                          <div>
            ...
            <div class="modal fade bd-extra-modal-sm" tabindex="-1" style="display: none;" aria-hidden="true">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <form action="<?php echo base_url('FrontofficeController/additional_amount_in_checkout')?>" method="post">
                            <input type="hidden" name="booking_id" value="<?php echo $this->uri->segment(3)?>"> 
                            <input type="hidden" name="u_id" value="<?php echo $this->uri->segment(4)?>"> 
                            <input type="hidden" name="user_checkout_data_id" value="<?php echo $booking_checkout_data['user_checkout_data_id']?>"> 
                            <div class="modal-body">
             ...
             <div class="modal fade bd-extra-modal-smd" tabindex="-1" style="display: none;" aria-hidden="true">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <form action="<?php echo base_url('FrontofficeController/add_advance_payment')?>" method="post">
                            <input type="hidden" name="booking_id" value="<?php echo $this->uri->segment(3)?>"> 
                            <input type="hidden" name="u_id" value="<?php echo $this->uri->segment(4)?>"> 
                            <input type="hidden" name="user_checkout_data_id" value="<?php echo $booking_checkout_data['user_checkout_data_id']?>"> 
                            <div class="modal-body">
                                            ...
                                            <table class="table simple mb-0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td> Add Amount:</td>
                                                        <td class="fw-700">
                                                            <input type="number" id="amount" onKeyUp="check_amount()" placeholder="enter amount" name="amount" class="form-control" required>
                                                        </td>
                                                    </tr>
                                                    <tr>
            ...
            <div class="modal fade bd-extra-modal-mb" tabindex="-1" style="display: none;" aria-hidden="true">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <form action="<?php echo base_url('FrontofficeController/add_minbar_in_checkout')?>" method="post">
   ...
   <script type="text/javascript">
    ...
    <script>
        function add_amt()
        {
            ...
            $.ajax({
                    url : base_url + "FrontofficeController/add_minibar_amt",
                    method : "post",
