                  ...
                  <table id="example1" class="display full-width">
                     ...
                     <tbody class="append_data">
                        ...
                        <tr>
                           ...
                           <td>
                              <div class="">
                                 <a href="#"  class="btn btn-secondary shadow btn-xs sharp me-1" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg_view<?php echo $businness_data['business_center_id']?>"><i class="fa fa-eye"></i></a>
                                 <!-- <a href="<?php echo base_url('business_center_view/'.$businness_data['business_center_id'])?>"
                                    class="btn btn-secondary shadow btn-xs sharp me-1"><i
                                        class="fa fa-eye"></i></a> -->
                                 <a href="#"  class="btn btn-warning shadow btn-xs sharp me-1" data-bs-toggle="modal" data-bs-target=".add_staff_modal_<?php echo $businness_data['business_center_id']?>"><i class="fa fa-pencil"></i></a> 
                                 <!-- <a id="delete"
                        ...
                        <!-- view model -->
                        <div class="modal fade bd-example-modal-lg_view<?php echo $businness_data['business_center_id']?>" tabindex="-1" role="dialog" aria-hidden="true">
                                                   ...
                                                   <div class="row m-0">
                                                         ...
                                                         <div class="card-body">
                                                            ...
                                                            <div class="d-flex flex-wrap">
                                                               <div class="mt-4 check-status">
                                                                  ...
                                                                  <h4 class="font-w500 fs-24"><?php echo $businness_data['business_center_type']?></h4>
                                                               </div>
                                                               <div class="mt-4 ms-3">
                                                                  <span class="d-block mb-2 text-black">Price</span>
                                                                  <span class="font-w500 fs-24 text-black"><?php echo $businness_data['price']?><small
                                                                     class="fs-14 ms-2 text-secondary"></small></span>
                                                               </div>
                                                            ...
                                                            <p class="mt-2">
                                                               <?php
                                                                  ...
                                                                  ?>
                                                               <?php echo $businness_data['description'] ?>
                                                               <?php  
                                                                  }
                                                      ...
                                                      <div class="col-xl-6 p-0 d-flex align-items-center">
                                                         <div id="owl-demo2" class="owl-carousel">
                                                            <?php
                                                               foreach($center_pics as $h_pic)
                                                               {
                                                                   if($h_pic['image'])
                                                                   {
                                                                       $hotel_image =$h_pic['image'];
                                                                   }
                                                                   else
                                                                   {
                                                                       $hotel_image = base_url().'documents/logo2.png';
                                                                   }
                                                               ?>
                                                            <div class="items">
                           ...
                           <div class="modal fade update_staff_modal add_staff_modal_<?php echo $businness_data['business_center_id']?>" tabindex="-1" role="dialog" aria-hidden="true">
                              <div class="modal-dialog modal-lg">
                                 <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                       <div class="basic-form">
                                          <form id="frmupdateblock"  method="post" enctype="multipart/form-data">
                                             <input type="hidden" name="business_center_id" value="<?php echo $businness_data['business_center_id']?>">
                                             <div class="row">
                                                <div class="mb-3 col-md-6">
                                                   <label class="form-label">Business Center Type</label>
                                                   <input type="text" class="form-control" name="business_center_type" value="<?php echo $businness_data['business_center_type']?>">
                                                </div>
                                                <div class="mb-3 col-md-6">
                                                   <label class="form-label">Business Center capacity</label>
                                                   <input type="text" class="form-control" name="no_of_people" value="<?php echo $businness_data['no_of_people']?>">
                                                </div>
                                                <div class="mb-3 col-md-6">
                                                   <label class="form-label">Price</label>
                                                   <div class="input-group">
                                                      <input type="text" class="form-control" name="price" value="<?php echo $businness_data['price']?>">
                                                ...
                                                <div class=" mb-3 col-md-12">
                                                   ...
                                                   <textarea class="summernote" name="description" rows="3" id="comment" required=""><?php echo $businness_data['description']?></textarea>
                                                </div>
                                             </div>
