    ...
    <div class="page-content">
        <div class="page-bar">
           ...
           <div class="alert alert-success successmessage" role="alert" id="a" style="margin-top:10px; margin-top: 10px;background-color: #4e8759;padding: 4px;border-radius:3px ;display: none;">
               <strong style="color:#fff ;margin-top:10px;">Lost Item Created Successfully..!</strong>
              
                <span style="  float: right;font-size: 29px;line-height: 0.8;top: 9;color: #fff;" aria-hidden="true">&times;</span>
              
            </div>
              <div class="alert alert-success updatemessage" role="alert" id="a" style="margin-top:10px; margin-top: 10px;background-color: #4e8759;padding: 4px;border-radius:3px ;display: none;">
               <strong style="color:#fff ;margin-top:10px;">Lost Item Updated Successfully..!</strong>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-topline-aqua">
                    ...
                    <button type="button" class="btn btn-secondary "><a href="<?php echo base_url('lost')?>" style="color:white;">List Of Lost & Found</a></button>
...
<!--                                                       
           ...
           data-bs-target="#exampleModalCenter12_<?php echo $g_f_s['id']?>"><i
             ...
             <div class="modal fade" id="exampleModalCenter12_<?php echo  $g_f_s['id'] ?>" style="display: none;" aria-hidden="true">
...
<input type="hidden" name="id" value="<?php echo $g_f_s['id']?>">
<div class="row">
...
document.getElementById('delete_<?php echo $g_f_s['id']  ?>').onclick = function() {
var id='<?php echo $g_f_s['id'] ?>';
