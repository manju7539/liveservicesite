                    ...
                    <div class="row">
                            <div class="col-md-4">
                                ...
                                <select class="form-control" id="categoryDropdown">
                                    ...
                                    <option value=""><a href="<?php echo base_url('handover')?>" style="color:white;">Pending Handover</a></option>
                                    <option value=""><a href="<?php echo base_url('completedHandover')?>" style="color:white;">Completed Handover</a></option>
