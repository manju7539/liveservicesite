                                ...
                                <?php
                                                ...
                                                ?>
                                                  ...
                                                  <td><h5><?php echo $exp['expense_amt']?> Rs</h5></td>
                                                       ...
                                                       <script>
                              document.getElementById('delete_<?php echo $exp['expense_id']; ?>').onclick = function() {
                              
                              var id='<?php echo $exp['expense_id'] ?>';
                              console.log("idd=",id);
                                  ...
                                  if (isConfirm) {
                                      ...
                                      swal(
                                          ...
                                          "error"
                                                        ...
                                                        <div class="modal fade bd-discription-modal-lg_<?php echo $exp['expense_id']?>" tabindex="-1" style="display: none;" aria-hidden="true">
