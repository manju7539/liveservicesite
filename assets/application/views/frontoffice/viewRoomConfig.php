                                            ...
                                            <div class="demo">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="button" style="top:41px"><a href="#" data-bs-toggle="modal"
                                                            ...
                                                            <a href="#" class="btn btn-secondary shadow btn-xs sharp me-1 room_id" data-bs-toggle="modal" room-id=<?= $r_m['room_type_id']?> data-bs-target=".bd-view-modal"><i class="fa fa-eye"></i>
                                                                        </a>
                                                    <!-- <button type="button" class="btn btn-primary mb-2" >Large modal</button> -->
                                                    <!-- <div class="button "><a href="<?php echo base_url('view_config/'.$r_m['room_type_id'])?>">View </a>
                                                    </div> -->
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="<?php echo base_url('MainController/add_rooms')?>" method="post" enctype="multipart/form-data">
                                                        <div class="row">
