                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <?php echo $booking_details['check_in']?>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <?php echo $booking_details['check_out']?>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- <hr> -->
                        ...
                        <div class="row">
                            <div class="table-responsive">
                                            ...
                                            <table style="border-collapse:collapse;"
                                                class="table-bordered shadow-hover table-responsive-lg table sortable mb-0  table_list">
                                                <thead>                                        <tr>
                                ...
                                ?>
                                        <tr>
                                        <td><?php echo $i++?></td>
                                            <td><?php echo $bk_h['booking_date'] ?></td>
                                            <td><?php echo $bk_h['booking_id']?></td>
                                            <td><?php echo $bk_h['check_in'] ?></td>
                                            <td><?php echo $bk_h['check_out'] ?></td>
...
if($booking_history)
{
    foreach($booking_history as $bk_h)
    {  
        $room_service_menu_completed_order = $this->FrontofficeModel->get_user_room_service_menu_completed_order_list($admin_id,$bk_h['booking_id'],$u_id);
        
        $housekeeping_service_completed_order = $this->FrontofficeModel->get_user_housekeeping_completed_order_list($admin_id,$bk_h['booking_id'],$u_id);

        $laundry_completed_order = $this->FrontofficeModel->get_user_laundry_order_list($admin_id,$bk_h['booking_id'],$u_id);
        
        $food_completed_order = $this->FrontofficeModel->get_user_food_completed_order_list($admin_id,$bk_h['booking_id'],$u_id);
        
        $room_service_services_completed_order = $this->FrontofficeModel->get_user_room_service_services_order_list($admin_id,$bk_h['booking_id'],$u_id);
