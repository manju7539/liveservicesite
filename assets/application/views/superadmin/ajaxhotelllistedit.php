<form id="edithotellistform" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="number" class="form-control" name="latitude" value="<?php echo $l[0]['latitude'];?>"  placeholder="Latitude">
                            <input type="number" class="form-control" name="longitude" value="<?php echo $l[0]['longitude'];?>" placeholder="Longitude">
                            </div>
                        </div>
                        <div class="mb-3 col-md-6">
