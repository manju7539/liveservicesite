...
<div class="row">
            ...
            <div class="row d-flex">
                <div class="col-md-5 ">
                <input type="date" id="from_date"  value="<?php echo $info[0]['start_date'];?>" name="start_date" class="form-control" readonly style="background-color:white;opacity:unset">
            ...
            <div class="col-md-5">
                <input type="date" id="to_date" value="<?php echo $info[0]['end_date'];?>"   name="end_date" class="form-control">
