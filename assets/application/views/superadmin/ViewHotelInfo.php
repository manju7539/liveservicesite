                                                    ...
                                                    <div class="d-flex"> 
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="mt-2 check-status">
                                                                ...
                                                                <span class="font-w500 fs-16"><?php echo $data['created_at']?></span>
                                                            </div>
                                                            ...
                                                            <div
                                                              ...
                                                              <?php
                                                                                foreach($hotels_pics as $h_pic)
                                                                                {
                                                                                    if($h_pic['images'])
                                                                                   {
                                                                                        $hotel_image =$h_pic['images'];
                                                                                    }
                                                                                    else
                                                                                    {
                                                                                        $hotel_image = base_url().'documents/logo16.png';
                                                                                    }
                                                                        ?>
                                                                <div class="item">
                                                                    <div class="rooms">
                                                                     <img src="<?php echo $hotel_image ?>" alt="">                                                                        <div class="booked">
