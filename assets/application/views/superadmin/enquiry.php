                                      ...
                                      <div class="col-md-5">
                                       <form method="POST">
                                            <div class="input-group">
                                                ...
                                                ?>
                                                <option value="<?php echo $e_req['hotel_id'] ?>"><?php echo $hotel_name ?></option>
                                                <?php
                                                        }
                                                ?>
                                                      </select>
...
<td><h5><?php echo $e_req['room_charges'] ?></h5></td>
<td><h5><?php echo $lead_cost1 ?></h5></td>
<td><h5><?php echo $e_req['check_in_date'] ?></h5></td>
<td><h5><?php echo $e_req['check_out_date'] ?></h5></td>
