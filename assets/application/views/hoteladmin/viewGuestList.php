                ...
                <div class="card card-topline-aqua">
                    ...
                    <div class="col-md-3">
                                    <select class="form-control" id="orderserviceDropdown">
                                        <option value="new_orders">Inhouse Guest</option>
                                        <option value="accepted_order">Departed Guest</option>
                                                        ...
                                                        ?>
                                                                <tr>
                                                                    ...
                                                                    <td class="w-space-no">
                                                                                ...
                                                                                <a href="#" class="btn btn-secondary shadow btn-xs sharp me-1 booking_id" data-bs-toggle="modal" booking-id=<?= $depart_g['booking_id']?> u-id1=<?= $depart_g['u_id']?> data-bs-target=".bd-view-modal"><i class="fa fa-eye"></i>
                                                                        </a>
