...
<div class="page-content-wrapper">
  ...
  <span class="tooltiptext">Tooltip text</span>
                                    ...
                                    <div class="custom_icon_block inactive" id="icon_4" data-id="4">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                             <img src="<?php echo base_url('assets/dist/images/big/floors.png')?>" alt="" title="Floor" style="height:75px;">
                                        </a> 
                                    </div>
                                    ...
                                    <div class="custom_icon_block inactive" id="icon_6" data-id="6">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                             <img src="<?php echo base_url('assets/dist/images/big/room_configure.png')?>" alt="" title="Room Configure" style="height:75px;">
                                        </a> 
                                    </div>
                                    <div class="custom_icon_block inactive" id="icon_7" data-id="7">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                             <img src="<?php echo base_url('assets/dist/images/big/business.png')?>" alt="" title="Add Business Center" style="height:75px;">
                                        </a> 
                                    </div>
                                    <div class="custom_icon_block inactive" id="icon_8" data-id="8">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                             <img src="<?php echo base_url('assets/dist/images/big/business.png')?>" alt="" title="Business Center Reservation" style="height:75px;">
                                        </a> 
                                    </div>
                                    ...
                                    <div class="custom_icon_block inactive" id="icon_12" data-id="12">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                             <img src="<?php echo base_url('assets/dist/images/big/aaaa.png')?>" alt="" title="Accounts" style="height:75px;">
                                        </a> 
                                    </div>
                                    ...
                                    <div class="custom_icon_block inactive" id="icon_16" data-id="16">
                                        <a href="javascript:void(0)" data-sub-html="Demo Description">
                                             <img src="<?php echo base_url('assets/dist/images/dispute.png')?>" alt="" title=" Raise Dispute" style="height:75px;">
                                        </a> 
                                    </div>
