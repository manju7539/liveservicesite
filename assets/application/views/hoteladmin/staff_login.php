                ...
                <div class="card card-topline-aqua">
                    ...
                    <div class="card-body">
                     <div class="btn-group r-btn">
                        <a class="btn btn-info add_login_person" href="javascript:void(0)">Create Staff Login ID</a>
                    </div>
                            ...
                            <table id="example1" class="display full-width">
                                ...
                                <?php
                                    ...
                                    <td><?php echo $st['password_text'] ?></td>
                                        ...
                                        <td>
                                            <a href="#" onclick="delete_data(<?php echo $st['u_id'] ?>)" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    <?php
                                        }
