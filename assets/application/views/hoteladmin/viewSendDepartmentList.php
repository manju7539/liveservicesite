                    ...
                    <div class="modal fade bd-example-modal-lg" tabindex="-1" style="display: none;" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <form action="<?php echo base_url('HoteladminController/sent_notification_to_department')?>" method="post" enctype="multipart/form-data">
        ...
        <!-- <td><a href="" class="btn btn-secondary shadow btn-xs sharp me-1" data-toggle="modal" data-target="#message1" style="border:2px solid black;"><i class="fa fa-eye" style="color:red;"></i></a></td> -->
        <!-- <td><a href="" class="btn btn-light btn-sm" data-toggle="modal" data-target="#send_reply2" style="border:2px solid black;"><i class="fa fa-paper-plane" style="color:green;"></i></a></td> -->
        <!-- <td> -->
        </tr>
        <?php
        }
