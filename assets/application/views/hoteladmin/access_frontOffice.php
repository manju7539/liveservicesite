...
<div class="content-body">
        ...
        <div id="main-wrapper">
                ...
                // print_r($front_ofs_admin_id);die;
                                    ...
                                    ?>
                                        <!-- <tr>
                                            <th>2</th>
                                            <td class="text-center">Room Booking Management</td>
                                            <td>
                                                <div class="col">
                                        ...
                                        <tr>
                                            <th>3</th>
                                            <td class="text-center"> Business Center reservation</td>
                                            <td>
                                                <div class="col">
                                                    <div class="form-check custom-checkbox mb-3 checkbox-info">
                                                        <input type="checkbox" class="form-check-input" checked=""
                                        ...
                                        <tr>
                                            <th>5</th>
                                            <td class="text-center">Service Management</td>
                                        ...
                                        <tr>
                                            <th>6</th>
                                            <td class="text-center">Cloakroom service</td>
                                            <td class="text-center">
                                                <div class="col">
                                                    <div class="form-check custom-checkbox mb-3 checkbox-info">
                                                        <input type="checkbox" class="form-check-input" checked=""
                                        ...
                                        <tr>
                                            <th>8</th>
                                            <td class="text-center">Handover</td>
                                            <td class="text-center">
                                                <div class="col">
                                                    <div class="form-check custom-checkbox mb-3 checkbox-info">
                                                        <input type="checkbox" class="form-check-input" checked=""
