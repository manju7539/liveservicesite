...
<?php
                                                            ...
                                                            ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <!-- /. -->
                                                                    <td><?php echo date('Y-m-d',strtotime($m_pen['created_at'])) ?> </td>
...
?>
        <tr>
            <td><strong><?php echo $i++?></strong></td>
            <td><?php echo $creator_full_name ?></td>
            <td><?php echo $m_com['date']." ".date('h:i a',strtotime($m_com['time'])) ?></td>
            <td><?php echo $completor_full_name ?></td>
            <td><?php echo $m_com['complete_date']." ".date('h:i a',strtotime($m_com['complete_time'])) ?></td>
            <td>
                <a href="#"
                    class="btn btn-secondary shadow btn-xs sharp me-1"
                    data-bs-toggle="modal"
