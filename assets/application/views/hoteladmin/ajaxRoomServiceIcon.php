...
<div class="add_div_view">
    ...
    <?php
                if($room_servs_cat_list)
                {
                    ...
                    {
                    ?>
                    <div class="new_orders_div_" id="new_orders_div_<?php echo $rmscl['room_servs_category_id']?>" style="display:none;">
                <div class="row">
                    <div class="col-md-9">
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <div class="tab-pane active show" id="manage_login_<?php echo $rmscl['room_servs_category_id']?>">
                                        <div class="card">
                                        <div class="card-header">
                                            ...
                                            <div class="table-scrollable">
                    <table id="test_<?php echo $rmscl['room_servs_category_id']?>" class="display full-width">
                         <thead>
                                                            <tr>
                                                                <th><strong>Sr.no.</strong></th>
