           ...
           <div class="modal fade" id="exampleModalCenter" style="display: none;" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <form action="<?php echo base_url('HoteladminController/add_banquet_hall')?>" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="#" class="btn btn-info shadow btn-xs sharp me-1"
                                                                data-bs-toggle="modal"
                                                                data-bs-target=".bd-example-modal-lg_<?php echo $b_h['banquet_hall_id']?>"><i
...
<?php
                if($list)
                {
                    ...
                    {
            ?>
                        <div class="modal fade bd-example-modal-lg_<?php echo $b_h['banquet_hall_id']?>" tabindex="-1" role="dialog" aria-hidden="true">
                            <div class="modal-dialog modal-md slideInRight animated">
                                <div class="modal-content">
                                    ...
                                    <form action="<?php echo base_url('HoteladminController/edit_banquet_hall')?>" method="post" enctype="multipart/form-data">
