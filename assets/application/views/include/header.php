...
<body
			...
			<div class="page-header-inner ">
				...
				<div class="top-menu">
					...
					<li class="nav-item dropdown notification_dropdown">
						...
						<i class="fa fa-question-circle" aria-hidden="true" style="font-size:21px ;color:#132239"></i>
                       </a>
                    </li>
					<li class="nav-item dropdown notification_dropdown">
                        <a class="nav-link" href="<?php echo base_url('serviceBooking')?>"> 
						<i class="fa fa-id-card-o" aria-hidden="true" style="font-size:21px ;color:#132239"></i>
                        </a>
                    </li>
						...
						<?php } else if($this->session->userdata('userType') == 7){?>
							...
							<li class="" id="">
								<a href="<?php echo base_url('newRequest') ?>">
									<i class="fa fa-home" style="font-size:21px ;color:#132239; margin-top: 6px;"></i>
							...
							<li class="dropdown dropdown-extended dropdown-inbox" id="header_inbox_bar">
								<a href="<?php echo base_url('newManageOrder') ?>" class="dropdown-toggle" >
									<i class="fa fa-info" style="font-size:21px ;color:#132239; margin-top: 6px;"></i>
	...
	<!-- start page container -->
								...
								<div class="user-panel">
									<div class="row">
										<div class="sidebar-userpic">
											...
											//  print_r($get_profile_photo);
											 if(!empty($get_profile_photo))
											 {
												 $profile_photo = $get_profile_photo['profile_photo'];
        ...
        <?php
            ...
            $wh4 = '(admin_id = "'.$u_id.'" AND department_id = 3 AND department_status = 1)';
            
            $hotel_panel_rs_data = $this->MainModel->getData('hotels_panel_list',$wh4);

            if($hotel_panel_rs_data)
            {
        ?>
									<li class="nav-item start active">
										<a href="<?php echo base_url('HoteladminController/RoomServiceList') ?>" class="nav-link nav-toggle">
											<i class="material-icons">dashboard</i>
