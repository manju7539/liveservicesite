      ...
      <div class="panel tab-border card-box">
         <header class="panel-heading panel-heading-gray custom-tab ">
            <ul class="nav nav-tabs">
               ...
               <li class="nav-item" style="width: 25%;text-align: center;"> <a class="nav-link active"
         ...
         <div class="row">
            <div class="col-xl-8">
                  ...
                  <div class="col-xl-4 col-md-6 col-12">
                     <div class="info-box bg-blue">
                        ...
                        <div class="info-box-content">
                           ...
                           <span class="info-box-number"> <?php echo count($complete_order)?>
                           <br>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-xl-4 col-md-6 col-12">
                     <div class="info-box bg-blue">
                        ...
                        <div class="info-box-content">
                           ...
                           <span class="info-box-number"> <?php echo count($total_expected_current_booking)?>
                           <br>
                        </div>
                     </div>
                  </div>
               ...
               <div class="card-body  data_scroll" style="padding:0.875rem;height: 280px;">
                           ...
                           <button type="button"
                              class="btn purple btn-outline btn-circle margin-0" style="margin-bottom:15px!important">
                             
                              <a href="<?php echo base_url('HoteladminController/HouseKeepingList')?>"
                                                                class="card-title  " style="color: black !important;">View
                                                                All</a>
                          </button>
                        </div>          
               </div>
                  ...
                  <div class="row">
                     <div class="noti-information notification-menu">
                        <div class="notification-list mail-list not-list small-slimscroll-style" style="height:400px">
                           <?php
                              // print_r($get_front_ofs_notifications);die;
                              
                              if($get_hk_notifications)
                              {
                              foreach($get_hk_notifications as $gnt)
                              {
                              $wh = '(notification_id = "'.$gnt['notification_id'].'" AND department_id = 2)';
                           ...
                           </span> <span class="text-purple"><?php echo $gnt['title'] ?></span>
                           <span class="notificationtime">
                           <small>
                           <?php echo date('m F Y',strtotime($gnt['created_at']))." - ".date('h:i a',strtotime($gnt['created_at'])) ?>
                           </small>
                           </span>
                           </a>
                           <?php
                        ...
                        <div class="full-width text-center p-t-10">
                           <button type="button"
                              ...
                              {
                              ?>
                           <a href="<?php echo base_url('housekeeping_notification')?>" >View All Notification</a>
                           <?php
                              }
                              ?></button>
                        </div>
         ...
         <div class="card  card-box">
                    ...
                    <div class="card-body no-padding height-9">
                        <div class="row">
                            ...
                            <div class="row">
                                    <div class="col-xl-12">
                                        <a href="https://testingsites.in/AtMyTip/Housekeeping_Admin/mng_loundry">
                                            <div class="accordion-item" style="height: 163px;">
                                                <div class="accordion-header rounded-lg collapsed" role="button">
                                                    ...
                                                    <div class="booking-status d-flex align-items-center">
                                                        <span>
                                                            <i> <img style="height:119px;width:150px;border-radius:18%;" transform="translate(-2 -6)" fill="var(--primary)" src="https://testingsites.in/AtMyTip/Housekeeping_Admin/assets_new/images/loundry1.webp" alt="">
                                                            </i>
                                                        </span>
                                                        <div class="ms-4">
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="accordion-item">
                                        <div class="accordion-header rounded-lg collapsed" id="accord-11One"
                                            data-bs-toggle="collapse" data-bs-target="#collapse11One"
                                            aria-controls="collapse11One" aria-expanded="false" role="button">
                                            <span class="accordion-header-icon"></span>
                                        ...
                                        <div id="collapse11One" class="accordion__body collapse"
                                                ...
                                                <div class="col-xl-12">
                                                    <div class="row row-cols-8 ">
                                                        <div class="room_card card red" data-bs-toggle="modal"
                                                          ...
                                                          <span class="room_no"><a href="<?php echo base_url('housekeeping_new_order')?>" style="color: black;">101</a></span>
                                                        </div>
                                                        <div class="room_card card red" data-bs-toggle="modal"
                                                            data-bs-target=".add">
                                                            <span title="2 orders" class="badge badge-success"
                                                          ...
                                                          <span class="room_no "><a href="<?php echo base_url('housekeeping_new_order')?>" style="color: black;">106</a></span>
                                                        </div>
                                                        <div class="room_card card red" data-bs-toggle="modal"
                                                            data-bs-target=".add">
                                                            <span title="2 orders" class="badge badge-success"
                                                          ...
                                                          <span class="room_no "><a href="<?php echo base_url('housekeeping_new_order')?>" style="color: black;">109</a></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-xl-6">
                                    <div class="accordion-item">
                                        <div class="accordion-header rounded-lg collapsed" id="accord-11Two"
                                            data-bs-toggle="collapse" data-bs-target="#collapse11Two"
                                            aria-controls="collapse11Two" aria-expanded="false" role="button">
                                            <span class="accordion-header-icon"></span>
                                            <span title="3 New Messages" class="badge badge-primary"
                                                style="float: right;
                                                   margin-right: 13px;margin-top:-14px; animation: 1s ease 0s normal none infinite running wobble;">3</span>
                                        ...
                                        <div id="collapse11Two" class="accordion__body collapse"
                                            aria-labelledby="accord-11Two" data-bs-parent="#accordion-eleven">
                                            <div class="accordion-body-text">
                                                <div class="col-xl-12">
                                                    <div class="row row-cols-8 ">
                                                        <div class="room_card card red" data-bs-toggle="modal"
                                                          ...
                                                          <span class="room_no "><a href="<?php echo base_url('housekeeping_new_order')?>" style="color: black;">201</a></span>
                                                        </div>
                                                        <div class="room_card card red" data-bs-toggle="modal"
                                                            data-bs-target=".add">
                                                            <span title="2 orders" class="badge badge-success"
                                                          ...
                                                          <span class="room_no "><a href="<?php echo base_url('housekeeping_new_order')?>" style="color: black;">206</a></span>
                                                        </div>
                                                        <div class="room_card card red" data-bs-toggle="modal"
                                                            data-bs-target=".add">
                                                            <span title="2 orders" class="badge badge-success"
                                ...
                                <div class="col-xl-6">
                                    <div class="accordion-item">
                                        <div class="accordion-header rounded-lg collapsed" id="accord-11three"
                                            data-bs-toggle="collapse" data-bs-target="#collapse11three"
                                            aria-controls="collapse11three" aria-expanded="false" role="button">
                                            <span class="accordion-header-icon"></span>
                                            <span title="3 New Messages" class="badge badge-primary"
                                                style="float: right;
                                                   margin-right: 13px;margin-top:-14px; animation: 1s ease 0s normal none infinite running wobble;">3</span>
                                        ...
                                        <div id="collapse11three" class="accordion__body collapse"
                                            aria-labelledby="accord-11three" data-bs-parent="#accordion-eleven">
                                            <div class="accordion-body-text">
                                                <div class="col-xl-12">
                                                    <div class="row row-cols-8 ">
                                                        <div class="room_card card red" data-bs-toggle="modal"
                                ...
                                <div class="col-xl-6">
                                    <div class="accordion-item">
                                        <div class="accordion-header collapsed rounded-lg" id="accord-11four"
                                            data-bs-toggle="collapse" data-bs-target="#collapse11four"
                                            aria-controls="collapse11four" aria-expanded="true" role="button">
                                            <span class="accordion-header-icon"></span>
                                            <span title="3 New Messages" class="badge badge-primary"
                                                style="float: right;
                                                   margin-right: 13px;margin-top:-14px; animation: 1s ease 0s normal none infinite running wobble;">3</span>
                                        ...
                                        <div id="collapse11four" class="collapse accordion__body"
                                            aria-labelledby="accord-11four" data-bs-parent="#accordion-eleven">
                                            <div class="accordion-body-text">
                                                <div class="col-xl-12">
                                                    <div class="row row-cols-8 ">
                                                        <div class="room_card card red" data-bs-toggle="modal"
                           ...
                           <table class="table display product-overview mb-30" id="support_table5">
                              ...
                              <?php 
                                            ...
                                            <tr>
                                                ...
                                                <td> <?php echo $get_services['service_type'] ?> - <?php echo $order_d['room_no']?>,<span style="font-weight:bold">Completed</span> ; By -
                                                    <span style="font-weight:bold"><?php echo $staff_name;?></span>
                                                </td>
                                                <?php 
                                                    if ($order_d['order_status'] == 2) 
                                                    {
                                                 ?>
                                                		<td><span class="badge notif">Completed</span></td>
                                                <?php
                                                    }
                                                ?>
                                            </tr>
