                                       ...
                                       <div class="col-xl-4 offset-xl-4">
                                          <div class="input-group">
                                             <select name="hotel_name" id="hotel_name"
                                                ...
                                                <option selected="" disabled="disable">Choose Hotel...
                                                </option>
                                                <?php
                                                   ...
                                                   //    $users = $this->MainModel->getDatas($tbl='hotels');
                                          ...
                                          <div class="tab-content">
                                             <div class="tab-pane fade show active" id="weekly1">
                                                <div style="width:100%;">
                                                   ...
                                                   <!-- <canvas id="barChart"
                                                      style="min-height: 400px; height: 400px; max-height: 400px;  max-width: 100%; display:none"
