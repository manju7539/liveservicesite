							...
							<div class="panel tab-border card-box">
								<header class="panel-heading panel-heading-gray custom-tab ">
									<ul class="nav nav-tabs">
										<li class="nav-item" style="width: 25%;text-align: center;"> <a class="nav-link active" data-bs-toggle="tab" href="#create_login">
                                        Front Office</a>
										</li>
                ...
                <div class="col-xl-3 col-md-6 col-12">
                    <div class="info-box bg-purple">
                        <span class="info-box-icon push-bottom"><i
                                class="material-icons">style</i></span>
                        <div class="info-box-content">
                            <span class="info-box-text">Expected Departur</span>
                ...
                <div class="col-xl-3 col-md-6 col-12">
                    <div class="info-box bg-success">
                        <span class="info-box-icon push-bottom"><i
                                class="material-icons">style</i></span>
                        <div class="info-box-content">
                            <span class="info-box-text">CHG</span>
                            <span class="info-box-number"><?php echo count($total_CHG_guest)?></span>
                            <!-- <div class="progress">
                                <div class="progress-bar width-60"></div>
                            </div>
                            <span class="progress-description">
...
?>
 ...
 <a href="javascript:;" class="single-mail"> <span
                                        ...
                                        <span class="notificationtime">
                                            <small>
    <?php echo date('m F Y',strtotime($f_nt['created_at']))." - ".date('h:i a',strtotime($f_nt['created_at'])) ?>
...
?>
                        ...
                        ?>
                                    ...
                                    <a href="<?php echo base_url('notification')?>" >View All Notification</a>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-3 col-sm-3 col-6 mb-4 col-xxl-6">
                                                                <div class="text-center">
                                                                    ...
                                                                    <?php echo count($total_reserve_business_center); ?>/<?php echo count($total_business_center); ?></h3></h3>
                                                            ...
                                                            <div class="col-xl-3 col-sm-3 col-6 mb-4 col-xxl-6">
                                                                <div class="text-center">
                                                                    ...
                                                                    <?php echo count($total_reserve_bh); ?>/<?php echo count($total_b_h); ?></h3>
                                                        ...
                                                        <div class="row">
                                                            <div class=" col-xl-4 col-sm-3">
                                                                <div class="text-center">
                                                                    ...
                                                                    <?php echo $hotels_booking_data[0]['total_adults']?></h3>
                                                            ...
                                                            <div class="col-xl-4 col-sm-3">
                                                                <div class="text-center">
                                                                    ...
                                                                    <?php echo $hotels_booking_data[0]['total_adults'] + $hotels_booking_data[0]['total_child'] ?></h3>
            ...
            <div class="col-md-12 col-sm-12">
                <div class="card  card-box">
                    <div class="card-head">
                        ...
                        <a href="<?php echo base_url('FrontofficeController/all_services')?>" class="fs-20 float-right" style="color:black; float:right; margin-right:30px">View
                                            All</a>
                              ...
                              if($today_check_in_check_out)
                              {
                                ...
                                ?> 
                                     ...
                                     <td><?php echo $msg?><span
                                                            ...
                                                            <span style="font-weight:bold"><?php echo $full_name ?></span></td>
